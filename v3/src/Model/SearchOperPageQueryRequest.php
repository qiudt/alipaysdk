...
/**
 * SearchOperPageQueryRequest Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class SearchOperPageQueryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchOperPageQueryRequest';
     ...
     * Sets pageSize
     *
     * @param string|null $pageSize 每页显示条数
     *
     * @return self
     */
     ...
     * Sets specCode
     *
     * @param string|null $specCode 服务类型 SP_MINI_APP 小程序 SP_PUBLIC_APP 生活号
     *
     * @return self
     */
