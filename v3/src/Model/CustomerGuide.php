...
/**
 * CustomerGuide Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class CustomerGuide implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerGuide';
    ...
    protected static $openAPITypes = [
        ...
        'shopIds' => 'string[]',
        'storeIds' => 'string[]',
        'voucherSendGuide' => '\Alipay\OpenAPISDK\Model\VoucherSendGuide',
        'voucherUseGuide' => '\Alipay\OpenAPISDK\Model\VoucherUseGuide'
    ];
     ...
     * Sets miniAppPath
     *
     * @param string|null $miniAppPath 指定跳转到mini_app_id时的具体页面路径。  限制：  1、只有mini_app_id有值时该值传入才会有效 2、该小程序路径是相对路径。详情参见 <a href=\"https://opendocs.alipay.com/support/01rb18\">小程序scheme链接介绍</a>
     *
     * @return self
     */
     ...
     * Sets storeIds
     *
     * @param string[]|null $storeIds 该字段后续废弃。券可使用的门店列表。列表中的门店id是通过调用接口ant.merchant.expand.shop.create创建门店返回的支付宝门店id。接口参数是列表类型。
     *
     * @return self
     */
     ...
     *
     * @return \Alipay\OpenAPISDK\Model\VoucherSendGuide|null
     */
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\VoucherSendGuide|null $voucherSendGuide voucherSendGuide
     *
     * @return self
     */
     ...
     *
     * @return \Alipay\OpenAPISDK\Model\VoucherUseGuide|null
     */
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\VoucherUseGuide|null $voucherUseGuide voucherUseGuide
     *
     * @return self
     */
