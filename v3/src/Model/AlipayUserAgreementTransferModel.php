...
/**
 * AlipayUserAgreementTransferModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayUserAgreementTransferModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayUserAgreementTransferModel';
    ...
    protected static $setters = [
        ...
        'targetProductCode' => 'setTargetProductCode'
    ];
    ...
    protected static $getters = [
        ...
        'targetProductCode' => 'getTargetProductCode'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['targetProductCode'] = $data['targetProductCode'] ?? null;
    }
     ...
     * Sets agreementNo
     *
     * @param string|null $agreementNo 支付宝系统中用以唯一标识用户签约记录的编号（用户签约成功后的协议号 ），如果传了该参数，其他参数会被忽略
     *
     * @return self
     */
    ...
    /**
     * Gets targetProductCode
     *
     * @return string|null
     */
    public function getTargetProductCode()
    {
        return $this->container['targetProductCode'];
    }

    /**
     * Sets targetProductCode
     *
     * @param string|null $targetProductCode 协议产品码，商户和支付宝签约时确定，不同业务场景对应不同的签约产品码。这里指的是需要修改目标产品码的值
     *
     * @return self
     */
    public function setTargetProductCode($targetProductCode)
    {
        $this->container['targetProductCode'] = $targetProductCode;
