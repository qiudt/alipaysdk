...
/**
 * AlipayEbppInvoiceExpenserulesEmployeeQueryResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayEbppInvoiceExpenserulesEmployeeQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayEbppInvoiceExpenserulesEmployeeQueryResponseModel';
     ...
     * Sets employeeList
     *
     * @param string[]|null $employeeList 切换open_id前请使用此字段：员工列表
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $employeeOpenIdList 切换open_id后请使用此字段：员工open_id列表
     *
     * @return self
     */
