...
/**
 * ZhimaCustomerJobworthJobdataAddResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class ZhimaCustomerJobworthJobdataAddResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ZhimaCustomerJobworthJobdataAddResponseModel';
     ...
     * Sets acceptanceId
     *
     * @param string|null $acceptanceId 受理台单号，用来调用工作证受理台
     *
     * @return self
     */
