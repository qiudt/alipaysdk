...
/**
 * OrderVoucherRealShopFailInfo Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class OrderVoucherRealShopFailInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderVoucherRealShopFailInfo';
    ...
    {
        $this->container['failMessage'] = $data['failMessage'] ?? null;
        $this->container['failReasons'] = $data['failReasons'] ?? null;
     ...
     * Sets failMessage
     *
     * @param string|null $failMessage 请求失败提示信息。
     *
     * @return self
     */
     ...
     * Sets failReasons
     *
     * @param string[]|null $failReasons 请求失败原因。
     *
     * @return self
     */
     ...
     * Sets realShopId
     *
     * @param string|null $realShopId 请求失败的代运营商业关系门店 ID。
     *
     * @return self
     */
