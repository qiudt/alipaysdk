 ...
 */
class TopicItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TopicItem';
     ...
     * Sets imgUrl
     *
     * @param string|null $imgUrl 内容图片url, 尺寸为300*300，最大不超过3M，支持格式:.jpg、.png ，请先调用<a href=\"https://docs.open.alipay.com/api_3/alipay.offline.material.image.upload\"> 图片上传接口</a>获得图片url
     *
     * @return self
     */
     ...
     * Sets linkUrl
     *
     * @param string|null $linkUrl 跳转链接，点击营销位内容图片跳到的链接url
     *
     * @return self
     */
     ...
     * Sets subTitle
     *
     * @param string|null $subTitle 内容说明
     *
     * @return self
     */
