...
/**
 * JointAccountMemberDTO Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class JointAccountMemberDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JointAccountMemberDTO';
    ...
    protected static $openAPITypes = [
        ...
        'memberExtInfo' => '\Alipay\OpenAPISDK\Model\MemberExtInfo',
        'name' => 'string',
        'openId' => 'string',
        'status' => 'string',
        'userId' => 'string'
     ...
     * Gets memberExtInfo
     *
     * @return \Alipay\OpenAPISDK\Model\MemberExtInfo|null
     */
     ...
     * Sets memberExtInfo
     *
     * @param \Alipay\OpenAPISDK\Model\MemberExtInfo|null $memberExtInfo memberExtInfo
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name 姓名，脱敏输出
     *
     * @return self
     */
     ...
     * Sets userId
     *
     * @param string|null $userId 用户会员号
     *
     * @return self
     */
