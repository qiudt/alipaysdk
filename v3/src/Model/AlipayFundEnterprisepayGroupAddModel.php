...
/**
 * AlipayFundEnterprisepayGroupAddModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayFundEnterprisepayGroupAddModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayFundEnterprisepayGroupAddModel';
     ...
     * Sets outBizNo
     *
     * @param string|null $outBizNo 外部业务号，外部群组号
     *
     * @return self
     */
