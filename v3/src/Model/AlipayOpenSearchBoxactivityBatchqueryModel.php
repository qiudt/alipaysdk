...
/**
 * AlipayOpenSearchBoxactivityBatchqueryModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenSearchBoxactivityBatchqueryModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenSearchBoxactivityBatchqueryModel';
     ...
     * Sets pageNumber
     *
     * @param int|null $pageNumber 分页查询的当前页号,从1开始
     *
     * @return self
     */
     ...
     * Sets pageSize
     *
     * @param int|null $pageSize 每页查询的数量，默认10，不超过50
     *
     * @return self
     */
