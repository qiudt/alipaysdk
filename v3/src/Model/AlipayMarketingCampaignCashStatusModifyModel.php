...
/**
 * AlipayMarketingCampaignCashStatusModifyModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayMarketingCampaignCashStatusModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayMarketingCampaignCashStatusModifyModel';
     ...
     * Sets campStatus
     *
     * @param string|null $campStatus 金活动修改后的状态。支持修改为： *PAUSE：活动暂停。 *READY：活动开始。 *CLOSED：活动结束。
     *
     * @return self
     */
