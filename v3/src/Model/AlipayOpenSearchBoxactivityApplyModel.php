...
/**
 * AlipayOpenSearchBoxactivityApplyModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenSearchBoxactivityApplyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenSearchBoxactivityApplyModel';
     ...
     * Sets endTime
     *
     * @param string|null $endTime 活动结束时间，开始和结束时间之间不得超过90天
     *
     * @return self
     */
     ...
     * Sets materialId
     *
     * @param string|null $materialId 当material_type=\"IMAGE\"时，为图片id；当material_type=\"VIDEO\"时，为视频id。小程序直达仅支持图片类型。图片id可以通过调用<a href=\"https://opendocs.alipay.com/mini/03hvl1?ref=api\"> 支付宝文件上传接口 </a>上传图片，获取图片id(bizCode：search_box_banner)。<a href=\"https://opendocs.alipay.com/b/03al6f\"> 图片规范 </a>
     *
     * @return self
     */
     ...
     * Sets startTime
     *
     * @param string|null $startTime 活动开始时间，开始和结束时间之间不得超过90天
     *
     * @return self
     */
