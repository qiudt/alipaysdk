...
/**
 * DatadigitalFincloudGeneralsaasOcrMobileInitializeModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class DatadigitalFincloudGeneralsaasOcrMobileInitializeModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DatadigitalFincloudGeneralsaasOcrMobileInitializeModel';
     ...
     * Sets bizCode
     *
     * @param string|null $bizCode bizCode，代表当前使用的能力类型。
     *
     * @return self
     */
     ...
     * Sets outerOrderNo
     *
     * @param string|null $outerOrderNo 客户业务单据号。请保持唯一。
     *
     * @return self
     */
