...
/**
 * AlipayOpenMiniTipsDeliveryModifyModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenMiniTipsDeliveryModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenMiniTipsDeliveryModifyModel';
     ...
     * Sets operateType
     *
     * @param string|null $operateType 活动投放操作类型
     *
     * @return self
     */
