...
/**
 * ZhimaMerchantZmgoCumulateSyncResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class ZhimaMerchantZmgoCumulateSyncResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ZhimaMerchantZmgoCumulateSyncResponseModel';
     ...
     * Sets failReason
     *
     * @param string|null $failReason 数据回传失败原因描述
     *
     * @return self
     */
