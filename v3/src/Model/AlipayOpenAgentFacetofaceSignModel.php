...
class AlipayOpenAgentFacetofaceSignModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets batchNo
     *
     * @param string|null $batchNo 代商户操作事务编号，通过<a href=\"https://opendocs.alipay.com/apis/api_50/alipay.open.agent.create\">接口地址</a> (开启代商户签约、创建应用事务)接口进行事务创建后获取。
     *
     * @return self
     */
     ...
     *
     * @param string|null $businessLicenseMobile 上传非经营者本人（签约账号）的营业执照时必填，填写营业执照法人支付宝账号对应的手机号。
     *
     * @return self
     */
