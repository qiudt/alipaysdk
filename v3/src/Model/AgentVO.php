 ...
 */
class AgentVO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AgentVO';
     ...
     * Sets ccsInstanceIds
     *
     * @param string[]|null $ccsInstanceIds 客服归属的部门id列表
     *
     * @return self
     */
     ...
     * Sets chatConfig
     *
     * @param \Alipay\OpenAPISDK\Model\AgentChatInfo[]|null $chatConfig 在线技能组信息
     *
     * @return self
     */
     ...
     * Sets createTime
     *
     * @param string|null $createTime 创建时间， 标准时间格式：yyyy-MM-dd HH:mm:ss
     *
     * @return self
     */
     ...
     * Sets dingtalkUserId
     *
     * @param string|null $dingtalkUserId 钉钉user_id（绑定钉钉的用户该字段非空）
     *
     * @return self
     */
     ...
     * Sets externalId
     *
     * @param string|null $externalId 外部系统用户,比如金融云的用户id、支付宝账号id
     *
     * @return self
     */
     ...
     * Sets hotlineConfig
     *
     * @param \Alipay\OpenAPISDK\Model\AgentHotlineInfo[]|null $hotlineConfig 热线技能组信息
     *
     * @return self
     */
     ...
     * Sets jobNumber
     *
     * @param string|null $jobNumber 客服工号
     *
     * @return self
     */
     ...
     * Sets lastLoginTime
     *
     * @param string|null $lastLoginTime 最后登录时间,标准时间格式：yyyy-MM-dd HH:mm:ss
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status 状态：NORMAL，DELETE
     *
     * @return self
     */
     ...
     * Sets updateTime
     *
     * @param string|null $updateTime 最后修改时间， 标准时间格式：yyyy-MM-dd HH:mm:ss
     *
     * @return self
     */
