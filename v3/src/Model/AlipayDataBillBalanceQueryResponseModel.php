...
/**
 * AlipayDataBillBalanceQueryResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayDataBillBalanceQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayDataBillBalanceQueryResponseModel';
     ...
     *
     * @param string|null $availableAmount 账户可用余额
     *
     * @return self
     */
     ...
     * Sets settleAmount
     *
     * @param string|null $settleAmount 待结算金额，单位（元）
     *
     * @return self
     */
     ...
     * Sets totalAmount
     *
     * @param string|null $totalAmount 支付宝账户余额
     *
     * @return self
     */
