...
/**
 * AlipayEcoMycarParkingCharginginfoSyncModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayEcoMycarParkingCharginginfoSyncModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayEcoMycarParkingCharginginfoSyncModel';
     ...
     * Sets serialNo
     *
     * @param string|null $serialNo 支付宝业务流水号，用于记录车辆从驶入到驶出的全流程。通过 alipay.eco.mycar.parking.enterinfo.sync (车辆驶入接口)接口获取。
     *
     * @return self
     */
