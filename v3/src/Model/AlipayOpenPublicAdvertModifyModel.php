...
/**
 * AlipayOpenPublicAdvertModifyModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenPublicAdvertModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenPublicAdvertModifyModel';
     ...
     * Sets advertId
     *
     * @param string|null $advertId 广告位id，通过<a href=\"https://opendocs.alipay.com/apis/api_6/alipay.open.public.advert.create\">alipay.open.public.advert.create</a>(生活号广告位添加接口)添加广告位获取。
     *
     * @return self
     */
     ...
     * Sets advertItems
     *
     * @param \Alipay\OpenAPISDK\Model\AdvertItem[]|null $advertItems 广告位轮播内容列表。数量限制：大于1个，小于5个。广告位轮播内容顺序：与接口传入的顺序排列一致。
     *
     * @return self
     */
