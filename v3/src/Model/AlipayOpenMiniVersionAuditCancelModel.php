...
/**
 * AlipayOpenMiniVersionAuditCancelModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenMiniVersionAuditCancelModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenMiniVersionAuditCancelModel';
     ...
     * Sets appVersion
     *
     * @param string|null $appVersion 商家小程序审核中的版本号, 不传默认撤消正在审核中的版本。
     *
     * @return self
     */
