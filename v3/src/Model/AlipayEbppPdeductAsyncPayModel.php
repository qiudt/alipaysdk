...
/**
 * AlipayEbppPdeductAsyncPayModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayEbppPdeductAsyncPayModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayEbppPdeductAsyncPayModel';
     ...
     * Sets agentChannel
     *
     * @param string|null $agentChannel 分配给外部机构发起扣款时的渠道码。朗新为LANGXIN
     *
     * @return self
     */
