...
/**
 * AlipayEbppPdeductSignAddResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayEbppPdeductSignAddResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayEbppPdeductSignAddResponseModel';
     ...
     *
     * @param string|null $agreementStatus 支付宝协议状态。签约成功则返回success
     *
     * @return self
     */
     ...
     * Sets extendField
     *
     * @param string|null $extendField 扩展参数，可为空
     *
     * @return self
     */
     ...
     * Sets notifyConfig
     *
     * @param string|null $notifyConfig 通知方式设置。
     *
     * @return self
     */
     ...
     * Sets outAgreementId
     *
     * @param string|null $outAgreementId 商户生成的代扣协议ID
     *
     * @return self
     */
     ...
     * Sets payConfig
     *
     * @param string[]|null $payConfig 支付方式设置
     *
     * @return self
     */
