...
/**
 * AlipayEbppInvoiceInstitutionExpenseruleDeleteModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayEbppInvoiceInstitutionExpenseruleDeleteModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayEbppInvoiceInstitutionExpenseruleDeleteModel';
     ...
     * Sets accountId
     *
     * @param string|null $accountId 企业共同账户id（alipay.ebpp.invoice.institution.expenserule.delete）(alipay.ebpp.invoice.institution.expenserule.delete)
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets standardIdList
     *
     * @param string[]|null $standardIdList 删除的使用规则id列表
     *
     * @return self
     */
