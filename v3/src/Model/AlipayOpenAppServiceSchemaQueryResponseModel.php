...
/**
 * AlipayOpenAppServiceSchemaQueryResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenAppServiceSchemaQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenAppServiceSchemaQueryResponseModel';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['schemaXml'] = $data['schemaXml'] ?? null;
    ...
    {
        return $this->container['schemaXml'];
    }

    /**
     * Sets schemaXml
     *
     * @param string|null $schemaXml 服务schema
     *
     * @return self
     */
    public function setSchemaXml($schemaXml)
    {
        $this->container['schemaXml'] = $schemaXml;
     ...
     * Sets templateType
     *
     * @param string|null $templateType 服务模版类型，默认值: DEFAULT
     *
     * @return self
     */
