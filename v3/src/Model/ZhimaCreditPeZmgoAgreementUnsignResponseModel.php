...
/**
 * ZhimaCreditPeZmgoAgreementUnsignResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class ZhimaCreditPeZmgoAgreementUnsignResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ZhimaCreditPeZmgoAgreementUnsignResponseModel';
     ...
     * Sets withholdPlanNo
     *
     * @param string|null $withholdPlanNo 调用芝麻GO结算受理接口时，需要传入该值
     *
     * @return self
     */
