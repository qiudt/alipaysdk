...
/**
 * AlipayIserviceCcmSwArticleCreateModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayIserviceCcmSwArticleCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayIserviceCcmSwArticleCreateModel';
     ...
     * Sets libraryId
     *
     * @param string|null $libraryId 知识库ID
     *
     * @return self
     */
     ...
     * Sets publishEnd
     *
     * @param string|null $publishEnd 默认为 2999-12-31 23:59:59
     *
     * @return self
     */
     ...
     * Sets publishStart
     *
     * @param string|null $publishStart 默认为当前时间
     *
     * @return self
     */
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\BaseArticleInfo[]|null $relatedArticles 关联知识点
     *
     * @return self
     */
     ...
     * Sets sceneCodes
     *
     * @param string[]|null $sceneCodes 场景ID。KNOWLEDGE（内部知识库）；ROBOT（机器人）;HELP（帮助中心）；WHELP（无线帮助中心）
     *
     * @return self
     */
