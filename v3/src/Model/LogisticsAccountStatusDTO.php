...
/**
 * LogisticsAccountStatusDTO Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class LogisticsAccountStatusDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LogisticsAccountStatusDTO';
     ...
     * Sets status
     *
     * @param string|null $status 账户状态，AUDITING:审核中，AUDIT_REJECT:审核驳回，VALID:已生效
     *
     * @return self
     */
