...
class AlipayMarketingCardUpdateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets targetCardNo
     *
     * @param string|null $targetCardNo 支付宝业务卡号：1、3.0（历史版本）版本来源于alipay.marketing.card.open(会员卡开卡)接口开卡后获取的 card_info.biz_card_no 值；2、极速版来源于spi.alipay.user.opencard.get(会员卡开通，获取会员卡信息)请求参数中的biz_card_no值。
     *
     * @return self
     */
