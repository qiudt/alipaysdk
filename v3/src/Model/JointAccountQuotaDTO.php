...
/**
 * JointAccountQuotaDTO Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class JointAccountQuotaDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JointAccountQuotaDTO';
     ...
     *
     * @param string|null $customBeginDate 自定义周期起始日期，精确到分钟，yyyy-MM-dd HH:mm
     *
     * @return self
     */
     ...
     * Sets customEndDate
     *
     * @param string|null $customEndDate 自定义周期结束日期，精确到分钟，yyyy-MM-dd HH:mm
     *
     * @return self
     */
     ...
     * Sets quotaDimension
     *
     * @param string|null $quotaDimension 额度维度 单笔上限：ONCE 日：DAY 月：MONTH 季度：QUARTER 年：YEAR 终身：LIFETIME 一次性使用额度：ONLYONE
     *
     * @return self
     */
