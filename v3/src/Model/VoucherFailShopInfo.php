...
/**
 * VoucherFailShopInfo Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class VoucherFailShopInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VoucherFailShopInfo';
     ...
     * Sets failReasons
     *
     * @param string[]|null $failReasons 请求失败的原因。
     *
     * @return self
     */
     ...
     * Sets realShopId
     *
     * @param string|null $realShopId 请求失败的物理门店 id。
     *
     * @return self
     */
