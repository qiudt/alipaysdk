...
/**
 * AlipayEbppInvoiceFileOutputQueryResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayEbppInvoiceFileOutputQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayEbppInvoiceFileOutputQueryResponseModel';
     ...
     * Sets fileType
     *
     * @param string|null $fileType 发票文件类型pdf或ofd
     *
     * @return self
     */
     ...
     *
     * @param string|null $invoiceFileContent 发票文件内容,需要先base64解码，获取原始byte[]类型文件流
     *
     * @return self
     */
