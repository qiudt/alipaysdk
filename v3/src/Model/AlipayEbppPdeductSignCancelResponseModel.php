...
/**
 * AlipayEbppPdeductSignCancelResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayEbppPdeductSignCancelResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayEbppPdeductSignCancelResponseModel';
     ...
     *
     * @param string|null $agreementStatus 支付宝协议状态。解约成功则返回success
     *
     * @return self
     */
     ...
     * Sets outAgreementId
     *
     * @param string|null $outAgreementId 商户代扣协议ID
     *
     * @return self
     */
