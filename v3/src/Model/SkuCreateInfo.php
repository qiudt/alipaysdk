...
/**
 * SkuCreateInfo Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class SkuCreateInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SkuCreateInfo';
     ...
     * Sets materialList
     *
     * @param \Alipay\OpenAPISDK\Model\MaterialCreateInfo[]|null $materialList SKU素材列表（最多3个）
     *
     * @return self
     */
     ...
     * Sets propertyList
     *
     * @param \Alipay\OpenAPISDK\Model\ItemSkuPropertyInfo[]|null $propertyList SKU属性列表
     *
     * @return self
     */
