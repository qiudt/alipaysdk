...
/**
 * AlipayOpenMiniInnerversionBetaConfirmModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenMiniInnerversionBetaConfirmModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenMiniInnerversionBetaConfirmModel';
     ...
     * Sets operate
     *
     * @param string|null $operate 操作：pass/reject。接受或者拒绝
     *
     * @return self
     */
     ...
     * Sets pluginId
     *
     * @param string|null $pluginId 要确认邀测结果的插件appid
     *
     * @return self
     */
