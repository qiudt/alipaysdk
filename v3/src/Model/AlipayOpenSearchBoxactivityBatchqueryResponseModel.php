...
/**
 * AlipayOpenSearchBoxactivityBatchqueryResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenSearchBoxactivityBatchqueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenSearchBoxactivityBatchqueryResponseModel';
    ...
    protected static $openAPITypes = [
        'models' => '\Alipay\OpenAPISDK\Model\SearchBoxActivity[]',
        'pageNumber' => 'string',
        'pageSize' => 'string',
        'totalCount' => 'int',
        'totalPageCount' => 'int'
     ...
     * Gets models
     *
     * @return \Alipay\OpenAPISDK\Model\SearchBoxActivity[]|null
     */
     ...
     * Sets models
     *
     * @param \Alipay\OpenAPISDK\Model\SearchBoxActivity[]|null $models 活动明细列表
     *
     * @return self
     */
     ...
     * Sets pageNumber
     *
     * @param string|null $pageNumber 当前页码
     *
     * @return self
     */
