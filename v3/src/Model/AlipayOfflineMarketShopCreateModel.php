...
/**
 * AlipayOfflineMarketShopCreateModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOfflineMarketShopCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOfflineMarketShopCreateModel';
    ...
    protected static $attributeMap = [
        ...
        'enterpriseLogonId' => 'enterprise_logon_id',
    ...
    protected static $setters = [
        ...
        'enterpriseLogonId' => 'setEnterpriseLogonId',
    ...
    protected static $getters = [
        ...
        'enterpriseLogonId' => 'getEnterpriseLogonId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['enterpriseLogonId'] = $data['enterpriseLogonId'] ?? null;
        ...
        $this->container['refApplyId'] = $data['refApplyId'] ?? null;
     ...
     * Sets address
     *
     * @param string|null $address 门店详细地址，地址字符长度在4-50个字符，注：不含省市区。门店详细地址按规范格式填写地址，以免影响门店搜索及活动报名：例1：道路+门牌号，“人民东路18号”；例2：道路+门牌号+标志性建筑+楼层，“四川北路1552号欢乐广场1楼”。
     *
     * @return self
     */
     ...
     * Sets auditImages
     *
     * @param string|null $auditImages 门店审核时需要的图片；至少包含一张门头照片，两张内景照片，必须反映真实的门店情况，审核才能够通过；多个图片之间以英文逗号分隔。
     *
     * @return self
     */
     ...
     * Sets authLetter
     *
     * @param string|null $authLetter 门店授权函,营业执照与签约账号主体不一致时需要。
     *
     * @return self
     */
     ...
     * Sets brandName
     *
     * @param string|null $brandName 品牌名，不填写则默认为“其它品牌”。
     *
     * @return self
     */
     ...
     * Sets categoryId
     *
     * @param string|null $categoryId 类目id，请参考<a href=\"https://doc.open.alipay.com/doc2/detail.htm?treeId=205&articleId=104497&docType=1\">商户入驻要求</a>。
     *
     * @return self
     */
     ...
     * Sets cityCode
     *
     * @param string|null $cityCode 城市编码，国标码，详见国家统计局数据 <a href=\"https://gw.alipayobjects.com/os/basement_prod/92d874c4-39a9-4977-b710-d55dad374b7f.csv\">点此下载</a>。
     *
     * @return self
     */
     ...
     * Sets contactNumber
     *
     * @param string|null $contactNumber 门店电话号码；支持座机和手机，只支持数字和+-号，在客户端对用户展现， 支持多个电话， 以英文逗号分隔。
     *
     * @return self
     */
     ...
     * Sets creator
     *
     * @param string|null $creator （支付宝内部参数）小二的支付宝账号。
     *
     * @return self
     */
     ...
     * Sets districtCode
     *
     * @param string|null $districtCode 区县编码，国标码，详见国家统计局数据 <a href=\"https://gw.alipayobjects.com/os/basement_prod/92d874c4-39a9-4977-b710-d55dad374b7f.csv\">点此下载</a>。
     *
     * @return self
     */
    ...
    /**
     * Gets enterpriseLogonId
     *
     * @return string|null
     */
    public function getEnterpriseLogonId()
    {
        return $this->container['enterpriseLogonId'];
    }

    /**
     * Sets enterpriseLogonId
     *
     * @param string|null $enterpriseLogonId （支付宝内部参数）企业支付宝账号。
     *
     * @return self
     */
    public function setEnterpriseLogonId($enterpriseLogonId)
    {
        $this->container['enterpriseLogonId'] = $enterpriseLogonId;
     ...
     * Sets enterpriseName
     *
     * @param string|null $enterpriseName （支付宝内部参数）企业支付宝账户名称。
     *
     * @return self
     */
     ...
     * Sets implementId
     *
     * @param string|null $implementId 机具号，多个之间以英文逗号分隔。
     *
     * @return self
     */
     ...
     * Sets isvUid
     *
     * @param string|null $isvUid ISV返佣id，门店创建、或者门店交易的返佣将通过此账号反给ISV，如果有口碑签订了返佣协议，则该字段作为返佣数据提取的依据。此字段必须是个合法uid，2088开头的16位支付宝会员账号，如果传入错误将无法创建门店。
     *
     * @return self
     */
     ...
     * Sets latitude
     *
     * @param string|null $latitude 纬度；最长15位字符（包括小数点）， 注：高德坐标系。经纬度是门店搜索和活动推荐的重要参数，录入时请确保经纬度参数准确。高德经纬度查询：http://lbs.amap.com/console/show/picker
     *
     * @return self
     */
     ...
     * Sets leadsId
     *
     * @param string|null $leadsId （支付宝内部参数）leads的编号。
     *
     * @return self
     */
     ...
     * Sets licence
     *
     * @param string|null $licence 门店营业执照图片，各行业所需的证照资质参见<a href=\"https://doc.open.alipay.com/doc2/detail.htm?treeId=205&articleId=104497&docType=1\">商户入驻要求</a>。
     *
     * @return self
     */
     ...
     * Sets licenceCode
     *
     * @param string|null $licenceCode 门店营业执照编号，只支持输入中文，英文和数字，营业执照信息与is_operating_online至少填一项。
     *
     * @return self
     */
     ...
     * Sets longitude
     *
     * @param string|null $longitude 经度；最长15位字符（包括小数点）， 注：高德坐标系。经纬度是门店搜索和活动推荐的重要参数，录入时请确保经纬度参数准确。高德经纬度查询：http://lbs.amap.com/console/show/picker
     *
     * @return self
     */
     ...
     * Sets mainShopName
     *
     * @param string|null $mainShopName 主门店名  比如：肯德基；主店名里不要包含分店名，如“万塘路店”。主店名长度不能超过20个字符。
     *
     * @return self
     */
     ...
     * Sets notifyMobile
     *
     * @param string|null $notifyMobile 门店店长电话号码；用于接收门店状态变更通知，收款成功通知等通知消息， 不在客户端展示。
     *
     * @return self
     */
     ...
     *
     * @param string|null $operateNotifyUrl 当商户的门店审核状态发生变化时，会向该地址推送消息。
     *
     * @return self
     */
     ...
     * Sets provinceCode
     *
     * @param string|null $provinceCode 省份编码，国标码，详见国家统计局数据 <a href=\"https://gw.alipayobjects.com/os/basement_prod/92d874c4-39a9-4977-b710-d55dad374b7f.csv\">点此下载</a>。
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getRefApplyId()
    {
        return $this->container['refApplyId'];
    }

    /**
     * Sets refApplyId
     *
     * @param string|null $refApplyId （支付宝内部参数）leads开店重试支付宝流水ID。
     *
     * @return self
     */
    public function setRefApplyId($refApplyId)
    {
        $this->container['refApplyId'] = $refApplyId;
     ...
     * Sets requestId
     *
     * @param string|null $requestId 支持英文字母和数字，由开发者自行定义（不允许重复），在门店notify消息中也会带有该参数，以此标明本次notify消息是对哪个请求的回应。
     *
     * @return self
     */
