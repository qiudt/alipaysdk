...
/**
 * AlipayOpenMiniExperienceCreateModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenMiniExperienceCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenMiniExperienceCreateModel';
     ...
     * Sets appVersion
     *
     * @param string|null $appVersion 商家小程序版本号。
     *
     * @return self
     */
