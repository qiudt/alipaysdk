...
class AuthenticationResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['authenticationData'] = $data['authenticationData'] ?? null;
        $this->container['authenticationMechanism'] = $data['authenticationMechanism'] ?? null;
    }
     ...
     *
     * @param string|null $authenticationData 已加密的鉴权数据
     *
     * @return self
     */
     ...
     *
     * @param string|null $authenticationMechanism 鉴权类型，如：支付密码、数字签名
     *
     * @return self
     */
