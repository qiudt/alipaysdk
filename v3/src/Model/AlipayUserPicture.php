...
/**
 * AlipayUserPicture Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayUserPicture implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayUserPicture';
    ...
    {
        $this->container['pictureType'] = $data['pictureType'] ?? null;
     ...
     * Sets pictureType
     *
     * @param string|null $pictureType 图片类型，包括身份证正反面、营业执照等
     *
     * @return self
     */
     ...
     * Sets pictureUrl
     *
     * @param string|null $pictureUrl 用于调用alipay.user.certify.image.fetch接口，获取图片资源
     *
     * @return self
     */
