...
/**
 * AlipayEbppInvoiceExpenserulesProjectemployeeModifyModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayEbppInvoiceExpenserulesProjectemployeeModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayEbppInvoiceExpenserulesProjectemployeeModifyModel';
     ...
     *
     * @param string[]|null $addEmployeeList 切换open_id前使用此字段： 需要添加的员工UID列表 约束：一次最多50个
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $addEmployeeOpenIdList 切换open_id后使用此字段： 需要添加的员工open_id列表 约束：一次最多50个
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $removeEmployeeList 切换open_id前使用此字段： 需要移除的员工UID列表 约束：一次最多50个
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $removeEmployeeOpenIdList 切换open_id后前使用此字段： 需要移除的员工open_id列表 约束：一次最多50个
     *
     * @return self
     */
