...
/**
 * AlipayOpenMiniWidgetGoodsUploadModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenMiniWidgetGoodsUploadModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenMiniWidgetGoodsUploadModel';
     ...
     * Sets miniAppId
     *
     * @param string|null $miniAppId 用于承接品的商家小程序ID
     *
     * @return self
     */
