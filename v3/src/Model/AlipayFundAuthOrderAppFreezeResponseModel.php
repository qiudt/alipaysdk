...
class AlipayFundAuthOrderAppFreezeResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['orderStr'] = $data['orderStr'] ?? null;
    ...
    {
        return $this->container['orderStr'];
    }

    /**
     * Sets orderStr
     *
     * @param string|null $orderStr 获取签名后的业务数据
     *
     * @return self
     */
    public function setOrderStr($orderStr)
    {
        $this->container['orderStr'] = $orderStr;
