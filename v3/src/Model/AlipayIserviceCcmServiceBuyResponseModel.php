...
/**
 * AlipayIserviceCcmServiceBuyResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayIserviceCcmServiceBuyResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayIserviceCcmServiceBuyResponseModel';
    ...
    {
        $this->container['serviceInstanceId'] = $data['serviceInstanceId'] ?? null;
     ...
     *
     * @param int|null $serviceInstanceId 服务实例id
     *
     * @return self
     */
     ...
     * Sets tenantId
     *
     * @param string|null $tenantId 商户在CCM的租户id
     *
     * @return self
     */
