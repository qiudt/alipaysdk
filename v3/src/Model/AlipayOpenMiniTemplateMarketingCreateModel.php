...
/**
 * AlipayOpenMiniTemplateMarketingCreateModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenMiniTemplateMarketingCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenMiniTemplateMarketingCreateModel';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['templateIds'] = $data['templateIds'] ?? null;
     ...
     * Sets activityId
     *
     * @param string|null $activityId 营销活动id
     *
     * @return self
     */
     ...
     * Sets gmtEnd
     *
     * @param string|null $gmtEnd 活动结束时间
     *
     * @return self
     */
     ...
     * Sets gmtStart
     *
     * @param string|null $gmtStart 活动开始时间
     *
     * @return self
     */
     ...
     * Sets templateIds
     *
     * @param string[]|null $templateIds 消息模板id列表，最多50个模板id
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title 消息运营位名称，不填默认使用券名称
     *
     * @return self
     */
