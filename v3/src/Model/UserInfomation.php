...
/**
 * UserInfomation Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class UserInfomation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserInfomation';
     ...
     * Sets userId
     *
     * @param string|null $userId 支付宝用户ID，可以通过支付结果通知、用户授权等渠道获取
     *
     * @return self
     */
