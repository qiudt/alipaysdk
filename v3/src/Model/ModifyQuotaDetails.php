...
/**
 * ModifyQuotaDetails Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class ModifyQuotaDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModifyQuotaDetails';
     ...
     * Sets quotaAmount
     *
     * @param string|null $quotaAmount 具体额度，单位：元。如金额为空，表示删除已有的额度设置，无已有额度设置则忽略。
     *
     * @return self
     */
     ...
     * Sets quotaDimension
     *
     * @param string|null $quotaDimension 额度维度 MONTH/DAY/SINGLE 分别代表月、日、单次
     *
     * @return self
     */
     ...
     * Sets role
     *
     * @param string|null $role PAYER/PAYEE 额度管控的角色，收or付款方，目前只支持付款方
     *
     * @return self
     */
