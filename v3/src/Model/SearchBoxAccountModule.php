...
/**
 * SearchBoxAccountModule Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class SearchBoxAccountModule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchBoxAccountModule';
    ...
    protected static $openAPITypes = [
        'appInfos' => '\Alipay\OpenAPISDK\Model\SearchBoxAppInfo[]',
        'moduleId' => 'string',
        'moduleType' => 'string'
    ];
     ...
     * Sets appInfos
     *
     * @param \Alipay\OpenAPISDK\Model\SearchBoxAppInfo[]|null $appInfos 应用信息列表
     *
     * @return self
     */
