...
/**
 * VoucherInventoryInfo Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class VoucherInventoryInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VoucherInventoryInfo';
     ...
     * Sets sendCount
     *
     * @param int|null $sendCount 已发放数量。
     *
     * @return self
     */
