...
class AlipayEbppInvoiceInstitutionDetailinfoQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets adapterType
     *
     * @param string|null $adapterType 若适用范围为EMPLOYEE_ALL，则表示制度对企业下全员生效，owner_id_list不返回；若适配范围为EMPLOYEE_SELECT，owner_id_list返回员工对应的id信息，返回的id类型通过owner_type区分；若适配范围为EMPLOYEE_DEPARTMENT，则表示对指定的部门生效，返回owner_id_list为部门id列表
     *
     * @return self
     */
     ...
     * Sets consultMode
     *
     * @param string|null $consultMode 费控咨询模式
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency 制度下可发放币种
     *
     * @return self
     */
     ...
     * Sets effective
     *
     * @param string|null $effective 制度启用停用状态
     *
     * @return self
     */
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\IssueRuleInfo[]|null $issueRuleInfoList 发放规则信息列表
     *
     * @return self
     */
     ...
     * Sets outerSourceId
     *
     * @param string|null $outerSourceId 外部唯一标识
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $ownerOpenIdList 适配开放id列表
     *
     * @return self
     */
     ...
     * Sets ownerType
     *
     * @param string|null $ownerType 适配id类型
     *
     * @return self
     */
