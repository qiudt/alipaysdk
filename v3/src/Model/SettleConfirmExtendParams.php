...
/**
 * SettleConfirmExtendParams Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class SettleConfirmExtendParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SettleConfirmExtendParams';
     ...
     * Sets royaltyFreeze
     *
     * @param string|null $royaltyFreeze 是否进行资金冻结，用于后续分账，true表示冻结，false或不传表示不冻结
     *
     * @return self
     */
