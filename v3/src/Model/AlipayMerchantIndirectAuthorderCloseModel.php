...
/**
 * AlipayMerchantIndirectAuthorderCloseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayMerchantIndirectAuthorderCloseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayMerchantIndirectAuthorderCloseModel';
     ...
     * Sets orderNo
     *
     * @param string|null $orderNo 意愿申请单号，参数二选一
     *
     * @return self
     */
