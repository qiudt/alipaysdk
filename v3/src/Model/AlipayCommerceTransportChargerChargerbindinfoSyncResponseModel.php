...
/**
 * AlipayCommerceTransportChargerChargerbindinfoSyncResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayCommerceTransportChargerChargerbindinfoSyncResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayCommerceTransportChargerChargerbindinfoSyncResponseModel';
     ...
     * Sets equipId
     *
     * @param string|null $equipId 商户同步的充电桩设备编码
     *
     * @return self
     */
     ...
     * Sets failReason
     *
     * @param string|null $failReason 绑定关系结果接收失败原因
     *
     * @return self
     */
     ...
     * Sets resultStatus
     *
     * @param string|null $resultStatus 0：成功 1：拒绝
     *
     * @return self
     */
