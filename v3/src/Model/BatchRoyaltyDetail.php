...
/**
 * BatchRoyaltyDetail Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class BatchRoyaltyDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchRoyaltyDetail';
    ...
    protected static $attributeMap = [
        ...
        'transInAccountOpenId' => 'trans_in_account_open_id',
    ...
    protected static $setters = [
        ...
        'transInAccountOpenId' => 'setTransInAccountOpenId',
    ...
    protected static $getters = [
        ...
        'transInAccountOpenId' => 'getTransInAccountOpenId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['transInAccountOpenId'] = $data['transInAccountOpenId'] ?? null;
     ...
     * Sets amount
     *
     * @param string|null $amount 分账金额，单位元
     *
     * @return self
     */
     ...
     * Sets errorCode
     *
     * @param string|null $errorCode 错误编码 BANK_CARD_ERROR：银行卡信息有误的场景，系统自动重试中 BANK_DISHONOR：银行退票
     *
     * @return self
     */
     ...
     *
     * @param string|null $transInAccountId 分账转入账户id。当分账账户id类型是cardSerialNo时，本参数为用户在支付宝绑定的卡编号；当分账账户id类型是userId时，本参数为用户的支付宝账号对应的支付宝唯一用户号；当分账账户id类型是loginName时，本参数为用户的支付宝登录号。
     *
     * @return self
     */
     ...
     *
     * @param string|null $transInAccountIdType 分账转入账户id类型。 当settle_account_type 为bankCard时，本参数为cardSerialNo，表示分账账户id是银行卡编号; 当settle_account_type 为alipayBalance时，本参数为userId或者loginName，其中userId表示分账账户id是支付宝唯一用户号，loginName表示分账账户id是支付宝登录号。
     *
     * @return self
     */
    ...
    /**
     * Gets transInAccountOpenId
     *
     * @return string|null
     */
    public function getTransInAccountOpenId()
    {
        return $this->container['transInAccountOpenId'];
    }

    /**
     * Sets transInAccountOpenId
     *
     * @param string|null $transInAccountOpenId 分账转入方的OpenId，OpenId是用户在应用（AppId）下的唯一用户标识。
     *
     * @return self
     */
    public function setTransInAccountOpenId($transInAccountOpenId)
    {
        $this->container['transInAccountOpenId'] = $transInAccountOpenId;
     ...
     *
     * @param string|null $transInAccountType 分账账户类型。 bankCard: 分账账户为银行卡； alipayBalance: 分账账户为支付宝余额户
     *
     * @return self
     */
     ...
     *
     * @param string|null $transInEntityId 分账转出主体账号。    当分账转出主体类型为SecondMerchant，本参数为二级商户的SecondMerchantID    当分账转出类型为Store，本参数为StoreID
     *
     * @return self
     */
     ...
     *
     * @param string|null $transOutEntityId 分账转出主体账号。    当分账转出主体类型为SecondMerchant，本参数为二级商户的SecondMerchantID    当分账转出类型为Store，本参数为StoreID
     *
     * @return self
     */
