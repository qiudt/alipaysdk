<?php
/**
 * AlipayPcreditHuabeiAuthRefundApplyDefaultResponse
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AlipayPcreditHuabeiAuthRefundApplyDefaultResponse Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayPcreditHuabeiAuthRefundApplyDefaultResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'alipay_pcredit_huabei_auth_refund_apply_default_response';
    ...
    public const CODE_REFUND_AGREEMENT_AND_USER_NOT_MATCH = 'REFUND_AGREEMENT_AND_USER_NOT_MATCH';
    ...
    public const CODE_REFUND_TRADE_NO_AND_AUTH_OPT_NOT_MATCH = 'REFUND_TRADE_NO_AND_AUTH_OPT_NOT_MATCH';
    public const CODE_REFUND_PARAM_OPT_ORDER_AND_TRADE_NO_ALL_EMPTY = 'REFUND_PARAM_OPT_ORDER_AND_TRADE_NO_ALL_EMPTY';
    public const CODE_REFUND_AGREEMENT_AND_PARTNER_NOT_MATCH = 'REFUND_AGREEMENT_AND_PARTNER_NOT_MATCH';
    ...
    public function getCodeAllowableValues()
    {
        return [
            ...
            self::CODE_REFUND_AGREEMENT_AND_USER_NOT_MATCH,
            self::CODE_REFUND_AMOUNT_IS_ILLEGAL,
            self::CODE_REFUND_PAY_AMOUNT_IS_EMPTY,
            self::CODE_REFUND_AMOUNT_IS_ZERO,
            self::CODE_REFUND_TRADE_NO_AND_AUTH_OPT_NOT_MATCH,
            self::CODE_REFUND_PARAM_OPT_ORDER_AND_TRADE_NO_ALL_EMPTY,
            self::CODE_REFUND_AGREEMENT_AND_PARTNER_NOT_MATCH,
