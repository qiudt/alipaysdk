...
/**
 * AlipayMarketingActivityDeliveryQueryModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayMarketingActivityDeliveryQueryModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayMarketingActivityDeliveryQueryModel';
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\DeliveryConfig[]|null $deliveryConfigList \"[已废弃] 待查询的投放配置列表。 最大数量限制20个。\"
     *
     * @return self
     */
