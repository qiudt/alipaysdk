...
/**
 * AlipayFundJointaccountListQueryResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayFundJointaccountListQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayFundJointaccountListQueryResponseModel';
    ...
    protected static $openAPITypes = [
        'accountList' => '\Alipay\OpenAPISDK\Model\JointAccountDTO[]',
        'bizScene' => 'string',
        'productCode' => 'string'
    ];
    ...
    {
        $this->container['accountList'] = $data['accountList'] ?? null;
     ...
     * Gets accountList
     *
     * @return \Alipay\OpenAPISDK\Model\JointAccountDTO[]|null
     */
     ...
     * Sets accountList
     *
     * @param \Alipay\OpenAPISDK\Model\JointAccountDTO[]|null $accountList 共同账户列表
     *
     * @return self
     */
