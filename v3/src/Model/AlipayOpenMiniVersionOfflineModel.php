...
/**
 * AlipayOpenMiniVersionOfflineModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenMiniVersionOfflineModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenMiniVersionOfflineModel';
     ...
     * Sets appVersion
     *
     * @param string|null $appVersion 商家小程序已上架版本号。
     *
     * @return self
     */
