...
/**
 * InstitutionScopeInfo Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class InstitutionScopeInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InstitutionScopeInfo';
     ...
     * Sets adapterType
     *
     * @param string|null $adapterType 制度适用范围，支持配置全员、指定员工和指定部门
     *
     * @return self
     */
     ...
     * Sets ownerIdList
     *
     * @param string[]|null $ownerIdList 适用范围归属id列表
     *
     * @return self
     */
     ...
     * Sets ownerType
     *
     * @param string|null $ownerType 员工id类型
     *
     * @return self
     */
