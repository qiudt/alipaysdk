...
/**
 * StandardIdInfo Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class StandardIdInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StandardIdInfo';
     ...
     * Sets outerSourceId
     *
     * @param string|null $outerSourceId 外部使用规则id
     *
     * @return self
     */
