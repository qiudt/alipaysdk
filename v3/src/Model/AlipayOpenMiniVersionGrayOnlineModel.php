...
/**
 * AlipayOpenMiniVersionGrayOnlineModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenMiniVersionGrayOnlineModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenMiniVersionGrayOnlineModel';
     ...
     * Sets appVersion
     *
     * @param string|null $appVersion 商家小程序版本号，需为审核通过状态的小程序版本。
     *
     * @return self
     */
     ...
     * Sets grayStrategy
     *
     * @param string|null $grayStrategy 小程序灰度策略值
     *
     * @return self
     */
