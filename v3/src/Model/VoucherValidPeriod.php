...
/**
 * VoucherValidPeriod Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class VoucherValidPeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VoucherValidPeriod';
     ...
     *
     * @param int|null $validDaysAfterReceive 券生效后N天内可以使用。可以配合wait_days_after_receive字段使用。
     *
     * @return self
     */
     ...
     *
     * @param int|null $waitDaysAfterReceive 用户领券后需要等待N天，券才可以生效。如果该字段填入0或者不填写，则用户领券后立刻生效。
     *
     * @return self
     */
