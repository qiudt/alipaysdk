...
/**
 * SearchBaseItems Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class SearchBaseItems implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchBaseItems';
     ...
     * Sets canSearch
     *
     * @param bool|null $canSearch 搜索可见性
     *
     * @return self
     */
     ...
     * Sets keyWords
     *
     * @param string[]|null $keyWords 提报关键词列表
     *
     * @return self
     */
