...
/**
 * AlipayMarketingCardQueryResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayMarketingCardQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayMarketingCardQueryResponseModel';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['passId'] = $data['passId'] ?? null;
     ...
     * Sets passId
     *
     * @param string|null $passId 商家会员卡页面跳转到支付宝卡券详情页的pass_id，对应schema地址中的参数p， 主要用于小程序跳往会员卡详情的链接拼接
     *
     * @return self
     */
     ...
     * Sets schemaUrl
     *
     * @param string|null $schemaUrl 商家会员卡页面跳转到支付宝卡券详情页面的schema地址
     *
     * @return self
     */
