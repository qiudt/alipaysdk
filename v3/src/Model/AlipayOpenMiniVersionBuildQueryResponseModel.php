...
/**
 * AlipayOpenMiniVersionBuildQueryResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenMiniVersionBuildQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenMiniVersionBuildQueryResponseModel';
     ...
     * Sets createStatus
     *
     * @param string|null $createStatus 创建版本的状态，状态说明如下： 0：构建排队中； 1：正在构建； 2：构建成功； 3：构建失败； 5：构建超时； 6：版本创建成功。
     *
     * @return self
     */
     ...
     * Sets versionCreated
     *
     * @param string|null $versionCreated 是否创建版本
     *
     * @return self
     */
