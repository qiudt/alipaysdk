...
/**
 * ShopCategoryInfo Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class ShopCategoryInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShopCategoryInfo';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['categoryLevel'] = $data['categoryLevel'] ?? null;
     ...
     * Sets categoryId
     *
     * @param string|null $categoryId 类目编号
     *
     * @return self
     */
     ...
     * Sets categoryLevel
     *
     * @param string|null $categoryLevel 类目层级,目前最多支持1、2、3三级
     *
     * @return self
     */
