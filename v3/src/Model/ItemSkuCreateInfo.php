...
/**
 * ItemSkuCreateInfo Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class ItemSkuCreateInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemSkuCreateInfo';
     ...
     * Sets externalSkuId
     *
     * @param string|null $externalSkuId 外部SKU ID
     *
     * @return self
     */
