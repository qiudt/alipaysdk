...
/**
 * AlipayIserviceCcmSwTreecategoryModifyModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayIserviceCcmSwTreecategoryModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayIserviceCcmSwTreecategoryModifyModel';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['fatherId'] = $data['fatherId'] ?? null;
     ...
     * Sets fatherId
     *
     * @param string|null $fatherId 父节点ID
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string|null $tags 标签。KNOWLEDGE（知识库）；PLATFORM（公有云工作台）；HELP（公有云帮助中心）
     *
     * @return self
     */
