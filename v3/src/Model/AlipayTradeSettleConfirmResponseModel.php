...
/**
 * AlipayTradeSettleConfirmResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayTradeSettleConfirmResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayTradeSettleConfirmResponseModel';
     ...
     * Sets settleAmount
     *
     * @param string|null $settleAmount 本次确认结算的实际结算金额，单位为元。
     *
     * @return self
     */
