...
/**
 * QueryComplexLabelRule Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class QueryComplexLabelRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QueryComplexLabelRule';
     ...
     * Sets labelValue
     *
     * @param string|null $labelValue 当有多个取值时用英文\",\"分隔，不允许传入下划线\"_\"、竖线\"|\"或者空格\" \"
     *
     * @return self
     */
