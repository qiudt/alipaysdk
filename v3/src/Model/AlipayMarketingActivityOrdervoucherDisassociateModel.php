...
/**
 * AlipayMarketingActivityOrdervoucherDisassociateModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayMarketingActivityOrdervoucherDisassociateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayMarketingActivityOrdervoucherDisassociateModel';
     ...
     * Sets tradeNo
     *
     * @param string|null $tradeNo 该交易在支付宝系统中的交易流水号。
     *
     * @return self
     */
     ...
     * Sets voucherCode
     *
     * @param string|null $voucherCode 券码。 限制: 券码必须已发放给用户。
     *
     * @return self
     */
