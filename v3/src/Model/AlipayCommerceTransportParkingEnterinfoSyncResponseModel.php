...
/**
 * AlipayCommerceTransportParkingEnterinfoSyncResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayCommerceTransportParkingEnterinfoSyncResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayCommerceTransportParkingEnterinfoSyncResponseModel';
     ...
     * Sets bizCode
     *
     * @param string|null $bizCode 具体错误code
     *
     * @return self
     */
     ...
     * Sets bizMsg
     *
     * @param string|null $bizMsg 具体错误描述
     *
     * @return self
     */
     ...
     * Sets serialNo
     *
     * @param string|null $serialNo 支付宝停车纪录流水号，串联一次停车行为；
     *
     * @return self
     */
