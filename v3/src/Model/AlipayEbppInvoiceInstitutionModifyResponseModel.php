...
/**
 * AlipayEbppInvoiceInstitutionModifyResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayEbppInvoiceInstitutionModifyResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayEbppInvoiceInstitutionModifyResponseModel';
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\IssueRuleIdInfo[]|null $issueRuleIdInfoList 新增发放规则时返回外部幂等id和发放规则id的映射关系
     *
     * @return self
     */
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\StandardIdInfo[]|null $standardIdInfoList 新增使用规则后会返回外部幂等id和使用规则id的映射关系
     *
     * @return self
     */
