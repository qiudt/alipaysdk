...
/**
 * AlipayMarketingActivityVoucherAppendModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayMarketingActivityVoucherAppendModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayMarketingActivityVoucherAppendModel';
     ...
     *
     * @param int|null $voucherQuantity 发行券的数量。。 限制： 券总预算<= 99999999 特别说明： 该字段的含义是追加到的数量。 不可减少，只能增加。
     *
     * @return self
     */
