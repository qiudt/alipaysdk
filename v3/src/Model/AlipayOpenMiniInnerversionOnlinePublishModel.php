...
/**
 * AlipayOpenMiniInnerversionOnlinePublishModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenMiniInnerversionOnlinePublishModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenMiniInnerversionOnlinePublishModel';
     ...
     * Sets downgrade
     *
     * @param bool|null $downgrade 否服务降级，如果降级，拉包策略如果端上有本地包，则使用本地包打开，同时异步下载新包，待下次打开则使用新包
     *
     * @return self
     */
     ...
     * Sets releaseType
     *
     * @param string|null $releaseType normal默认普通发布，high 高保发布
     *
     * @return self
     */
