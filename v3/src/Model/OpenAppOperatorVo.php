...
/**
 * OpenAppOperatorVo Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class OpenAppOperatorVo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OpenAppOperatorVo';
     ...
     * Sets logonId
     *
     * @param string|null $logonId 登录账号
     *
     * @return self
     */
     ...
     * Sets portrait
     *
     * @param string|null $portrait 用户头像
     *
     * @return self
     */
