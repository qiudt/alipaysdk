...
/**
 * ZhimaCustomerJobworthPositionAddResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class ZhimaCustomerJobworthPositionAddResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ZhimaCustomerJobworthPositionAddResponseModel';
     ...
     * Sets positionId
     *
     * @param string|null $positionId 岗位信息ID
     *
     * @return self
     */
     ...
     * Sets subCode
     *
     * @param string|null $subCode 业务错误
     *
     * @return self
     */
     ...
     * Sets subMsg
     *
     * @param string|null $subMsg 业务错误信息
     *
     * @return self
     */
