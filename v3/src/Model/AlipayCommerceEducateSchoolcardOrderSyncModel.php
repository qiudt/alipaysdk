...
class AlipayCommerceEducateSchoolcardOrderSyncModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets actualAmount
     *
     * @param string|null $actualAmount 实际金额（总支付金额），单位为【元】
     *
     * @return self
     */
     ...
     * Sets cardType
     *
     * @param string|null $cardType 校园卡类型
     *
     * @return self
     */
     ...
     * Sets createTime
     *
     * @param string|null $createTime 该笔订单真实的创建时间，需精确到毫秒。
     *
     * @return self
     */
     ...
     * Sets modifiedTime
     *
     * @param string|null $modifiedTime 订单修改时间
     *
     * @return self
     */
     ...
     * Sets outBizNo
     *
     * @param string|null $outBizNo 外部业务号，由商家自定义，128个字符以内，仅支持字母、数字、下划线且需保证在商户端不重复。
     *
     * @return self
     */
     ...
     * Sets rakeBackPid
     *
     * @param string|null $rakeBackPid 系统商编号。该参数作为系统商返佣数据提取的依据，请填写系统商签约协议的PID
     *
     * @return self
     */
     ...
     * Sets schoolId
     *
     * @param string|null $schoolId 学校内标，录入学校接口返回的参数
     *
     * @return self
     */
     ...
     * Sets schoolPid
     *
     * @param string|null $schoolPid 学校收款账号
     *
     * @return self
     */
     ...
     * Sets userId
     *
     * @param string|null $userId 买家支付宝用户ID。 2088开头的16位纯数字，小程序场景下获取用户ID请参考：用户授权; 其它场景下获取用户ID请参考：网页授权获取用户信息;
     *
     * @return self
     */
