...
/**
 * AlipayIserviceCcmRoleGetResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayIserviceCcmRoleGetResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayIserviceCcmRoleGetResponseModel';
     ...
     * Sets functionIds
     *
     * @param string[]|null $functionIds 角色关联的功能点id
     *
     * @return self
     */
