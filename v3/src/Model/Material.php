...
class Material implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets articles
     *
     * @param \Alipay\OpenAPISDK\Model\Article[]|null $articles 图文消息子消息项集合，单条消息最多6个子项，否则会发送失败
     *
     * @return self
     */
     ...
     * Sets msgType
     *
     * @param string|null $msgType 消息类型，text：文本类型，image-text：图文类型。当消息类型为text时，text参数必传，当消息类型为image-text时，articles参数必传
     *
     * @return self
     */
