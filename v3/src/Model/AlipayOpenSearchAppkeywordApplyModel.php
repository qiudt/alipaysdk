...
/**
 * AlipayOpenSearchAppkeywordApplyModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenSearchAppkeywordApplyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenSearchAppkeywordApplyModel';
     ...
     * Sets configId
     *
     * @param string|null $configId 关键词配置id，由支付宝生成，关键词申请通过后会通知接口返回，也可以申请单状态获取
     *
     * @return self
     */
     ...
     * Sets keyWords
     *
     * @param string[]|null $keyWords 提报的关键词
     *
     * @return self
     */
