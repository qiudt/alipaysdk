...
class AlipayTradeQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'extInfos' => 'string',
        'fulfillmentDetailList' => '\Alipay\OpenAPISDK\Model\FulfillmentDetail[]',
        ...
        'reqGoodsDetail' => '\Alipay\OpenAPISDK\Model\GoodsDetail[]',
        'sendPayDate' => 'string',
        'settleAmount' => 'string',
    ...
    protected static $attributeMap = [
        ...
        'extInfos' => 'ext_infos',
        'fulfillmentDetailList' => 'fulfillment_detail_list',
    ...
    protected static $setters = [
        'additionalStatus' => 'setAdditionalStatus',
        ...
        'fulfillmentDetailList' => 'setFulfillmentDetailList',
        ...
        'reqGoodsDetail' => 'setReqGoodsDetail',
    ...
    protected static $getters = [
        'additionalStatus' => 'getAdditionalStatus',
        ...
        'fulfillmentDetailList' => 'getFulfillmentDetailList',
        ...
        'reqGoodsDetail' => 'getReqGoodsDetail',
    ...
    {
        $this->container['additionalStatus'] = $data['additionalStatus'] ?? null;
        ...
        $this->container['cashierType'] = $data['cashierType'] ?? null;
        ...
        $this->container['fulfillmentDetailList'] = $data['fulfillmentDetailList'] ?? null;
        ...
        $this->container['periodScene'] = $data['periodScene'] ?? null;
        ...
        $this->container['reqGoodsDetail'] = $data['reqGoodsDetail'] ?? null;
    ...
    /**
     * Gets additionalStatus
     *
     * @return string|null
     */
    public function getAdditionalStatus()
    {
        return $this->container['additionalStatus'];
    }

    /**
     * Sets additionalStatus
     *
     * @param string|null $additionalStatus 交易附加状态： SELLER_NOT_RECEIVED（买家已付款，卖家未收款）；
     *
     * @return self
     */
    public function setAdditionalStatus($additionalStatus)
    {
        $this->container['additionalStatus'] = $additionalStatus;
     ...
     *
     * @param string|null $asyncPayApplyStatus 异步支付受理状态，仅异步支付模式且query_options指定async_pay_info时返回。S：受理成功，支付宝内部会在一定期限内捞起任务推进支付，直到支付成功或超出可重试期限；其它：受理结果未知，可重试查询。
     *
     * @return self
     */
     ...
     * Sets cashierType
     *
     * @param string|null $cashierType 收银台类型。  用户支付的收银台类型，取值如下：  APP：支付宝APP收银台支付；  WAP：支付H5收银台支付；  注：只有在无线产品支付接口请求中query_options指定cashier_type才返回该字段。
     *
     * @return self
     */
    ...
    /**
     * Gets fulfillmentDetailList
     *
     * @return \Alipay\OpenAPISDK\Model\FulfillmentDetail[]|null
     */
    public function getFulfillmentDetailList()
    {
        return $this->container['fulfillmentDetailList'];
    }

    /**
     * Sets fulfillmentDetailList
     *
     * @param \Alipay\OpenAPISDK\Model\FulfillmentDetail[]|null $fulfillmentDetailList 履约详情列表。 只有入参的query_options中指定fulfillment_detail_list并且所查询的交易存在履约明细时才返回该字段信息。
     *
     * @return self
     */
    public function setFulfillmentDetailList($fulfillmentDetailList)
    {
        $this->container['fulfillmentDetailList'] = $fulfillmentDetailList;
    ...
    {
        return $this->container['periodScene'];
    }

    /**
     * Sets periodScene
     *
     * @param string|null $periodScene 该字段用于描述当前账期交易的场景。
     *
     * @return self
     */
    public function setPeriodScene($periodScene)
    {
        $this->container['periodScene'] = $periodScene;
    ...
    {
        return $this->container['reqGoodsDetail'];
    }

    /**
     * Sets reqGoodsDetail
     *
     * @param \Alipay\OpenAPISDK\Model\GoodsDetail[]|null $reqGoodsDetail 支付请求的商品明细列表
     *
     * @return self
     */
    public function setReqGoodsDetail($reqGoodsDetail)
    {
        $this->container['reqGoodsDetail'] = $reqGoodsDetail;
