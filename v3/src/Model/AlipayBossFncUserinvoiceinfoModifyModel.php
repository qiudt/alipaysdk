...
/**
 * AlipayBossFncUserinvoiceinfoModifyModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayBossFncUserinvoiceinfoModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayBossFncUserinvoiceinfoModifyModel';
     ...
     * Sets hold
     *
     * @param bool|null $hold 是否暂停开票，商户修改无效，如果要暂停开票，只能去结算中台处理。
     *
     * @return self
     */
     ...
     * Sets telephone
     *
     * @param string|null $telephone 公司注册电话  一般纳税人必须填写，小规模纳税人无需填写
     *
     * @return self
     */
