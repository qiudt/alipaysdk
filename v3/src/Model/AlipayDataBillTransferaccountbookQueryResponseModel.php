...
/**
 * AlipayDataBillTransferaccountbookQueryResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayDataBillTransferaccountbookQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayDataBillTransferaccountbookQueryResponseModel';
    ...
    protected static $openAPITypes = [
        'detailList' => '\Alipay\OpenAPISDK\Model\TransferAccountBookDetailResult[]',
        'pageNo' => 'string',
        'pageSize' => 'string',
        'totalSize' => 'string'
    ];
     ...
     * Gets detailList
     *
     * @return \Alipay\OpenAPISDK\Model\TransferAccountBookDetailResult[]|null
     */
     ...
     * Sets detailList
     *
     * @param \Alipay\OpenAPISDK\Model\TransferAccountBookDetailResult[]|null $detailList 充值、提现、转账明细记录
     *
     * @return self
     */
     ...
     * Sets totalSize
     *
     * @param string|null $totalSize 充值、提现、转账明细总数。返回满足查询条件的明细的数量
     *
     * @return self
     */
