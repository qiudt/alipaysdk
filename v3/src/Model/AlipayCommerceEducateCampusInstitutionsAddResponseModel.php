...
/**
 * AlipayCommerceEducateCampusInstitutionsAddResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayCommerceEducateCampusInstitutionsAddResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayCommerceEducateCampusInstitutionsAddResponseModel';
     ...
     * Sets instId
     *
     * @param string|null $instId 学校内标。如果入驻成功，返回学校内标；入驻失败则不返回学校内标。
     *
     * @return self
     */
     ...
     * Sets instStdCode
     *
     * @param string|null $instStdCode 学校外标。如果入驻成功，返回学校外标；入驻失败则不返回学校外标。
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string|null $reason 入驻失败原因
     *
     * @return self
     */
