...
/**
 * AlipayTradePrecreateModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayTradePrecreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayTradePrecreateModel';
    ...
    protected static $attributeMap = [
        ...
        'qrCodeTimeoutExpress' => 'qr_code_timeout_express',
    ...
    protected static $setters = [
        ...
        'qrCodeTimeoutExpress' => 'setQrCodeTimeoutExpress',
    ...
    protected static $getters = [
        ...
        'qrCodeTimeoutExpress' => 'getQrCodeTimeoutExpress',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['qrCodeTimeoutExpress'] = $data['qrCodeTimeoutExpress'] ?? null;
     ...
     * Sets codeType
     *
     * @param string|null $codeType 码类型，如果请求时传入了share_code，将在响应参数返回吱口令；如果为空，则默认为订单码
     *
     * @return self
     */
     ...
     * Sets goodsDetail
     *
     * @param \Alipay\OpenAPISDK\Model\GoodsDetail[]|null $goodsDetail 订单包含的商品列表信息.json格式. 其它说明详见：“商品明细说明”
     *
     * @return self
     */
    ...
    /**
     * Gets qrCodeTimeoutExpress
     *
     * @return string|null
     */
    public function getQrCodeTimeoutExpress()
    {
        return $this->container['qrCodeTimeoutExpress'];
    }

    /**
     * Sets qrCodeTimeoutExpress
     *
     * @param string|null $qrCodeTimeoutExpress 二维码订单相对超时时间。 该笔订单允许的最晚付款时间，逾期将关闭交易，从生成二维码开始计时。 取值范围：1m～15d。m-分钟，h-小时，d-天，1c-当天（1c-当天的情况下，无论交易何时创建，都在0点关闭）。 该参数数值不接受小数点， 如 1.5h，可转换为 90m。 注：二维码最长有效期是2小时，不管该参数传递的值是多少，超过2小时后二维码都将失效不能再进行扫码支付。
     *
     * @return self
     */
    public function setQrCodeTimeoutExpress($qrCodeTimeoutExpress)
    {
        $this->container['qrCodeTimeoutExpress'] = $qrCodeTimeoutExpress;
     ...
     * Sets queryOptions
     *
     * @param string[]|null $queryOptions 返回参数选项。 商户通过传递该参数来定制需要额外返回的信息字段，数组格式。包括但不限于：[\"hyb_amount\",\"enterprise_pay_info\"]
     *
     * @return self
     */
     ...
     * Sets timeoutExpress
     *
     * @param string|null $timeoutExpress 订单相对超时时间。 从预下单请求时间开始计算。 该笔订单允许的最晚付款时间，逾期将关闭交易。取值范围：1m～15d。m-分钟，h-小时，d-天，1c-当天（1c-当天的情况下，无论交易何时创建，都在0点关闭）。 该参数数值不接受小数点， 如 1.5h，可转换为 90m。  当面付场景默认值为3h，如需指定，推荐设置5m及以上  注： 1. 二维码最长有效期是2小时，不管该参数传递的值是多少，超过2小时后二维码都将失效不能再进行扫码支付。 2. time_expire和timeout_express两者只需传入一个或者都不传，如果两者都传，优先使用time_expire。
     *
     * @return self
     */
