...
/**
 * AlipayMarketingActivityDeliveryStopResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayMarketingActivityDeliveryStopResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayMarketingActivityDeliveryStopResponseModel';
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\ErrorDeliveryConfig[]|null $errorDeliveryConfigList 停止失败的投放配置列表
     *
     * @return self
     */
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\SuccessDeliveryConfig[]|null $successDeliveryConfigList 停止成功的投放配置列表
     *
     * @return self
     */
