...
/**
 * InviteMemberBusinessParamsDTO Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class InviteMemberBusinessParamsDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InviteMemberBusinessParamsDTO';
     ...
     * Sets employeeId
     *
     * @param string|null $employeeId 企业员工工卡
     *
     * @return self
     */
     ...
     * Sets groupIdList
     *
     * @param string[]|null $groupIdList 员工关联的群组ID，当前系统仅支持一个
     *
     * @return self
     */
