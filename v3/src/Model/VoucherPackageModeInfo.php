...
/**
 * VoucherPackageModeInfo Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class VoucherPackageModeInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VoucherPackageModeInfo';
     ...
     *
     * @param string|null $voucherPackageId 券包id，对应alipay.marketing.activity.voucherpackage.query中voucher_package_id。
     *
     * @return self
     */
