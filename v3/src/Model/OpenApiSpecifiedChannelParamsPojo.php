...
/**
 * OpenApiSpecifiedChannelParamsPojo Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class OpenApiSpecifiedChannelParamsPojo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OpenApiSpecifiedChannelParamsPojo';
     ...
     * Sets assetTypeCode
     *
     * @param string|null $assetTypeCode 资产类型编码，具体传参值请联系技术进行分配。
     *
     * @return self
     */
