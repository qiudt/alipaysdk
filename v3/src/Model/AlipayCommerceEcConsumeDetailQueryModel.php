...
class AlipayCommerceEcConsumeDetailQueryModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets accountId
     *
     * @param string|null $accountId 共同账户ID(该字段将废弃，不建议使用，可用enterprise_id字段替换)
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets agreementNo
     *
     * @param string|null $agreementNo 授权签约协议号(该字段将废弃，不建议使用，可用enterprise_id字段替换)
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets queryOptions
     *
     * @param string[]|null $queryOptions 查询选项
     *
     * @return self
     */
