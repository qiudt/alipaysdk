...
/**
 * ZMGoOutDiscountInfo Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class ZMGoOutDiscountInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ZMGoOutDiscountInfo';
     ...
     * Sets discountName
     *
     * @param string|null $discountName 商户数据回传的优惠信息的名称
     *
     * @return self
     */
     ...
     * Sets discountType
     *
     * @param string|null $discountType 优惠信息的类型。为枚举值，商户可任意选择一个值作为入参传入。可取值： (\"exclusiveBenefit\",\"专享优惠\"), (\"exclusiveDiscount\",\"专享折扣\"), (\"appreciationBenefit\", \"增值权益\"), (\"memberPoint\", \"会员积分\")
     *
     * @return self
     */
