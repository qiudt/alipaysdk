...
/**
 * AlipayOpenSearchBoxApplyModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenSearchBoxApplyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenSearchBoxApplyModel';
     ...
     * Sets customKeywords
     *
     * @param string[]|null $customKeywords 自定义触发词，最多可配置10个，限1-8个中文字符。 小程序直达不支持设置此项
     *
     * @return self
     */
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\SearchBoxAppInfo[]|null $relatedAccounts 关联账号信息，1-3个。 内部字段均需设置。当为品牌直达时，数组中的第1个账号会被设置为\"账号1\"，也就是将作为搜索直达专区头部的跳转地址
     *
     * @return self
     */
     ...
     * Sets serviceInfos
     *
     * @param \Alipay\OpenAPISDK\Model\SearchBoxServiceInfo[]|null $serviceInfos \"服务信息，服务必须审核通过才能申请搜索直达。品牌直达最多可配置同一品牌认证下的小程序4个，小程序直达最多可配置2个。 内部字段均需设置。\"
     *
     * @return self
     */
