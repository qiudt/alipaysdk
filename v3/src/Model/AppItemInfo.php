 ...
 */
class AppItemInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppItemInfo';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['itemUseType'] = $data['itemUseType'] ?? null;
     ...
     * Sets itemId
     *
     * @param string|null $itemId 小程序商品-支付宝内部商品id
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getItemUseType()
    {
        return $this->container['itemUseType'];
    }

    /**
     * Sets itemUseType
     *
     * @param string|null $itemUseType 商品可用类型
     *
     * @return self
     */
    public function setItemUseType($itemUseType)
    {
        $this->container['itemUseType'] = $itemUseType;
