...
/**
 * AlipayIserviceCcmRoleCreateModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayIserviceCcmRoleCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayIserviceCcmRoleCreateModel';
     ...
     * Sets description
     *
     * @param string|null $description 角色描述信息
     *
     * @return self
     */
