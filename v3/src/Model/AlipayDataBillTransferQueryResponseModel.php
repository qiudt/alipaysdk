...
/**
 * AlipayDataBillTransferQueryResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayDataBillTransferQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayDataBillTransferQueryResponseModel';
    ...
    protected static $openAPITypes = [
        'detailList' => '\Alipay\OpenAPISDK\Model\TransferDetailResult[]',
        'pageNo' => 'string',
        'pageSize' => 'string',
        'totalSize' => 'string'
    ];
     ...
     * Gets detailList
     *
     * @return \Alipay\OpenAPISDK\Model\TransferDetailResult[]|null
     */
     ...
     * Sets detailList
     *
     * @param \Alipay\OpenAPISDK\Model\TransferDetailResult[]|null $detailList 充值、提现、转账明细记录
     *
     * @return self
     */
