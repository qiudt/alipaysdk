...
/**
 * AlipayEbppInvoiceIssueruleModifyModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayEbppInvoiceIssueruleModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayEbppInvoiceIssueruleModifyModel';
     ...
     * Sets action
     *
     * @param string|null $action 修改类型，枚举： MODIFY_BASIC_INFO（修改发放规则基本信息）
     *
     * @return self
     */
     ...
     * Sets effective
     *
     * @param string|null $effective 是否启用，\"0\"为停用，\"1\"为启用；
     *
     * @return self
     */
     ...
     *
     * @param string|null $effectivePeriod 生效周期（不传则不修改），不限：\"{\\\"all\\\":true}\"
     *
     * @return self
     */
     ...
     * Sets invalidMode
     *
     * @param int|null $invalidMode 是否可累计（不传则不修改）可选值：0（不可累计）、1（可累计），2（累计天数），3（累计到固定时间）
     *
     * @return self
     */
     ...
     *
     * @param string|null $invalidModeValue 累计值
     *
     * @return self
     */
     ...
     *
     * @param string|null $issueAmountValue 发放金额（不传则不修改），单位（元）
     *
     * @return self
     */
     ...
     * Sets issueEndDate
     *
     * @param string|null $issueEndDate 发放规则的截止时间
     *
     * @return self
     */
     ...
     * Sets issueRuleName
     *
     * @param string|null $issueRuleName 发放规则名称（不传则不修改）
     *
     * @return self
     */
     ...
     * Sets issueStartDate
     *
     * @param string|null $issueStartDate 发放规则的开始时间
     *
     * @return self
     */
     ...
     * Sets shareMode
     *
     * @param int|null $shareMode 是否可转赠（不传则不修改），可选值：0（不可转赠）、1（可转赠），默认为0，按城市发放不支持可转赠
     *
     * @return self
     */
