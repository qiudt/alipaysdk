...
/**
 * AlipayOpenMiniInnerappPluginOrderModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenMiniInnerappPluginOrderModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenMiniInnerappPluginOrderModel';
     ...
     * Sets requestId
     *
     * @param string|null $requestId 业务幂等号，规则为商品id+appOrigin+requestId 作为幂等流水号 非必填,不传则默认生成一个8位requestId
     *
     * @return self
     */
