...
/**
 * AlipayOpenPublicAccountCreateModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenPublicAccountCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenPublicAccountCreateModel';
     ...
     * Sets agreementId
     *
     * @param string|null $agreementId 账户添加成功，在支付宝与其对应的协议号。如果账户重复添加，接口保证幂等依然视为添加成功，返回此前该账户在支付宝对应的协议号。其他异常该字段不存在。
     *
     * @return self
     */
     ...
     * Sets displayName
     *
     * @param string|null $displayName 开发者期望在服务窗首页看到的关于该用户的显示信息，最长10个字符
     *
     * @return self
     */
     ...
     * Sets fromUserId
     *
     * @param string|null $fromUserId 要绑定的商户会员对应的支付宝userid，2088开头长度为16位的字符串
     *
     * @return self
     */
