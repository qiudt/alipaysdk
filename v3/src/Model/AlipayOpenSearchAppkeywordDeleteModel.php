...
/**
 * AlipayOpenSearchAppkeywordDeleteModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenSearchAppkeywordDeleteModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenSearchAppkeywordDeleteModel';
     ...
     * Sets keyWords
     *
     * @param string[]|null $keyWords 需要删除的生效关键词
     *
     * @return self
     */
