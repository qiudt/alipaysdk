...
/**
 * ZhimaCustomerJobworthPictureUploadResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class ZhimaCustomerJobworthPictureUploadResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ZhimaCustomerJobworthPictureUploadResponseModel';
    ...
    {
        $this->container['picId'] = $data['picId'] ?? null;
     ...
     * Sets picId
     *
     * @param string|null $picId 图片返回ID
     *
     * @return self
     */
