...
class AddressInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets latitude
     *
     * @param string|null $latitude 纬度，浮点型,小数点后最多保留6位  如需要录入经纬度，请以高德坐标系为准，录入时请确保经纬度参数准确。<a href=\"http://lbs.amap.com/console/show/picker\">高德经纬度查询</a>
     *
     * @return self
     */
     ...
     * Sets longitude
     *
     * @param string|null $longitude 经度，浮点型, 小数点后最多保留6位。  如需要录入经纬度，请以高德坐标系为准，录入时请确保经纬度参数准确。<a href=\"http://lbs.amap.com/console/show/picker\">高德经纬度查询</a>
     *
     * @return self
     */
