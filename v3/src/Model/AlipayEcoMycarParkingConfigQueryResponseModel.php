...
/**
 * AlipayEcoMycarParkingConfigQueryResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayEcoMycarParkingConfigQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayEcoMycarParkingConfigQueryResponseModel';
     ...
     * Sets accountNo
     *
     * @param string|null $accountNo 签约支付宝账号，开发者通过ISV系统配置信息注册接口(alipay.eco.mycar.parking.config.set)传入的参数值
     *
     * @return self
     */
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\InterfaceInfoList|null $interfaceInfoList interfaceInfoList
     *
     * @return self
     */
     ...
     * Sets merchantLogo
     *
     * @param string|null $merchantLogo 商户在停车平台首页露出的LOGO链接地址，开发者通过ISV系统配置信息注册接口(alipay.eco.mycar.parking.config.set)调用自动生成该链接
     *
     * @return self
     */
     ...
     * Sets merchantName
     *
     * @param string|null $merchantName 商户简称，开发者通过ISV系统配置信息注册接口(alipay.eco.mycar.parking.config.set)传入的参数值
     *
     * @return self
     */
     ...
     *
     * @param string|null $merchantServicePhone 商户客服电话，开发者通过ISV系统配置信息注册接口(alipay.eco.mycar.parking.config.set)传入的参数值
     *
     * @return self
     */
