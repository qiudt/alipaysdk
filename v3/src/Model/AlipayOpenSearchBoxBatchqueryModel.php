...
/**
 * AlipayOpenSearchBoxBatchqueryModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenSearchBoxBatchqueryModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenSearchBoxBatchqueryModel';
     ...
     * Sets pageSize
     *
     * @param int|null $pageSize 每页查询的数量，默认10，不得超过50
     *
     * @return self
     */
