...
/**
 * AlipayCommerceEcDepartmentInfoModifyModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayCommerceEcDepartmentInfoModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayCommerceEcDepartmentInfoModifyModel';
     ...
     * Sets departmentCode
     *
     * @param string|null $departmentCode 部门编码，不同部门的编码不能相同，为空则代表不修改
     *
     * @return self
     */
     ...
     * Sets departmentId
     *
     * @param string|null $departmentId 待修改部门的部门id
     *
     * @return self
     */
     ...
     * Sets departmentName
     *
     * @param string|null $departmentName 部门名称，为空则代表不修改
     *
     * @return self
     */
     ...
     *
     * @param string|null $parentDepartmentId 上级部门id，为空则代表不修改
     *
     * @return self
     */
