...
/**
 * VoucherSendRuleDetail Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class VoucherSendRuleDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VoucherSendRuleDetail';
     ...
     *
     * @param int|null $voucherQuantity 发行券的数量。
     *
     * @return self
     */
     ...
     *
     * @param int|null $voucherQuantityLimitPerUser 每人领取限制。默认按照支付宝uid进行领取限制; 不填写或填入0，默认没有领取限制。
     *
     * @return self
     */
