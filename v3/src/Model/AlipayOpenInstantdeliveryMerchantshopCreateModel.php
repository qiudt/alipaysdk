...
/**
 * AlipayOpenInstantdeliveryMerchantshopCreateModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenInstantdeliveryMerchantshopCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenInstantdeliveryMerchantshopCreateModel';
     ...
     * Sets shopName
     *
     * @param string|null $shopName 门店名称，最长不超过256个字符。名称+地址需要全局唯一。
     *
     * @return self
     */
     ...
     * Sets shopNo
     *
     * @param string|null $shopNo 商家门店编码，可自定义，但必须唯一
     *
     * @return self
     */
