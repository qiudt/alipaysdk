...
/**
 * AlipayCommerceEcEmployeeAddResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayCommerceEcEmployeeAddResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayCommerceEcEmployeeAddResponseModel';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['shareCode'] = $data['shareCode'] ?? null;
     ...
     * Sets employeeId
     *
     * @param string|null $employeeId 企业码生成的员工ID
     *
     * @return self
     */
     ...
     * Sets iotUniqueId
     *
     * @param string|null $iotUniqueId 员工开通IOT企业刷脸付的唯一流水号
     *
     * @return self
     */
    ...
    {
        return $this->container['shareCode'];
    }

    /**
     * Sets shareCode
     *
     * @param string|null $shareCode 员工签约激活吱口令
     *
     * @return self
     */
    public function setShareCode($shareCode)
    {
        $this->container['shareCode'] = $shareCode;
     ...
     * Sets signUrl
     *
     * @param string|null $signUrl 员工签约激活页面链接
     *
     * @return self
     */
