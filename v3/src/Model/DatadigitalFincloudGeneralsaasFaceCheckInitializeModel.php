...
/**
 * DatadigitalFincloudGeneralsaasFaceCheckInitializeModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class DatadigitalFincloudGeneralsaasFaceCheckInitializeModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DatadigitalFincloudGeneralsaasFaceCheckInitializeModel';
     ...
     * Sets bizCode
     *
     * @param string|null $bizCode DATA_DIGITAL_BIZ_CODE_FACE_CHECK_LIVE，代表活体检测。
     *
     * @return self
     */
     ...
     * Sets outerOrderNo
     *
     * @param string|null $outerOrderNo 客户业务单据号。
     *
     * @return self
     */
