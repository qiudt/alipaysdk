...
/**
 * AlipayIserviceCcmRoleModifyModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayIserviceCcmRoleModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayIserviceCcmRoleModifyModel';
     ...
     * Sets ccsInstanceId
     *
     * @param string|null $ccsInstanceId 部门id（即租户实例ID、数据权限ID），不传默认使用租户id
     *
     * @return self
     */
