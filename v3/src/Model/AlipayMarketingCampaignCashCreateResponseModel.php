...
/**
 * AlipayMarketingCampaignCashCreateResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayMarketingCampaignCashCreateResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayMarketingCampaignCashCreateResponseModel';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['payUrl'] = $data['payUrl'] ?? null;
    }
     ...
     * Sets crowdNo
     *
     * @param string|null $crowdNo 生成的现金红包活动号
     *
     * @return self
     */
     ...
     * Sets payUrl
     *
     * @param string|null $payUrl 活动创建后的付款链接，返回的是urlencode编码后的字符串。需要先进行urldecode解码，然后在浏览器中进行访问，会先进行支付宝登录引导，然后商户进行付款，付款有效期24小时。
     *
     * @return self
     */
