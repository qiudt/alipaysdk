...
/**
 * SpecialVoucher Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class SpecialVoucher implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpecialVoucher';
    ...
    protected static $setters = [
        ...
        'specialAmount' => 'setSpecialAmount'
    ];
    ...
    protected static $getters = [
        ...
        'specialAmount' => 'getSpecialAmount'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['specialAmount'] = $data['specialAmount'] ?? null;
    }
     ...
     * Sets originAmount
     *
     * @param string|null $originAmount 原价。 限制： 币种为人民币，单位为元。小数点以后最多保留两位; 取值范围:0.1<=x<=9999。
     *
     * @return self
     */
    ...
    {
        return $this->container['specialAmount'];
    }

    /**
     * Sets specialAmount
     *
     * @param string|null $specialAmount 特价，即：原价-特价=优惠金额。
     *
     * @return self
     */
    public function setSpecialAmount($specialAmount)
    {
        $this->container['specialAmount'] = $specialAmount;
