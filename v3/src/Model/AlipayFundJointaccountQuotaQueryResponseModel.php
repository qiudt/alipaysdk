...
/**
 * AlipayFundJointaccountQuotaQueryResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayFundJointaccountQuotaQueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayFundJointaccountQuotaQueryResponseModel';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['memberOpenId'] = $data['memberOpenId'] ?? null;
     ...
     * Sets accountQuota
     *
     * @param \Alipay\OpenAPISDK\Model\JointAccountQuotaRespDTO[]|null $accountQuota 共同账户额度模型
     *
     * @return self
     */
     ...
     * Sets memberId
     *
     * @param string|null $memberId 成员ID（如果查询员工才返回）
     *
     * @return self
     */
    ...
    {
        return $this->container['memberOpenId'];
    }

    /**
     * Sets memberOpenId
     *
     * @param string|null $memberOpenId 员工openId
     *
     * @return self
     */
    public function setMemberOpenId($memberOpenId)
    {
        $this->container['memberOpenId'] = $memberOpenId;
