...
/**
 * WaybillInvoiceQueryIstd Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class WaybillInvoiceQueryIstd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WaybillInvoiceQueryIstd';
     ...
     * Sets reason
     *
     * @param string|null $reason 失败原因，需要传单个即时配送运单的驳回原因
     *
     * @return self
     */
     ...
     *
     * @param int|null $waybillInvoiceStatus 明细的运单开票状态，1：开票成功 2：不可开票 3：可开票；整体开票状态为0的情况下，无开票明细；整体开票状态为1，明细开票状态全部是1；整体开票状态为2，明细开票状态全部为2
     *
     * @return self
     */
