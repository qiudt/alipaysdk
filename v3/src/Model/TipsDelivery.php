...
/**
 * TipsDelivery Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class TipsDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TipsDelivery';
     ...
     * Sets failReason
     *
     * @param string|null $failReason 文案审核驳回理由，仅状态为AUDIT_REJECTED时有效
     *
     * @return self
     */
