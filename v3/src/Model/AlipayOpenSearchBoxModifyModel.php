...
/**
 * AlipayOpenSearchBoxModifyModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenSearchBoxModifyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenSearchBoxModifyModel';
     ...
     * Sets boxDesc
     *
     * @param string|null $boxDesc 品牌介绍，5-15个中文字符。当修改品牌介绍模块(module_type=BOX_EXCLUSIVE_BASE)时传入。 小程序直达时不支持设置
     *
     * @return self
     */
     ...
     * Sets customKeywords
     *
     * @param string|null $customKeywords 1024
     *
     * @return self
     */
     ...
     * Sets imageName
     *
     * @param string|null $imageName 氛围图片名，当修改氛围图模块(module_type=BOX_ATMOSPHERE_IMAGE)时传入。 小程序直达不支持设置
     *
     * @return self
     */
     ...
     * Sets moduleId
     *
     * @param string|null $moduleId 搜索直达模块配置id，新增模块时可不传，更新模块时必传。从alipay.open.search.box.query详情接口查询可获取已存在模块的配置id
     *
     * @return self
     */
     ...
     * Sets moduleType
     *
     * @param string|null $moduleType 搜索直达模块类型，参考<a href=\"https://opendocs.alipay.com/mini/03fjba#%E4%BD%BF%E7%94%A8%E8%AF%B4%E6%98%8E\"> 搜索直达模块说明 </a>。
     *
     * @return self
     */
     ...
     *
     * @param \Alipay\OpenAPISDK\Model\SearchBoxAppInfo[]|null $relatedAccounts \"关联账号信息，可配置1-2个。传入账号需归属于商家主体。品牌直达修改官方账号(module_type=BOX_EXCLUSIVE_ACCOUNTS)时传入，小程序直达修改常用服务模块时也需传值。 当为品牌直达时，数组中的第1个账号会被设置为\"账号1\"，也就是将作为搜索直达专区头部的跳转地址。\"
     *
     * @return self
     */
     ...
     * Sets serviceInfos
     *
     * @param \Alipay\OpenAPISDK\Model\SearchBoxServiceInfo[]|null $serviceInfos 服务信息，服务必须审核通过才能申请搜索直达，可配置1-4个。当修改常用服务模块(module_type=BOX_EXCLUSIVE_FUNCTIONS)时传入
     *
     * @return self
     */
