...
/**
 * AlipayOfflineMarketShopBatchqueryResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOfflineMarketShopBatchqueryResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOfflineMarketShopBatchqueryResponseModel';
    ...
    protected static $attributeMap = [
        'currentPageno' => 'current_pageno',
        'shopIds' => 'shop_ids',
        'totalPageno' => 'total_pageno'
    ];
     ...
     * Sets shopIds
     *
     * @param string[]|null $shopIds 门店列表ID，逗号分隔
     *
     * @return self
     */
