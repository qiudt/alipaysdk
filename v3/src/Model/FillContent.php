 ...
 */
class FillContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FillContent';
     ...
     * Sets structKey
     *
     * @param string|null $structKey 模板组件自定义key
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value 模板值,该值长度取决于配置模板时该字段的限制
     *
     * @return self
     */
