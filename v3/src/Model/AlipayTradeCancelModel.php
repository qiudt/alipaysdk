...
/**
 * AlipayTradeCancelModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayTradeCancelModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayTradeCancelModel';
     ...
     * Sets outTradeNo
     *
     * @param string|null $outTradeNo 原支付请求的商户订单号,和支付宝交易号不能同时为空
     *
     * @return self
     */
