...
class AlipayTradeCreateModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets buyerLogonId
     *
     * @param string|null $buyerLogonId 买家支付宝登录账号。 建议通过open_id来传递买家信息。
     *
     * @return self
     */
     ...
     * Sets timeoutExpress
     *
     * @param string|null $timeoutExpress 订单相对超时时间。从交易创建时间开始计算。 该笔订单允许的最晚付款时间，逾期将关闭交易。取值范围：1m～15d。m-分钟，h-小时，d-天，1c-当天（1c-当天的情况下，无论交易何时创建，都在0点关闭）。 该参数数值不接受小数点， 如 1.5h，可转换为 90m。 当面付场景默认值为3h，如需指定，推荐设置5m及以上。  注：time_expire和timeout_express两者只需传入一个或者都不传，如果两者都传，优先使用time_expire。
     *
     * @return self
     */
