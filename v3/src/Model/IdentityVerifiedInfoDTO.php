...
/**
 * IdentityVerifiedInfoDTO Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class IdentityVerifiedInfoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IdentityVerifiedInfoDTO';
     ...
     * Sets certNo
     *
     * @param string|null $certNo MD5加密处理后的证件号
     *
     * @return self
     */
     ...
     * Sets userName
     *
     * @param string|null $userName 用户的真实姓名
     *
     * @return self
     */
