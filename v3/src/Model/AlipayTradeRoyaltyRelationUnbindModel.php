...
/**
 * AlipayTradeRoyaltyRelationUnbindModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayTradeRoyaltyRelationUnbindModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayTradeRoyaltyRelationUnbindModel';
     ...
     * Sets receiverList
     *
     * @param \Alipay\OpenAPISDK\Model\RoyaltyEntity[]|null $receiverList 分账接收方列表，单次传入最多 20 个信息。
     *
     * @return self
     */
