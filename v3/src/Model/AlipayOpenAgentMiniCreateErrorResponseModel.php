...
/**
 * AlipayOpenAgentMiniCreateErrorResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenAgentMiniCreateErrorResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenAgentMiniCreateErrorResponseModel';
    ...
    public const CODE_ISV_APP_NO_TINYAPP_SCENE = 'ISV_APP_NO_TINYAPP_SCENE';
    public const CODE_BATCH_IS_NOT_EXIST = 'BATCH_IS_NOT_EXIST';
    public const CODE_MERCHANT_NOT_ENTERPRISE = 'MERCHANT_NOT_ENTERPRISE';
    ...
    public const CODE_CATEGOTY_NUM_IS_INVALID = 'CATEGOTY_NUM_IS_INVALID';
    ...
    public const CODE_PID_IS_BLANK = 'PID_IS_BLANK';
    ...
    public const CODE_PRE_AUTH_INVALID_CREATE_APPLICAT = 'PRE_AUTH_INVALID_CREATE_APPLICAT';
    public const CODE_PRE_AUTH_INVALID_AUTH_APP_ID = 'PRE_AUTH_INVALID_AUTH_APP_ID';
    public const CODE_PRE_AUTH_TICKET_CREATE_APP_ONCE = 'PRE_AUTH_TICKET_CREATE_APP_ONCE';
    ...
    public const CODE_INVALID_CONTACT_MOBILE = 'INVALID_CONTACT_MOBILE';
    public const CODE_INVALID_CONTACT_NAME = 'INVALID_CONTACT_NAME';
    public const CODE_INVALID_CONTACT_EMAIL = 'INVALID_CONTACT_EMAIL';
    public const CODE_MERCHANT_IS_NOT_EXIST = 'MERCHANT_IS_NOT_EXIST';
    public const CODE_MERCHANT_NOT_ACTIVED = 'MERCHANT_NOT_ACTIVED';
    public const CODE_MERCHANT_CAN_NOT_LOGON = 'MERCHANT_CAN_NOT_LOGON';
    public const CODE_MERCHANT_NOT_ENABLED = 'MERCHANT_NOT_ENABLED';
    public const CODE_MERCHANT_NOT_CERTIFIED = 'MERCHANT_NOT_CERTIFIED';
    public const CODE_DUPLICATE_CREATE_APP_NAME = 'DUPLICATE_CREATE_APP_NAME';
    ...
    public function getCodeAllowableValues()
    {
        return [
            ...
            self::CODE_ISV_APP_NO_TINYAPP_SCENE,
            self::CODE_BATCH_IS_NOT_EXIST,
            self::CODE_MERCHANT_NOT_ENTERPRISE,
            ...
            self::CODE_CATEGOTY_NUM_IS_INVALID,
            ...
            self::CODE_PRE_AUTH_INVALID_CREATE_APPLICAT,
            self::CODE_PRE_AUTH_INVALID_AUTH_APP_ID,
            self::CODE_PRE_AUTH_TICKET_CREATE_APP_ONCE,
            self::CODE_BLACK_LIST_CHECK_FAIL,
            self::CODE_RISK_DECISION_CHECK_FAIL,
            self::CODE_RISK_DECISION_HIT_BRAND,
            self::CODE_INVALID_CONTACT_MOBILE,
            self::CODE_INVALID_CONTACT_NAME,
            self::CODE_INVALID_CONTACT_EMAIL,
            self::CODE_MERCHANT_IS_NOT_EXIST,
            self::CODE_MERCHANT_NOT_ACTIVED,
            self::CODE_MERCHANT_CAN_NOT_LOGON,
            self::CODE_MERCHANT_NOT_ENABLED,
            self::CODE_MERCHANT_NOT_CERTIFIED,
            self::CODE_DUPLICATE_CREATE_APP_NAME,
        ];
    }
