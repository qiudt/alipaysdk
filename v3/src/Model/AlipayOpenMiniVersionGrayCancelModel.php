...
/**
 * AlipayOpenMiniVersionGrayCancelModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class AlipayOpenMiniVersionGrayCancelModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayOpenMiniVersionGrayCancelModel';
     ...
     * Sets appVersion
     *
     * @param string|null $appVersion 商家灰度中的小程序版本号，结束灰度后小程序将回到审核通过状态。
     *
     * @return self
     */
