...
/**
 * ZhimaCreditPayafteruseCreditagreementTransferResponseModel Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class ZhimaCreditPayafteruseCreditagreementTransferResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ZhimaCreditPayafteruseCreditagreementTransferResponseModel';
     ...
     *
     * @param string|null $deductAgreementNo 当operation_type==AGREEMENT_TRANSFER时，并且是迁移到小程序商家版时有值，其他情况下不返回
     *
     * @return self
     */
