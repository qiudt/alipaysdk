...
/**
 * LogisticsShopStatusDTO Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 ...
 */
class LogisticsShopStatusDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LogisticsShopStatusDTO';
    ...
    protected static $setters = [
        ...
        'logisticsName' => 'setLogisticsName',
        'status' => 'setStatus'
    ];
    ...
    protected static $getters = [
        ...
        'logisticsName' => 'getLogisticsName',
        'status' => 'getStatus'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['logisticsName'] = $data['logisticsName'] ?? null;
     ...
     * Sets auditDesc
     *
     * @param string|null $auditDesc 商家在配送公司的账户的审核说明.
     *
     * @return self
     */
     ...
     * Sets logisticsCode
     *
     * @param string|null $logisticsCode 配送公司物流编码。
     *
     * @return self
     */
    ...
    {
        return $this->container['logisticsName'];
    }

    /**
     * Sets logisticsName
     *
     * @param string|null $logisticsName 配送公司名称。
     *
     * @return self
     */
    public function setLogisticsName($logisticsName)
    {
        $this->container['logisticsName'] = $logisticsName;
     ...
     * Sets status
     *
     * @param string|null $status 门店状态，AUDITING:审核中，AUDIT_REJECT:审核驳回，VALID:已生效，UPDATING:更新中，WAIT_CREATE:待开通(存量门店若需要支持后面新增的配送公司，需要调用门店更新接口发起申请)
     *
     * @return self
     */
