...
/**
 * AlipayFundTransUniApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayFundTransUniApi
{
     ...
     * 单笔转账接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferModel $alipayFundTransUniTransferModel alipayFundTransUniTransferModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferDefaultResponse
     */
    public function transfer($alipayFundTransUniTransferModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->transferWithHttpInfo($alipayFundTransUniTransferModel, $customizedParams);
        return $response;
    }
     ...
     * 单笔转账接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferModel $alipayFundTransUniTransferModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function transferWithHttpInfo($alipayFundTransUniTransferModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->transferRequest($alipayFundTransUniTransferModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function transferAsync($alipayFundTransUniTransferModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->transferAsyncWithHttpInfo($alipayFundTransUniTransferModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function transferAsyncWithHttpInfo($alipayFundTransUniTransferModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundTransUniTransferResponseModel';
        $request = $this->transferRequest($alipayFundTransUniTransferModel, $customizedParams);
     ...
     */
    public function transferRequest($alipayFundTransUniTransferModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/fund/trans/uni/transfer';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayFundTransUniTransferModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayFundTransUniTransferModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayFundTransUniTransferModel;
            }
