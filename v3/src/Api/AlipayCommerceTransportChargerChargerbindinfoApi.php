...
/**
 * AlipayCommerceTransportChargerChargerbindinfoApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayCommerceTransportChargerChargerbindinfoApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  \Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncModel $alipayCommerceTransportChargerChargerbindinfoSyncModel alipayCommerceTransportChargerChargerbindinfoSyncModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncDefaultResponse
     */
    public function sync($authToken = null, $alipayCommerceTransportChargerChargerbindinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->syncWithHttpInfo($authToken, $alipayCommerceTransportChargerChargerbindinfoSyncModel, $customizedParams);
        return $response;
    }
     ...
     *
     * @param  string $authToken 用户授权令牌 (optional)
     * @param  \Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncModel $alipayCommerceTransportChargerChargerbindinfoSyncModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function syncWithHttpInfo($authToken = null, $alipayCommerceTransportChargerChargerbindinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->syncRequest($authToken, $alipayCommerceTransportChargerChargerbindinfoSyncModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function syncAsync($authToken = null, $alipayCommerceTransportChargerChargerbindinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->syncAsyncWithHttpInfo($authToken, $alipayCommerceTransportChargerChargerbindinfoSyncModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function syncAsyncWithHttpInfo($authToken = null, $alipayCommerceTransportChargerChargerbindinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceTransportChargerChargerbindinfoSyncResponseModel';
        $request = $this->syncRequest($authToken, $alipayCommerceTransportChargerChargerbindinfoSyncModel, $customizedParams);
     ...
     */
    public function syncRequest($authToken = null, $alipayCommerceTransportChargerChargerbindinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/commerce/transport/charger/chargerbindinfo/sync';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayCommerceTransportChargerChargerbindinfoSyncModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayCommerceTransportChargerChargerbindinfoSyncModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayCommerceTransportChargerChargerbindinfoSyncModel;
            }
