...
/**
 * AlipayDataBillTransferaccountbookApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayDataBillTransferaccountbookApi
{
    /**
     * @var ClientInterface
     */
     ...
     *
     * @param  string $startTime 充值、转账、提现流水业务时间的起始范围 (optional)
     * @param  string $endTime 充值、转账、提现流水业务时间的结束范围。与起始时间间隔不超过31天。查询结果为起始时间至结束时间的左闭右开区间 (optional)
     * @param  string $type 转账类型：充值-DEPOSIT，提现-WITHDRAW，转账-TRANSFER。 (optional)
     * @param  string $agreementNo 协议号 (optional)
     * @param  string $storeNo 子账本号，或者子账本名称。模糊查询 (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayDataBillTransferaccountbookQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayDataBillTransferaccountbookQueryDefaultResponse
     */
    public function query($startTime = null, $endTime = null, $type = null, $agreementNo = null, $storeNo = null, $pageNo = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($startTime, $endTime, $type, $agreementNo, $storeNo, $pageNo, $pageSize, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayDataBillTransferaccountbookQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayDataBillTransferaccountbookQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($startTime = null, $endTime = null, $type = null, $agreementNo = null, $storeNo = null, $pageNo = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($startTime, $endTime, $type, $agreementNo, $storeNo, $pageNo, $pageSize, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayDataBillTransferaccountbookQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayDataBillTransferaccountbookQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayDataBillTransferaccountbookQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayDataBillTransferaccountbookQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayDataBillTransferaccountbookQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayDataBillTransferaccountbookQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayDataBillTransferaccountbookQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayDataBillTransferaccountbookQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($startTime = null, $endTime = null, $type = null, $agreementNo = null, $storeNo = null, $pageNo = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($startTime, $endTime, $type, $agreementNo, $storeNo, $pageNo, $pageSize, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($startTime = null, $endTime = null, $type = null, $agreementNo = null, $storeNo = null, $pageNo = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayDataBillTransferaccountbookQueryResponseModel';
        $request = $this->queryRequest($startTime, $endTime, $type, $agreementNo, $storeNo, $pageNo, $pageSize, $customizedParams);
     ...
     */
    public function queryRequest($startTime = null, $endTime = null, $type = null, $agreementNo = null, $storeNo = null, $pageNo = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/data/bill/transferaccountbook/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
