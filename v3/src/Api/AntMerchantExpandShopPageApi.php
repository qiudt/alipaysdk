...
/**
 * AntMerchantExpandShopPageApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AntMerchantExpandShopPageApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 店铺分页查询接口
     *
     * @param  string $ipRoleId 商户角色id，表示将要开的店属于哪个商户角色。对于直连开店场景，填写商户pid；对于间连开店场景（线上、线下、直付通），填写商户smid。特别说明：IoT设备三绑定场景统一填写商户pid (optional)
     * @param  int $pageNum 查询页数 (optional)
     * @param  int $pageSize 每页查询大小，限制100以内 (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AntMerchantExpandShopPageQueryResponseModel|\Alipay\OpenAPISDK\Model\AntMerchantExpandShopPageQueryDefaultResponse
     */
    public function query($ipRoleId = null, $pageNum = null, $pageSize = null, $addressVersion = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($ipRoleId, $pageNum, $pageSize, $addressVersion, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AntMerchantExpandShopPageQueryResponseModel|\Alipay\OpenAPISDK\Model\AntMerchantExpandShopPageQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($ipRoleId = null, $pageNum = null, $pageSize = null, $addressVersion = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($ipRoleId, $pageNum, $pageSize, $addressVersion, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AntMerchantExpandShopPageQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AntMerchantExpandShopPageQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AntMerchantExpandShopPageQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AntMerchantExpandShopPageQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AntMerchantExpandShopPageQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AntMerchantExpandShopPageQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AntMerchantExpandShopPageQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AntMerchantExpandShopPageQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($ipRoleId = null, $pageNum = null, $pageSize = null, $addressVersion = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($ipRoleId, $pageNum, $pageSize, $addressVersion, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($ipRoleId = null, $pageNum = null, $pageSize = null, $addressVersion = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AntMerchantExpandShopPageQueryResponseModel';
        $request = $this->queryRequest($ipRoleId, $pageNum, $pageSize, $addressVersion, $customizedParams);
     ...
     */
    public function queryRequest($ipRoleId = null, $pageNum = null, $pageSize = null, $addressVersion = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/ant/merchant/shop/pagequery';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
