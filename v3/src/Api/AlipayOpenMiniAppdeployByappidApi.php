...
/**
 * AlipayOpenMiniAppdeployByappidApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniAppdeployByappidApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 根据APPID分页查询小程序发布信息
     *
     * @param  string $miniAppId 小程序应用ID (optional)
     * @param  string $bundleId 端标识 (optional)
     * @param  string $instCode 租户标识 (optional)
     * @param  int $pageNum 当前页，从1开始 (optional)
     * @param  int $pageSize 每页个数 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappidQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappidQueryDefaultResponse
     */
    public function query($miniAppId = null, $bundleId = null, $instCode = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($miniAppId, $bundleId, $instCode, $pageNum, $pageSize, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappidQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappidQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($miniAppId = null, $bundleId = null, $instCode = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($miniAppId, $bundleId, $instCode, $pageNum, $pageSize, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappidQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappidQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappidQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappidQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappidQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappidQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappidQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappidQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($miniAppId = null, $bundleId = null, $instCode = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($miniAppId, $bundleId, $instCode, $pageNum, $pageSize, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($miniAppId = null, $bundleId = null, $instCode = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappidQueryResponseModel';
        $request = $this->queryRequest($miniAppId, $bundleId, $instCode, $pageNum, $pageSize, $customizedParams);
     ...
     */
    public function queryRequest($miniAppId = null, $bundleId = null, $instCode = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/appdeploy/byappid/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
