...
/**
 * ZhimaCustomerJobworthPictureApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ZhimaCustomerJobworthPictureApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 职得工作证图片上传
     *
     * @param  \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadModel $zhimaCustomerJobworthPictureUploadModel zhimaCustomerJobworthPictureUploadModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadDefaultResponse
     */
    public function upload($zhimaCustomerJobworthPictureUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->uploadWithHttpInfo($zhimaCustomerJobworthPictureUploadModel, $customizedParams);
        return $response;
    }
     ...
     * 职得工作证图片上传
     *
     * @param  \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadModel $zhimaCustomerJobworthPictureUploadModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadWithHttpInfo($zhimaCustomerJobworthPictureUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->uploadRequest($zhimaCustomerJobworthPictureUploadModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function uploadAsync($zhimaCustomerJobworthPictureUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->uploadAsyncWithHttpInfo($zhimaCustomerJobworthPictureUploadModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function uploadAsyncWithHttpInfo($zhimaCustomerJobworthPictureUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPictureUploadResponseModel';
        $request = $this->uploadRequest($zhimaCustomerJobworthPictureUploadModel, $customizedParams);
     ...
     */
    public function uploadRequest($zhimaCustomerJobworthPictureUploadModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/zhima/customer/jobworth/picture/upload';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($zhimaCustomerJobworthPictureUploadModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($zhimaCustomerJobworthPictureUploadModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $zhimaCustomerJobworthPictureUploadModel;
            }
