...
/**
 * ZhimaCreditPeZmgoBizoptApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ZhimaCreditPeZmgoBizoptApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 芝麻GO签约关单
     *
     * @param  \Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseModel $zhimaCreditPeZmgoBizoptCloseModel zhimaCreditPeZmgoBizoptCloseModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseDefaultResponse
     */
    public function close($zhimaCreditPeZmgoBizoptCloseModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->closeWithHttpInfo($zhimaCreditPeZmgoBizoptCloseModel, $customizedParams);
        return $response;
    }
     ...
     * 芝麻GO签约关单
     *
     * @param  \Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseModel $zhimaCreditPeZmgoBizoptCloseModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function closeWithHttpInfo($zhimaCreditPeZmgoBizoptCloseModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->closeRequest($zhimaCreditPeZmgoBizoptCloseModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function closeAsync($zhimaCreditPeZmgoBizoptCloseModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->closeAsyncWithHttpInfo($zhimaCreditPeZmgoBizoptCloseModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function closeAsyncWithHttpInfo($zhimaCreditPeZmgoBizoptCloseModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoBizoptCloseResponseModel';
        $request = $this->closeRequest($zhimaCreditPeZmgoBizoptCloseModel, $customizedParams);
     ...
     */
    public function closeRequest($zhimaCreditPeZmgoBizoptCloseModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/zhima/credit/pe/zmgo/bizopt/close';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($zhimaCreditPeZmgoBizoptCloseModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($zhimaCreditPeZmgoBizoptCloseModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $zhimaCreditPeZmgoBizoptCloseModel;
            }
