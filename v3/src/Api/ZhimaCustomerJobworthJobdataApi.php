...
/**
 * ZhimaCustomerJobworthJobdataApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ZhimaCustomerJobworthJobdataApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 工作证职业数据回流接口
     *
     * @param  \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddModel $zhimaCustomerJobworthJobdataAddModel zhimaCustomerJobworthJobdataAddModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddDefaultResponse
     */
    public function add($zhimaCustomerJobworthJobdataAddModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->addWithHttpInfo($zhimaCustomerJobworthJobdataAddModel, $customizedParams);
        return $response;
    }
     ...
     * 工作证职业数据回流接口
     *
     * @param  \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddModel $zhimaCustomerJobworthJobdataAddModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function addWithHttpInfo($zhimaCustomerJobworthJobdataAddModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->addRequest($zhimaCustomerJobworthJobdataAddModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function addAsync($zhimaCustomerJobworthJobdataAddModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->addAsyncWithHttpInfo($zhimaCustomerJobworthJobdataAddModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function addAsyncWithHttpInfo($zhimaCustomerJobworthJobdataAddModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthJobdataAddResponseModel';
        $request = $this->addRequest($zhimaCustomerJobworthJobdataAddModel, $customizedParams);
     ...
     */
    public function addRequest($zhimaCustomerJobworthJobdataAddModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/zhima/customer/jobworth/jobdata/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($zhimaCustomerJobworthJobdataAddModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($zhimaCustomerJobworthJobdataAddModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $zhimaCustomerJobworthJobdataAddModel;
            }
