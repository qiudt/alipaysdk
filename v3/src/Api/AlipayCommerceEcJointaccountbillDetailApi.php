...
/**
 * AlipayCommerceEcJointaccountbillDetailApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayCommerceEcJointaccountbillDetailApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $bizScene 业务场景。不传默认为ISV_DEFAULT (optional)
     * @param  string $userId 员工支付宝UID (optional)
     * @param  string $openId 员工支付宝UID (optional)
     * @param  string $employeeId 员工id (optional)
     * @param  string $pageNum 页码 (optional)
     * @param  string $pageSize 每页大小 (optional)
     * @param  string $startDate 起始日期 (optional)
     * @param  string $endDate 截止日期 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayCommerceEcJointaccountbillDetailBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceEcJointaccountbillDetailBatchqueryDefaultResponse
     */
    public function batchquery($enterpriseId = null, $bizScene = null, $userId = null, $openId = null, $employeeId = null, $pageNum = null, $pageSize = null, $startDate = null, $endDate = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->batchqueryWithHttpInfo($enterpriseId, $bizScene, $userId, $openId, $employeeId, $pageNum, $pageSize, $startDate, $endDate, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayCommerceEcJointaccountbillDetailBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceEcJointaccountbillDetailBatchqueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function batchqueryWithHttpInfo($enterpriseId = null, $bizScene = null, $userId = null, $openId = null, $employeeId = null, $pageNum = null, $pageSize = null, $startDate = null, $endDate = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->batchqueryRequest($enterpriseId, $bizScene, $userId, $openId, $employeeId, $pageNum, $pageSize, $startDate, $endDate, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcJointaccountbillDetailBatchqueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcJointaccountbillDetailBatchqueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceEcJointaccountbillDetailBatchqueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcJointaccountbillDetailBatchqueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcJointaccountbillDetailBatchqueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceEcJointaccountbillDetailBatchqueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceEcJointaccountbillDetailBatchqueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayCommerceEcJointaccountbillDetailBatchqueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function batchqueryAsync($enterpriseId = null, $bizScene = null, $userId = null, $openId = null, $employeeId = null, $pageNum = null, $pageSize = null, $startDate = null, $endDate = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->batchqueryAsyncWithHttpInfo($enterpriseId, $bizScene, $userId, $openId, $employeeId, $pageNum, $pageSize, $startDate, $endDate, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function batchqueryAsyncWithHttpInfo($enterpriseId = null, $bizScene = null, $userId = null, $openId = null, $employeeId = null, $pageNum = null, $pageSize = null, $startDate = null, $endDate = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceEcJointaccountbillDetailBatchqueryResponseModel';
        $request = $this->batchqueryRequest($enterpriseId, $bizScene, $userId, $openId, $employeeId, $pageNum, $pageSize, $startDate, $endDate, $customizedParams);
     ...
     */
    public function batchqueryRequest($enterpriseId = null, $bizScene = null, $userId = null, $openId = null, $employeeId = null, $pageNum = null, $pageSize = null, $startDate = null, $endDate = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/commerce/ec/jointaccountbill/detail/batchquery';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
