...
/**
 * AlipayEbppInvoiceApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayEbppInvoiceApi
{
     ...
     * 发票信息同步至支付宝
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnModel $alipayEbppInvoiceSycnModel alipayEbppInvoiceSycnModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnDefaultResponse
     */
    public function sycn($alipayEbppInvoiceSycnModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->sycnWithHttpInfo($alipayEbppInvoiceSycnModel, $customizedParams);
        return $response;
    }

    /**
     * Operation sycnWithHttpInfo
     *
     * 发票信息同步至支付宝
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnModel $alipayEbppInvoiceSycnModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sycnWithHttpInfo($alipayEbppInvoiceSycnModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->sycnRequest($alipayEbppInvoiceSycnModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function sycnAsync($alipayEbppInvoiceSycnModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->sycnAsyncWithHttpInfo($alipayEbppInvoiceSycnModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation sycnAsyncWithHttpInfo
     *
     * 发票信息同步至支付宝
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnModel $alipayEbppInvoiceSycnModel (optional)
     ...
     * @deprecated
     */
    public function sycnAsyncWithHttpInfo($alipayEbppInvoiceSycnModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnResponseModel';
        $request = $this->sycnRequest($alipayEbppInvoiceSycnModel, $customizedParams);
    ...
    /**
     * Create request for operation 'sycn'
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceSycnModel $alipayEbppInvoiceSycnModel (optional)
     * @param CustomizedParams $customizedParams
     *
     ...
     */
    public function sycnRequest($alipayEbppInvoiceSycnModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/invoice/sycn';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayEbppInvoiceSycnModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayEbppInvoiceSycnModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayEbppInvoiceSycnModel;
            }
