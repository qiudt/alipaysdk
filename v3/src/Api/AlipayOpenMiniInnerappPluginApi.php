...
/**
 * AlipayOpenMiniInnerappPluginApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerappPluginApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 小程序代商户订购插件
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderModel $alipayOpenMiniInnerappPluginOrderModel alipayOpenMiniInnerappPluginOrderModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderDefaultResponse
     */
    public function order($alipayOpenMiniInnerappPluginOrderModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->orderWithHttpInfo($alipayOpenMiniInnerappPluginOrderModel, $customizedParams);
        return $response;
    }
     ...
     * 小程序代商户订购插件
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderModel $alipayOpenMiniInnerappPluginOrderModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function orderWithHttpInfo($alipayOpenMiniInnerappPluginOrderModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->orderRequest($alipayOpenMiniInnerappPluginOrderModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function orderAsync($alipayOpenMiniInnerappPluginOrderModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->orderAsyncWithHttpInfo($alipayOpenMiniInnerappPluginOrderModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function orderAsyncWithHttpInfo($alipayOpenMiniInnerappPluginOrderModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginOrderResponseModel';
        $request = $this->orderRequest($alipayOpenMiniInnerappPluginOrderModel, $customizedParams);
     ...
     */
    public function orderRequest($alipayOpenMiniInnerappPluginOrderModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerapp/plugin/order';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniInnerappPluginOrderModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniInnerappPluginOrderModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniInnerappPluginOrderModel;
            }
