...
/**
 * AlipayCommerceIotDeviceReportApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayCommerceIotDeviceReportApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 设备检测报告上传
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadModel $alipayCommerceIotDeviceReportUploadModel alipayCommerceIotDeviceReportUploadModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadDefaultResponse
     */
    public function upload($alipayCommerceIotDeviceReportUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->uploadWithHttpInfo($alipayCommerceIotDeviceReportUploadModel, $customizedParams);
        return $response;
    }
     ...
     * 设备检测报告上传
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadModel $alipayCommerceIotDeviceReportUploadModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadWithHttpInfo($alipayCommerceIotDeviceReportUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->uploadRequest($alipayCommerceIotDeviceReportUploadModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function uploadAsync($alipayCommerceIotDeviceReportUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->uploadAsyncWithHttpInfo($alipayCommerceIotDeviceReportUploadModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function uploadAsyncWithHttpInfo($alipayCommerceIotDeviceReportUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceIotDeviceReportUploadResponseModel';
        $request = $this->uploadRequest($alipayCommerceIotDeviceReportUploadModel, $customizedParams);
     ...
     */
    public function uploadRequest($alipayCommerceIotDeviceReportUploadModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/commerce/iot/device/report/upload';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayCommerceIotDeviceReportUploadModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayCommerceIotDeviceReportUploadModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayCommerceIotDeviceReportUploadModel;
            }
