...
/**
 * AlipayPcreditHuabeiAuthSettleApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayPcreditHuabeiAuthSettleApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 花芝轻会员结算申请
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyModel $alipayPcreditHuabeiAuthSettleApplyModel alipayPcreditHuabeiAuthSettleApplyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyResponseModel|\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyDefaultResponse
     */
    public function apply($alipayPcreditHuabeiAuthSettleApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->applyWithHttpInfo($alipayPcreditHuabeiAuthSettleApplyModel, $customizedParams);
        return $response;
    }
     ...
     * 花芝轻会员结算申请
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyModel $alipayPcreditHuabeiAuthSettleApplyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyResponseModel|\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function applyWithHttpInfo($alipayPcreditHuabeiAuthSettleApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->applyRequest($alipayPcreditHuabeiAuthSettleApplyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function applyAsync($alipayPcreditHuabeiAuthSettleApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->applyAsyncWithHttpInfo($alipayPcreditHuabeiAuthSettleApplyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function applyAsyncWithHttpInfo($alipayPcreditHuabeiAuthSettleApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthSettleApplyResponseModel';
        $request = $this->applyRequest($alipayPcreditHuabeiAuthSettleApplyModel, $customizedParams);
     ...
     */
    public function applyRequest($alipayPcreditHuabeiAuthSettleApplyModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/pcredit/huabei/auth/settle/apply';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayPcreditHuabeiAuthSettleApplyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayPcreditHuabeiAuthSettleApplyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayPcreditHuabeiAuthSettleApplyModel;
            }
