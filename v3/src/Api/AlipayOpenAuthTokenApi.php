...
/**
 * AlipayOpenAuthTokenApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayOpenAuthTokenApi
{
     ...
     * 换取应用授权令牌
     *
     * @param \Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppModel $alipayOpenAuthTokenAppModel alipayOpenAuthTokenAppModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppDefaultResponse
     * @throws \InvalidArgumentException
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     */
    public function app($alipayOpenAuthTokenAppModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->appWithHttpInfo($alipayOpenAuthTokenAppModel, $customizedParams);
        return $response;
    }
     ...
     * 换取应用授权令牌
     *
     * @param \Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppModel $alipayOpenAuthTokenAppModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \InvalidArgumentException
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     */
    public function appWithHttpInfo($alipayOpenAuthTokenAppModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->appRequest($alipayOpenAuthTokenAppModel, $customizedParams);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];

                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string)$response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function appAsync($alipayOpenAuthTokenAppModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->appAsyncWithHttpInfo($alipayOpenAuthTokenAppModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function appAsyncWithHttpInfo($alipayOpenAuthTokenAppModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppResponseModel';
        $request = $this->appRequest($alipayOpenAuthTokenAppModel, $customizedParams);
     ...
     * @throws \InvalidArgumentException
     */
    public function appRequest($alipayOpenAuthTokenAppModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/auth/token/app';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenAuthTokenAppModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenAuthTokenAppModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenAuthTokenAppModel;
            }
