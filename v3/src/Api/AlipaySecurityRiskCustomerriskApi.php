...
/**
 * AlipaySecurityRiskCustomerriskApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipaySecurityRiskCustomerriskApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 商户数据同步
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipaySecurityRiskCustomerriskSendModel $alipaySecurityRiskCustomerriskSendModel alipaySecurityRiskCustomerriskSendModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipaySecurityRiskCustomerriskSendDefaultResponse
     */
    public function send($alipaySecurityRiskCustomerriskSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->sendWithHttpInfo($alipaySecurityRiskCustomerriskSendModel, $customizedParams);
        return $response;
    }
     ...
     * 商户数据同步
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipaySecurityRiskCustomerriskSendModel $alipaySecurityRiskCustomerriskSendModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipaySecurityRiskCustomerriskSendDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendWithHttpInfo($alipaySecurityRiskCustomerriskSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->sendRequest($alipaySecurityRiskCustomerriskSendModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipaySecurityRiskCustomerriskSendDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipaySecurityRiskCustomerriskSendDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipaySecurityRiskCustomerriskSendDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipaySecurityRiskCustomerriskSendDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function sendAsync($alipaySecurityRiskCustomerriskSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->sendAsyncWithHttpInfo($alipaySecurityRiskCustomerriskSendModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function sendAsyncWithHttpInfo($alipaySecurityRiskCustomerriskSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->sendRequest($alipaySecurityRiskCustomerriskSendModel, $customizedParams);
     ...
     */
    public function sendRequest($alipaySecurityRiskCustomerriskSendModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/security/risk/customerrisk/send';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipaySecurityRiskCustomerriskSendModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipaySecurityRiskCustomerriskSendModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipaySecurityRiskCustomerriskSendModel;
            }
