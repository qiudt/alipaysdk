...
/**
 * AlipayFundJointaccountSignApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayFundJointaccountSignApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $outBizNo 外部业务号，查询对应账户状态，优先级高于account_id (optional)
     * @param  string $accountId 企业签约账户ID,用于外部商户已获取企业签约ID，查询账户状态 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayFundJointaccountSignQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundJointaccountSignQueryDefaultResponse
     */
    public function query($productCode = null, $bizScene = null, $outBizNo = null, $accountId = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($productCode, $bizScene, $outBizNo, $accountId, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayFundJointaccountSignQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundJointaccountSignQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($productCode = null, $bizScene = null, $outBizNo = null, $accountId = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($productCode, $bizScene, $outBizNo, $accountId, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountSignQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountSignQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountSignQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountSignQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountSignQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountSignQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountSignQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountSignQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($productCode = null, $bizScene = null, $outBizNo = null, $accountId = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($productCode, $bizScene, $outBizNo, $accountId, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($productCode = null, $bizScene = null, $outBizNo = null, $accountId = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountSignQueryResponseModel';
        $request = $this->queryRequest($productCode, $bizScene, $outBizNo, $accountId, $customizedParams);
     ...
     */
    public function queryRequest($productCode = null, $bizScene = null, $outBizNo = null, $accountId = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/fund/jointaccount/sign/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
