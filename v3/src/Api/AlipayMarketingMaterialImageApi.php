...
/**
 * AlipayMarketingMaterialImageApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMarketingMaterialImageApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 营销图片资源上传接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadModel $data data (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadDefaultResponse
     */
    public function upload($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->uploadWithHttpInfo($data, $fileContent, $customizedParams);
        return $response;
    }
     ...
     * 营销图片资源上传接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadModel $data (optional)
     * @param  \SplFileObject $fileContent (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadWithHttpInfo($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->uploadRequest($data, $fileContent, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function uploadAsync($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->uploadAsyncWithHttpInfo($data, $fileContent, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function uploadAsyncWithHttpInfo($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingMaterialImageUploadResponseModel';
        $request = $this->uploadRequest($data, $fileContent, $customizedParams);
     ...
     */
    public function uploadRequest($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/marketing/material/image';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
