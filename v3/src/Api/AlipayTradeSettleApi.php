...
/**
 * AlipayTradeSettleApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayTradeSettleApi
{
     ...
     * 统一收单确认结算接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmModel $alipayTradeSettleConfirmModel alipayTradeSettleConfirmModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmResponseModel|\Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmDefaultResponse
     */
    public function confirm($alipayTradeSettleConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->confirmWithHttpInfo($alipayTradeSettleConfirmModel, $customizedParams);
        return $response;
    }
     ...
     * 统一收单确认结算接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmModel $alipayTradeSettleConfirmModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmResponseModel|\Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function confirmWithHttpInfo($alipayTradeSettleConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->confirmRequest($alipayTradeSettleConfirmModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function confirmAsync($alipayTradeSettleConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->confirmAsyncWithHttpInfo($alipayTradeSettleConfirmModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function confirmAsyncWithHttpInfo($alipayTradeSettleConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayTradeSettleConfirmResponseModel';
        $request = $this->confirmRequest($alipayTradeSettleConfirmModel, $customizedParams);
     ...
     */
    public function confirmRequest($alipayTradeSettleConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/trade/settle/confirm';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayTradeSettleConfirmModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayTradeSettleConfirmModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayTradeSettleConfirmModel;
            }
