...
/**
 * AlipayOfflineMarketShopCategoryApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOfflineMarketShopCategoryApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 门店类目配置查询接口
     *
     * @param  string $categoryId 类目ID，如果为空则查询全部类目。 (optional)
     * @param  string $opRole 表示接口业务的调用方身份,默认不填标识为ISV。 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOfflineMarketShopCategoryQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOfflineMarketShopCategoryQueryDefaultResponse
     */
    public function query($categoryId = null, $opRole = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($categoryId, $opRole, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOfflineMarketShopCategoryQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOfflineMarketShopCategoryQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($categoryId = null, $opRole = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($categoryId, $opRole, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOfflineMarketShopCategoryQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOfflineMarketShopCategoryQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOfflineMarketShopCategoryQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOfflineMarketShopCategoryQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOfflineMarketShopCategoryQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOfflineMarketShopCategoryQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOfflineMarketShopCategoryQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOfflineMarketShopCategoryQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($categoryId = null, $opRole = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($categoryId, $opRole, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($categoryId = null, $opRole = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOfflineMarketShopCategoryQueryResponseModel';
        $request = $this->queryRequest($categoryId, $opRole, $customizedParams);
     ...
     */
    public function queryRequest($categoryId = null, $opRole = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/offline/market/shop/category/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
