...
/**
 * AlipayMobileStdPublicMessageCustomApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMobileStdPublicMessageCustomApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 异步单发消息
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMobileStdPublicMessageCustomSendModel $alipayMobileStdPublicMessageCustomSendModel alipayMobileStdPublicMessageCustomSendModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayMobileStdPublicMessageCustomSendDefaultResponse
     */
    public function send($alipayMobileStdPublicMessageCustomSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->sendWithHttpInfo($alipayMobileStdPublicMessageCustomSendModel, $customizedParams);
        return $response;
    }
     ...
     * 异步单发消息
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMobileStdPublicMessageCustomSendModel $alipayMobileStdPublicMessageCustomSendModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayMobileStdPublicMessageCustomSendDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendWithHttpInfo($alipayMobileStdPublicMessageCustomSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->sendRequest($alipayMobileStdPublicMessageCustomSendModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMobileStdPublicMessageCustomSendDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMobileStdPublicMessageCustomSendDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMobileStdPublicMessageCustomSendDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMobileStdPublicMessageCustomSendDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function sendAsync($alipayMobileStdPublicMessageCustomSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->sendAsyncWithHttpInfo($alipayMobileStdPublicMessageCustomSendModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function sendAsyncWithHttpInfo($alipayMobileStdPublicMessageCustomSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->sendRequest($alipayMobileStdPublicMessageCustomSendModel, $customizedParams);
     ...
     */
    public function sendRequest($alipayMobileStdPublicMessageCustomSendModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/mobile/std/public/message/custom/send';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayMobileStdPublicMessageCustomSendModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayMobileStdPublicMessageCustomSendModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayMobileStdPublicMessageCustomSendModel;
            }
