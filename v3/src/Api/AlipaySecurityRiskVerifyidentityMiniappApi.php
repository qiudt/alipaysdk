<?php
/**
 * AlipaySecurityRiskVerifyidentityMiniappApi
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AlipaySecurityRiskVerifyidentityMiniappApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipaySecurityRiskVerifyidentityMiniappApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 小程序核验服务结果确认接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmModel $alipaySecurityRiskVerifyidentityMiniappConfirmModel alipaySecurityRiskVerifyidentityMiniappConfirmModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmResponseModel|\Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmDefaultResponse
     */
    public function confirm($alipaySecurityRiskVerifyidentityMiniappConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->confirmWithHttpInfo($alipaySecurityRiskVerifyidentityMiniappConfirmModel, $customizedParams);
        return $response;
    }
     ...
     * 小程序核验服务结果确认接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmModel $alipaySecurityRiskVerifyidentityMiniappConfirmModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmResponseModel|\Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function confirmWithHttpInfo($alipaySecurityRiskVerifyidentityMiniappConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->confirmRequest($alipaySecurityRiskVerifyidentityMiniappConfirmModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function confirmAsync($alipaySecurityRiskVerifyidentityMiniappConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->confirmAsyncWithHttpInfo($alipaySecurityRiskVerifyidentityMiniappConfirmModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function confirmAsyncWithHttpInfo($alipaySecurityRiskVerifyidentityMiniappConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipaySecurityRiskVerifyidentityMiniappConfirmResponseModel';
        $request = $this->confirmRequest($alipaySecurityRiskVerifyidentityMiniappConfirmModel, $customizedParams);
     ...
     */
    public function confirmRequest($alipaySecurityRiskVerifyidentityMiniappConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/security/risk/verifyidentity/miniapp/confirm';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipaySecurityRiskVerifyidentityMiniappConfirmModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipaySecurityRiskVerifyidentityMiniappConfirmModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipaySecurityRiskVerifyidentityMiniappConfirmModel;
            }
