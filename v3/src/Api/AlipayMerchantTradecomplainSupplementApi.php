...
/**
 * AlipayMerchantTradecomplainSupplementApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMerchantTradecomplainSupplementApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 商家补充凭证
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainSupplementSubmitModel $alipayMerchantTradecomplainSupplementSubmitModel alipayMerchantTradecomplainSupplementSubmitModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainSupplementSubmitDefaultResponse
     */
    public function submit($alipayMerchantTradecomplainSupplementSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->submitWithHttpInfo($alipayMerchantTradecomplainSupplementSubmitModel, $customizedParams);
        return $response;
    }
     ...
     * 商家补充凭证
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainSupplementSubmitModel $alipayMerchantTradecomplainSupplementSubmitModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainSupplementSubmitDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitWithHttpInfo($alipayMerchantTradecomplainSupplementSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->submitRequest($alipayMerchantTradecomplainSupplementSubmitModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainSupplementSubmitDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainSupplementSubmitDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainSupplementSubmitDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainSupplementSubmitDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function submitAsync($alipayMerchantTradecomplainSupplementSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->submitAsyncWithHttpInfo($alipayMerchantTradecomplainSupplementSubmitModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function submitAsyncWithHttpInfo($alipayMerchantTradecomplainSupplementSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->submitRequest($alipayMerchantTradecomplainSupplementSubmitModel, $customizedParams);
     ...
     */
    public function submitRequest($alipayMerchantTradecomplainSupplementSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/merchant/tradecomplain/supplement';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayMerchantTradecomplainSupplementSubmitModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayMerchantTradecomplainSupplementSubmitModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayMerchantTradecomplainSupplementSubmitModel;
            }
