...
/**
 * ZolozAuthenticationCustomerSmilepayApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ZolozAuthenticationCustomerSmilepayApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 人脸刷脸付初始化
     *
     * @param  \Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeModel $zolozAuthenticationCustomerSmilepayInitializeModel zolozAuthenticationCustomerSmilepayInitializeModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeResponseModel|\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeDefaultResponse
     */
    public function initialize($zolozAuthenticationCustomerSmilepayInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->initializeWithHttpInfo($zolozAuthenticationCustomerSmilepayInitializeModel, $customizedParams);
        return $response;
    }
     ...
     * 人脸刷脸付初始化
     *
     * @param  \Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeModel $zolozAuthenticationCustomerSmilepayInitializeModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeResponseModel|\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function initializeWithHttpInfo($zolozAuthenticationCustomerSmilepayInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->initializeRequest($zolozAuthenticationCustomerSmilepayInitializeModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function initializeAsync($zolozAuthenticationCustomerSmilepayInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->initializeAsyncWithHttpInfo($zolozAuthenticationCustomerSmilepayInitializeModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function initializeAsyncWithHttpInfo($zolozAuthenticationCustomerSmilepayInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerSmilepayInitializeResponseModel';
        $request = $this->initializeRequest($zolozAuthenticationCustomerSmilepayInitializeModel, $customizedParams);
     ...
     */
    public function initializeRequest($zolozAuthenticationCustomerSmilepayInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/zoloz/authentication/customer/smilepay/initialize';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($zolozAuthenticationCustomerSmilepayInitializeModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($zolozAuthenticationCustomerSmilepayInitializeModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $zolozAuthenticationCustomerSmilepayInitializeModel;
            }
