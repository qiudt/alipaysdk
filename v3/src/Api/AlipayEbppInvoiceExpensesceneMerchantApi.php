...
/**
 * AlipayEbppInvoiceExpensesceneMerchantApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEbppInvoiceExpensesceneMerchantApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $roleId 商户ID (optional)
     * @param  string $pid 商户ID (optional)
     * @param  string $shopId 门店ID (optional)
     * @param  string $expenseType 费用类型 MEAL - 工作餐 (optional)
     * @param  int $pageNum 页码 (optional)
     * @param  int $pageSize 每页行数（最大100） (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensesceneMerchantQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensesceneMerchantQueryDefaultResponse
     */
    public function query($accountId = null, $agreementNo = null, $enterpriseId = null, $roleId = null, $pid = null, $shopId = null, $expenseType = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($accountId, $agreementNo, $enterpriseId, $roleId, $pid, $shopId, $expenseType, $pageNum, $pageSize, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensesceneMerchantQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensesceneMerchantQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($accountId = null, $agreementNo = null, $enterpriseId = null, $roleId = null, $pid = null, $shopId = null, $expenseType = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($accountId, $agreementNo, $enterpriseId, $roleId, $pid, $shopId, $expenseType, $pageNum, $pageSize, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensesceneMerchantQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensesceneMerchantQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensesceneMerchantQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensesceneMerchantQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensesceneMerchantQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensesceneMerchantQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensesceneMerchantQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensesceneMerchantQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($accountId = null, $agreementNo = null, $enterpriseId = null, $roleId = null, $pid = null, $shopId = null, $expenseType = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($accountId, $agreementNo, $enterpriseId, $roleId, $pid, $shopId, $expenseType, $pageNum, $pageSize, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($accountId = null, $agreementNo = null, $enterpriseId = null, $roleId = null, $pid = null, $shopId = null, $expenseType = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensesceneMerchantQueryResponseModel';
        $request = $this->queryRequest($accountId, $agreementNo, $enterpriseId, $roleId, $pid, $shopId, $expenseType, $pageNum, $pageSize, $customizedParams);
     ...
     */
    public function queryRequest($accountId = null, $agreementNo = null, $enterpriseId = null, $roleId = null, $pid = null, $shopId = null, $expenseType = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/invoice/expensescene/merchant/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
