...
/**
 * AlipayTradeBatchTransferApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayTradeBatchTransferApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 请款分账查询接口
     *
     * @param  string $outRequestNo 批量结算时传入的外部流水号，与settle_no二者必填其一。 out_request_no和settle_no如果同时存在，优先取settle_no (optional)
     * @param  string $settleNo 结算单据号，与out_request_no二者必填其一 (optional)
     * @param  string $extendParams 扩展字段 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayTradeBatchTransferQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayTradeBatchTransferQueryDefaultResponse
     */
    public function query($outRequestNo = null, $settleNo = null, $extendParams = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($outRequestNo, $settleNo, $extendParams, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayTradeBatchTransferQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayTradeBatchTransferQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($outRequestNo = null, $settleNo = null, $extendParams = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($outRequestNo, $settleNo, $extendParams, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayTradeBatchTransferQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayTradeBatchTransferQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayTradeBatchTransferQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayTradeBatchTransferQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayTradeBatchTransferQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayTradeBatchTransferQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayTradeBatchTransferQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayTradeBatchTransferQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($outRequestNo = null, $settleNo = null, $extendParams = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($outRequestNo, $settleNo, $extendParams, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($outRequestNo = null, $settleNo = null, $extendParams = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayTradeBatchTransferQueryResponseModel';
        $request = $this->queryRequest($outRequestNo, $settleNo, $extendParams, $customizedParams);
     ...
     */
    public function queryRequest($outRequestNo = null, $settleNo = null, $extendParams = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/trade/batch/transfer/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
