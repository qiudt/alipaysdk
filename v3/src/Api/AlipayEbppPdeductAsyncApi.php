...
/**
 * AlipayEbppPdeductAsyncApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEbppPdeductAsyncApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 公共事业缴费直连代扣异步扣款支付接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayModel $alipayEbppPdeductAsyncPayModel alipayEbppPdeductAsyncPayModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayDefaultResponse
     */
    public function pay($alipayEbppPdeductAsyncPayModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->payWithHttpInfo($alipayEbppPdeductAsyncPayModel, $customizedParams);
        return $response;
    }
     ...
     * 公共事业缴费直连代扣异步扣款支付接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayModel $alipayEbppPdeductAsyncPayModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function payWithHttpInfo($alipayEbppPdeductAsyncPayModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->payRequest($alipayEbppPdeductAsyncPayModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function payAsync($alipayEbppPdeductAsyncPayModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->payAsyncWithHttpInfo($alipayEbppPdeductAsyncPayModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function payAsyncWithHttpInfo($alipayEbppPdeductAsyncPayModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductAsyncPayResponseModel';
        $request = $this->payRequest($alipayEbppPdeductAsyncPayModel, $customizedParams);
     ...
     */
    public function payRequest($alipayEbppPdeductAsyncPayModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/pdeduct/async/pay';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayEbppPdeductAsyncPayModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayEbppPdeductAsyncPayModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayEbppPdeductAsyncPayModel;
            }
