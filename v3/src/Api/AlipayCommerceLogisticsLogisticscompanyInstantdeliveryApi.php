...
/**
 * AlipayCommerceLogisticsLogisticscompanyInstantdeliveryApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayCommerceLogisticsLogisticscompanyInstantdeliveryApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsLogisticscompanyInstantdeliveryQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsLogisticscompanyInstantdeliveryQueryDefaultResponse
     */
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsLogisticscompanyInstantdeliveryQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsLogisticscompanyInstantdeliveryQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo(?CustomizedParams $customizedParams = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsLogisticscompanyInstantdeliveryQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsLogisticscompanyInstantdeliveryQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsLogisticscompanyInstantdeliveryQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsLogisticscompanyInstantdeliveryQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsLogisticscompanyInstantdeliveryQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsLogisticscompanyInstantdeliveryQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsLogisticscompanyInstantdeliveryQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsLogisticscompanyInstantdeliveryQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
    ...
    public function queryRequest(?CustomizedParams $customizedParams = null)
    {
        ...
        $resourcePath = '/v3/alipay/commerce/logistics/logisticscompany/instantdelivery/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
