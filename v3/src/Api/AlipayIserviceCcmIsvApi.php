...
/**
 * AlipayIserviceCcmIsvApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayIserviceCcmIsvApi
{
     ...
     * ccm isv注册接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeModel $alipayIserviceCcmIsvInitializeModel alipayIserviceCcmIsvInitializeModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeResponseModel|\Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeDefaultResponse
     */
    public function initialize($alipayIserviceCcmIsvInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->initializeWithHttpInfo($alipayIserviceCcmIsvInitializeModel, $customizedParams);
        return $response;
    }
     ...
     * ccm isv注册接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeModel $alipayIserviceCcmIsvInitializeModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeResponseModel|\Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function initializeWithHttpInfo($alipayIserviceCcmIsvInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->initializeRequest($alipayIserviceCcmIsvInitializeModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function initializeAsync($alipayIserviceCcmIsvInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->initializeAsyncWithHttpInfo($alipayIserviceCcmIsvInitializeModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function initializeAsyncWithHttpInfo($alipayIserviceCcmIsvInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmIsvInitializeResponseModel';
        $request = $this->initializeRequest($alipayIserviceCcmIsvInitializeModel, $customizedParams);
     ...
     */
    public function initializeRequest($alipayIserviceCcmIsvInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/iservice/ccm/isv/initialize';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayIserviceCcmIsvInitializeModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayIserviceCcmIsvInitializeModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayIserviceCcmIsvInitializeModel;
            }
