...
/**
 * AlipayDataBillBailApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayDataBillBailApi
{
     ...
     * 支付宝商家账户保证金查询
     *
     * @param  string $startTime 保证金流水创建时间的起始范围 (optional)
     * @param  string $endTime 保证金流水创建时间的结束范围。与起始时间间隔不超过31天。查询结果为起始时间至结束时间的左闭右开区间 (optional)
     * @param  string $bailType 保证金类型，目前支持TMALL_S_BAIL-天猫保证金，TAOBAO_BAIL-淘宝保证金 (optional)
     * @param  string $transLogId 保证金流水号。如果查询参数中指定流水号，则只查询流水号相关的记录 (optional)
     * @param  string $bizOrigNo 业务基础订单号。如果查询参数中指定订单号，则只查询相关的记录 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayDataBillBailQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayDataBillBailQueryDefaultResponse
     */
    public function query($startTime = null, $endTime = null, $bailType = null, $transLogId = null, $bizOrigNo = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($startTime, $endTime, $bailType, $transLogId, $bizOrigNo, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayDataBillBailQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayDataBillBailQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($startTime = null, $endTime = null, $bailType = null, $transLogId = null, $bizOrigNo = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($startTime, $endTime, $bailType, $transLogId, $bizOrigNo, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBailQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBailQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayDataBillBailQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBailQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBailQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayDataBillBailQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayDataBillBailQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayDataBillBailQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($startTime = null, $endTime = null, $bailType = null, $transLogId = null, $bizOrigNo = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($startTime, $endTime, $bailType, $transLogId, $bizOrigNo, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($startTime = null, $endTime = null, $bailType = null, $transLogId = null, $bizOrigNo = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayDataBillBailQueryResponseModel';
        $request = $this->queryRequest($startTime, $endTime, $bailType, $transLogId, $bizOrigNo, $customizedParams);
     ...
     */
    public function queryRequest($startTime = null, $endTime = null, $bailType = null, $transLogId = null, $bizOrigNo = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/data/bill/bail/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
