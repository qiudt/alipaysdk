...
/**
 * AlipayMarketingActivityShopApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMarketingActivityShopApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayMarketingActivityShopBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingActivityShopBatchqueryDefaultResponse
     */
    public function batchquery($activityId, $merchantId = null, $pageNum = null, $pageSize = null, $productVersion = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->batchqueryWithHttpInfo($activityId, $merchantId, $pageNum, $pageSize, $productVersion, $merchantAccessMode, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayMarketingActivityShopBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingActivityShopBatchqueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function batchqueryWithHttpInfo($activityId, $merchantId = null, $pageNum = null, $pageSize = null, $productVersion = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->batchqueryRequest($activityId, $merchantId, $pageNum, $pageSize, $productVersion, $merchantAccessMode, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityShopBatchqueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityShopBatchqueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityShopBatchqueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityShopBatchqueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityShopBatchqueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityShopBatchqueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityShopBatchqueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityShopBatchqueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function batchqueryAsync($activityId, $merchantId = null, $pageNum = null, $pageSize = null, $productVersion = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->batchqueryAsyncWithHttpInfo($activityId, $merchantId, $pageNum, $pageSize, $productVersion, $merchantAccessMode, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function batchqueryAsyncWithHttpInfo($activityId, $merchantId = null, $pageNum = null, $pageSize = null, $productVersion = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityShopBatchqueryResponseModel';
        $request = $this->batchqueryRequest($activityId, $merchantId, $pageNum, $pageSize, $productVersion, $merchantAccessMode, $customizedParams);
     ...
     */
    public function batchqueryRequest($activityId, $merchantId = null, $pageNum = null, $pageSize = null, $productVersion = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        ...
        $resourcePath = '/v3/alipay/marketing/activity/{activity_id}/shop/batchquery';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
