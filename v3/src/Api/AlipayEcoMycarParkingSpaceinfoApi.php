...
/**
 * AlipayEcoMycarParkingSpaceinfoApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEcoMycarParkingSpaceinfoApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 停车场车位信息同步
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncModel $alipayEcoMycarParkingSpaceinfoSyncModel alipayEcoMycarParkingSpaceinfoSyncModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncResponseModel|\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncDefaultResponse
     */
    public function sync($alipayEcoMycarParkingSpaceinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->syncWithHttpInfo($alipayEcoMycarParkingSpaceinfoSyncModel, $customizedParams);
        return $response;
    }
     ...
     * 停车场车位信息同步
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncModel $alipayEcoMycarParkingSpaceinfoSyncModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncResponseModel|\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function syncWithHttpInfo($alipayEcoMycarParkingSpaceinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->syncRequest($alipayEcoMycarParkingSpaceinfoSyncModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function syncAsync($alipayEcoMycarParkingSpaceinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->syncAsyncWithHttpInfo($alipayEcoMycarParkingSpaceinfoSyncModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function syncAsyncWithHttpInfo($alipayEcoMycarParkingSpaceinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingSpaceinfoSyncResponseModel';
        $request = $this->syncRequest($alipayEcoMycarParkingSpaceinfoSyncModel, $customizedParams);
     ...
     */
    public function syncRequest($alipayEcoMycarParkingSpaceinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/eco/mycar/parking/spaceinfo/sync';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayEcoMycarParkingSpaceinfoSyncModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayEcoMycarParkingSpaceinfoSyncModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayEcoMycarParkingSpaceinfoSyncModel;
            }
