...
/**
 * AlipayOpenMiniInnerversionPackageApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerversionPackageApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 单独构建包信息
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionPackageCreateModel $alipayOpenMiniInnerversionPackageCreateModel alipayOpenMiniInnerversionPackageCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionPackageCreateDefaultResponse
     */
    public function create($alipayOpenMiniInnerversionPackageCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->createWithHttpInfo($alipayOpenMiniInnerversionPackageCreateModel, $customizedParams);
        return $response;
    }
     ...
     * 单独构建包信息
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionPackageCreateModel $alipayOpenMiniInnerversionPackageCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionPackageCreateDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($alipayOpenMiniInnerversionPackageCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->createRequest($alipayOpenMiniInnerversionPackageCreateModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionPackageCreateDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionPackageCreateDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionPackageCreateDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionPackageCreateDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function createAsync($alipayOpenMiniInnerversionPackageCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->createAsyncWithHttpInfo($alipayOpenMiniInnerversionPackageCreateModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function createAsyncWithHttpInfo($alipayOpenMiniInnerversionPackageCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->createRequest($alipayOpenMiniInnerversionPackageCreateModel, $customizedParams);
     ...
     */
    public function createRequest($alipayOpenMiniInnerversionPackageCreateModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerversion/package/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniInnerversionPackageCreateModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniInnerversionPackageCreateModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniInnerversionPackageCreateModel;
            }
