...
/**
 * AlipayEbppInvoiceApplyInvApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEbppInvoiceApplyInvApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 发票回传
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadModel $alipayEbppInvoiceApplyInvUploadModel alipayEbppInvoiceApplyInvUploadModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadDefaultResponse
     */
    public function upload($alipayEbppInvoiceApplyInvUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->uploadWithHttpInfo($alipayEbppInvoiceApplyInvUploadModel, $customizedParams);
        return $response;
    }
     ...
     * 发票回传
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadModel $alipayEbppInvoiceApplyInvUploadModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadWithHttpInfo($alipayEbppInvoiceApplyInvUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->uploadRequest($alipayEbppInvoiceApplyInvUploadModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function uploadAsync($alipayEbppInvoiceApplyInvUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->uploadAsyncWithHttpInfo($alipayEbppInvoiceApplyInvUploadModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function uploadAsyncWithHttpInfo($alipayEbppInvoiceApplyInvUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceApplyInvUploadResponseModel';
        $request = $this->uploadRequest($alipayEbppInvoiceApplyInvUploadModel, $customizedParams);
     ...
     */
    public function uploadRequest($alipayEbppInvoiceApplyInvUploadModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/invoice/apply/inv/upload';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayEbppInvoiceApplyInvUploadModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayEbppInvoiceApplyInvUploadModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayEbppInvoiceApplyInvUploadModel;
            }
