<?php
/**
 * AlipayEbppInvoiceExpenserulesGroupemployeeApi
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AlipayEbppInvoiceExpenserulesGroupemployeeApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEbppInvoiceExpenserulesGroupemployeeApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 修改费控规则员工
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyModel $alipayEbppInvoiceExpenserulesGroupemployeeModifyModel alipayEbppInvoiceExpenserulesGroupemployeeModifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyDefaultResponse
     */
    public function modify($alipayEbppInvoiceExpenserulesGroupemployeeModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->modifyWithHttpInfo($alipayEbppInvoiceExpenserulesGroupemployeeModifyModel, $customizedParams);
        return $response;
    }
     ...
     * 修改费控规则员工
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyModel $alipayEbppInvoiceExpenserulesGroupemployeeModifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function modifyWithHttpInfo($alipayEbppInvoiceExpenserulesGroupemployeeModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->modifyRequest($alipayEbppInvoiceExpenserulesGroupemployeeModifyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function modifyAsync($alipayEbppInvoiceExpenserulesGroupemployeeModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->modifyAsyncWithHttpInfo($alipayEbppInvoiceExpenserulesGroupemployeeModifyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function modifyAsyncWithHttpInfo($alipayEbppInvoiceExpenserulesGroupemployeeModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesGroupemployeeModifyResponseModel';
        $request = $this->modifyRequest($alipayEbppInvoiceExpenserulesGroupemployeeModifyModel, $customizedParams);
     ...
     */
    public function modifyRequest($alipayEbppInvoiceExpenserulesGroupemployeeModifyModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/invoice/expenserules/groupemployee/modify';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayEbppInvoiceExpenserulesGroupemployeeModifyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayEbppInvoiceExpenserulesGroupemployeeModifyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayEbppInvoiceExpenserulesGroupemployeeModifyModel;
            }
