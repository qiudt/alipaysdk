...
/**
 * AlipayUserTwostageIndirectApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayUserTwostageIndirectApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 双联二阶段
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseModel $alipayUserTwostageIndirectUseModel alipayUserTwostageIndirectUseModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseResponseModel|\Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseDefaultResponse
     */
    public function callUse($alipayUserTwostageIndirectUseModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->callUseWithHttpInfo($alipayUserTwostageIndirectUseModel, $customizedParams);
        return $response;
    }
     ...
     * 双联二阶段
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseModel $alipayUserTwostageIndirectUseModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseResponseModel|\Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function callUseWithHttpInfo($alipayUserTwostageIndirectUseModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->callUseRequest($alipayUserTwostageIndirectUseModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function callUseAsync($alipayUserTwostageIndirectUseModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->callUseAsyncWithHttpInfo($alipayUserTwostageIndirectUseModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function callUseAsyncWithHttpInfo($alipayUserTwostageIndirectUseModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayUserTwostageIndirectUseResponseModel';
        $request = $this->callUseRequest($alipayUserTwostageIndirectUseModel, $customizedParams);
     ...
     */
    public function callUseRequest($alipayUserTwostageIndirectUseModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/user/twostage/indirect/use';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayUserTwostageIndirectUseModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayUserTwostageIndirectUseModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayUserTwostageIndirectUseModel;
            }
