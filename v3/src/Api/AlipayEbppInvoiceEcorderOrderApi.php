...
/**
 * AlipayEbppInvoiceEcorderOrderApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEbppInvoiceEcorderOrderApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $orderId 订单ID (optional)
     * @param  string $orderType 订单类型 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEcorderOrderQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEcorderOrderQueryDefaultResponse
     */
    public function query($enterpriseId = null, $accountId = null, $agreementNo = null, $orderId = null, $orderType = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($enterpriseId, $accountId, $agreementNo, $orderId, $orderType, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEcorderOrderQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEcorderOrderQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($enterpriseId = null, $accountId = null, $agreementNo = null, $orderId = null, $orderType = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($enterpriseId, $accountId, $agreementNo, $orderId, $orderType, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEcorderOrderQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEcorderOrderQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEcorderOrderQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEcorderOrderQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEcorderOrderQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEcorderOrderQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEcorderOrderQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEcorderOrderQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($enterpriseId = null, $accountId = null, $agreementNo = null, $orderId = null, $orderType = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($enterpriseId, $accountId, $agreementNo, $orderId, $orderType, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($enterpriseId = null, $accountId = null, $agreementNo = null, $orderId = null, $orderType = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEcorderOrderQueryResponseModel';
        $request = $this->queryRequest($enterpriseId, $accountId, $agreementNo, $orderId, $orderType, $customizedParams);
     ...
     */
    public function queryRequest($enterpriseId = null, $accountId = null, $agreementNo = null, $orderId = null, $orderType = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/invoice/ecorder/order/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
