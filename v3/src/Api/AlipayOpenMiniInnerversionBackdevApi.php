...
/**
 * AlipayOpenMiniInnerversionBackdevApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerversionBackdevApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 内部链路小程序退回开发
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBackdevPublishModel $alipayOpenMiniInnerversionBackdevPublishModel alipayOpenMiniInnerversionBackdevPublishModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBackdevPublishDefaultResponse
     */
    public function publish($alipayOpenMiniInnerversionBackdevPublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->publishWithHttpInfo($alipayOpenMiniInnerversionBackdevPublishModel, $customizedParams);
        return $response;
    }
     ...
     * 内部链路小程序退回开发
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBackdevPublishModel $alipayOpenMiniInnerversionBackdevPublishModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBackdevPublishDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function publishWithHttpInfo($alipayOpenMiniInnerversionBackdevPublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->publishRequest($alipayOpenMiniInnerversionBackdevPublishModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBackdevPublishDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBackdevPublishDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBackdevPublishDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBackdevPublishDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function publishAsync($alipayOpenMiniInnerversionBackdevPublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->publishAsyncWithHttpInfo($alipayOpenMiniInnerversionBackdevPublishModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function publishAsyncWithHttpInfo($alipayOpenMiniInnerversionBackdevPublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->publishRequest($alipayOpenMiniInnerversionBackdevPublishModel, $customizedParams);
     ...
     */
    public function publishRequest($alipayOpenMiniInnerversionBackdevPublishModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerversion/backdev/publish';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniInnerversionBackdevPublishModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniInnerversionBackdevPublishModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniInnerversionBackdevPublishModel;
            }
