...
/**
 * AlipayMarketingCardActivateformApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMarketingCardActivateformApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $bizType 开放表单信息查询业务类型 (optional)
     * @param  string $templateId 会员卡模板id。使用会员卡模板创建接口(alipay.marketing.card.template.create)返回的结果 (optional)
     * @param  string $requestId 查询用户表单提交信息的请求id。  网页移动应用&amp;小程序应用：与auth_code  一起通过alipay.marketing.card.activateurl.apply(获取会员卡领卡投放链接)接口callback地址回传。  注意：auth_code（用户授权码）用于换取用户授权令牌 accessToken，后续调用接口需传入accessToken。 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayMarketingCardActivateformQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingCardActivateformQueryDefaultResponse
     */
    public function query($authToken = null, $bizType = null, $templateId = null, $requestId = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($authToken, $bizType, $templateId, $requestId, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayMarketingCardActivateformQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingCardActivateformQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($authToken = null, $bizType = null, $templateId = null, $requestId = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($authToken, $bizType, $templateId, $requestId, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCardActivateformQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCardActivateformQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingCardActivateformQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCardActivateformQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCardActivateformQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingCardActivateformQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingCardActivateformQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMarketingCardActivateformQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($authToken = null, $bizType = null, $templateId = null, $requestId = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($authToken, $bizType, $templateId, $requestId, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($authToken = null, $bizType = null, $templateId = null, $requestId = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingCardActivateformQueryResponseModel';
        $request = $this->queryRequest($authToken, $bizType, $templateId, $requestId, $customizedParams);
     ...
     */
    public function queryRequest($authToken = null, $bizType = null, $templateId = null, $requestId = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/marketing/card/activateform/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
