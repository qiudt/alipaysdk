...
/**
 * AlipayIserviceCcmOlsChatrecordApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayIserviceCcmOlsChatrecordApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 查询某通在线服务的聊天记录
     *
     * @param  string $ccsInstanceId 租户实例id（数据权限id），不填，则使用默认的租户实例id (optional)
     * @param  string $id 在线服务记录id (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayIserviceCcmOlsChatrecordQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayIserviceCcmOlsChatrecordQueryDefaultResponse
     */
    public function query($ccsInstanceId = null, $id = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($ccsInstanceId, $id, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayIserviceCcmOlsChatrecordQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayIserviceCcmOlsChatrecordQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($ccsInstanceId = null, $id = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($ccsInstanceId, $id, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayIserviceCcmOlsChatrecordQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayIserviceCcmOlsChatrecordQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmOlsChatrecordQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayIserviceCcmOlsChatrecordQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayIserviceCcmOlsChatrecordQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmOlsChatrecordQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmOlsChatrecordQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmOlsChatrecordQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($ccsInstanceId = null, $id = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($ccsInstanceId, $id, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($ccsInstanceId = null, $id = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmOlsChatrecordQueryResponseModel';
        $request = $this->queryRequest($ccsInstanceId, $id, $customizedParams);
     ...
     */
    public function queryRequest($ccsInstanceId = null, $id = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/iservice/ccm/ols/chatrecord/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
