...
/**
 * AlipaySystemOauthApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipaySystemOauthApi
{
     ...
     * 换取授权访问令牌
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenModel $alipaySystemOauthTokenModel alipaySystemOauthTokenModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenResponseModel|\Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenDefaultResponse
     */
    public function token($alipaySystemOauthTokenModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->tokenWithHttpInfo($alipaySystemOauthTokenModel, $customizedParams);
        return $response;
    }
     ...
     * 换取授权访问令牌
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenModel $alipaySystemOauthTokenModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenResponseModel|\Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function tokenWithHttpInfo($alipaySystemOauthTokenModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->tokenRequest($alipaySystemOauthTokenModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function tokenAsync($alipaySystemOauthTokenModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->tokenAsyncWithHttpInfo($alipaySystemOauthTokenModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function tokenAsyncWithHttpInfo($alipaySystemOauthTokenModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipaySystemOauthTokenResponseModel';
        $request = $this->tokenRequest($alipaySystemOauthTokenModel, $customizedParams);
     ...
     */
    public function tokenRequest($alipaySystemOauthTokenModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/system/oauth/token';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipaySystemOauthTokenModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipaySystemOauthTokenModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipaySystemOauthTokenModel;
            }
