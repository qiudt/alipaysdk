...
/**
 * AlipayFundAuthOrderAppApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayFundAuthOrderAppApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 线上资金授权冻结接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeModel $alipayFundAuthOrderAppFreezeModel alipayFundAuthOrderAppFreezeModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeDefaultResponse
     */
    public function freeze($alipayFundAuthOrderAppFreezeModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->freezeWithHttpInfo($alipayFundAuthOrderAppFreezeModel, $customizedParams);
        return $response;
    }
     ...
     * 线上资金授权冻结接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeModel $alipayFundAuthOrderAppFreezeModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function freezeWithHttpInfo($alipayFundAuthOrderAppFreezeModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->freezeRequest($alipayFundAuthOrderAppFreezeModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function freezeAsync($alipayFundAuthOrderAppFreezeModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->freezeAsyncWithHttpInfo($alipayFundAuthOrderAppFreezeModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function freezeAsyncWithHttpInfo($alipayFundAuthOrderAppFreezeModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundAuthOrderAppFreezeResponseModel';
        $request = $this->freezeRequest($alipayFundAuthOrderAppFreezeModel, $customizedParams);
     ...
     */
    public function freezeRequest($alipayFundAuthOrderAppFreezeModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/fund/auth/order/app/freeze';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayFundAuthOrderAppFreezeModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayFundAuthOrderAppFreezeModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayFundAuthOrderAppFreezeModel;
            }
