...
/**
 * AlipayOpenMiniInnerversionUploadstatusApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerversionUploadstatusApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 多端小程序-查询构建状态
     *
     * @param  string $buildPackageId 包管理ID，用于查询打包状态 (optional)
     * @param  string $miniAppId 小程序ID (optional)
     * @param  string $buildVersion 小程序版本 (optional)
     * @param  string $instCode 租户id (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionUploadstatusQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionUploadstatusQueryDefaultResponse
     */
    public function query($buildPackageId = null, $miniAppId = null, $buildVersion = null, $instCode = null, $bundleId = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($buildPackageId, $miniAppId, $buildVersion, $instCode, $bundleId, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionUploadstatusQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionUploadstatusQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($buildPackageId = null, $miniAppId = null, $buildVersion = null, $instCode = null, $bundleId = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($buildPackageId, $miniAppId, $buildVersion, $instCode, $bundleId, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionUploadstatusQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionUploadstatusQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionUploadstatusQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionUploadstatusQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionUploadstatusQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionUploadstatusQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionUploadstatusQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionUploadstatusQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($buildPackageId = null, $miniAppId = null, $buildVersion = null, $instCode = null, $bundleId = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($buildPackageId, $miniAppId, $buildVersion, $instCode, $bundleId, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($buildPackageId = null, $miniAppId = null, $buildVersion = null, $instCode = null, $bundleId = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionUploadstatusQueryResponseModel';
        $request = $this->queryRequest($buildPackageId, $miniAppId, $buildVersion, $instCode, $bundleId, $customizedParams);
     ...
     */
    public function queryRequest($buildPackageId = null, $miniAppId = null, $buildVersion = null, $instCode = null, $bundleId = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerversion/uploadstatus/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $buildPackageId,
            'build_package_id', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
