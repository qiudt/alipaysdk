...
/**
 * AlipayOpenMiniInnerversionInstantiationApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerversionInstantiationApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 小程序实例化关系查询
     *
     * @param  string $appOrigin 来源类型，新接入方需要向支付宝申请专用来源，否则不予接入，申请方式请参见接入手册。 (optional)
     * @param  string $bundleId 端id (optional)
     * @param  string $miniAppId 小程序ID，特殊场景专用，普通业务方无需关注该参数。 (optional)
     * @param  string $appVersion 实例化小程序版本号 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionInstantiationQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionInstantiationQueryDefaultResponse
     */
    public function query($appOrigin = null, $bundleId = null, $miniAppId = null, $appVersion = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($appOrigin, $bundleId, $miniAppId, $appVersion, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionInstantiationQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionInstantiationQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($appOrigin = null, $bundleId = null, $miniAppId = null, $appVersion = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($appOrigin, $bundleId, $miniAppId, $appVersion, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionInstantiationQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionInstantiationQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionInstantiationQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionInstantiationQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionInstantiationQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionInstantiationQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionInstantiationQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionInstantiationQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($appOrigin = null, $bundleId = null, $miniAppId = null, $appVersion = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($appOrigin, $bundleId, $miniAppId, $appVersion, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($appOrigin = null, $bundleId = null, $miniAppId = null, $appVersion = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionInstantiationQueryResponseModel';
        $request = $this->queryRequest($appOrigin, $bundleId, $miniAppId, $appVersion, $customizedParams);
     ...
     */
    public function queryRequest($appOrigin = null, $bundleId = null, $miniAppId = null, $appVersion = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerversion/instantiation/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
