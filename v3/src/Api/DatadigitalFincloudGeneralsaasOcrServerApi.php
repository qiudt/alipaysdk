...
/**
 * DatadigitalFincloudGeneralsaasOcrServerApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DatadigitalFincloudGeneralsaasOcrServerApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 服务端OCR
     *
     * @param  \Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectModel $data data (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectResponseModel|\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectDefaultResponse
     */
    public function detect($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->detectWithHttpInfo($data, $fileContent, $customizedParams);
        return $response;
    }

    /**
     * Operation detectWithHttpInfo
     *
     * 服务端OCR
     *
     * @param  \Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectModel $data (optional)
     * @param  \SplFileObject $fileContent (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectResponseModel|\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function detectWithHttpInfo($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->detectRequest($data, $fileContent, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function detectAsync($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->detectAsyncWithHttpInfo($data, $fileContent, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation detectAsyncWithHttpInfo
     *
     * 服务端OCR
     *
     * @param  \Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectModel $data (optional)
     ...
     * @deprecated
     */
    public function detectAsyncWithHttpInfo($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectResponseModel';
        $request = $this->detectRequest($data, $fileContent, $customizedParams);
    ...
    /**
     * Create request for operation 'detect'
     *
     * @param  \Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrServerDetectModel $data (optional)
     * @param  \SplFileObject $fileContent (optional)
     * @param CustomizedParams $customizedParams
     ...
     */
    public function detectRequest($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/datadigital/fincloud/generalsaas/ocr/server/detect';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
