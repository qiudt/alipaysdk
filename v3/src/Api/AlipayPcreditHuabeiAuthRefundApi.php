<?php
/**
 * AlipayPcreditHuabeiAuthRefundApi
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AlipayPcreditHuabeiAuthRefundApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayPcreditHuabeiAuthRefundApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 花芝结算扣款费用逆向退款申请
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyModel $alipayPcreditHuabeiAuthRefundApplyModel alipayPcreditHuabeiAuthRefundApplyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyResponseModel|\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyDefaultResponse
     */
    public function apply($alipayPcreditHuabeiAuthRefundApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->applyWithHttpInfo($alipayPcreditHuabeiAuthRefundApplyModel, $customizedParams);
        return $response;
    }
     ...
     * 花芝结算扣款费用逆向退款申请
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyModel $alipayPcreditHuabeiAuthRefundApplyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyResponseModel|\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function applyWithHttpInfo($alipayPcreditHuabeiAuthRefundApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->applyRequest($alipayPcreditHuabeiAuthRefundApplyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function applyAsync($alipayPcreditHuabeiAuthRefundApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->applyAsyncWithHttpInfo($alipayPcreditHuabeiAuthRefundApplyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function applyAsyncWithHttpInfo($alipayPcreditHuabeiAuthRefundApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthRefundApplyResponseModel';
        $request = $this->applyRequest($alipayPcreditHuabeiAuthRefundApplyModel, $customizedParams);
     ...
     */
    public function applyRequest($alipayPcreditHuabeiAuthRefundApplyModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/pcredit/huabei/auth/refund/apply';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayPcreditHuabeiAuthRefundApplyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayPcreditHuabeiAuthRefundApplyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayPcreditHuabeiAuthRefundApplyModel;
            }
