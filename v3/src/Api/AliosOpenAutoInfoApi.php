...
/**
 * AliosOpenAutoInfoApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AliosOpenAutoInfoApi
{
     ...
     * @param  string $openId 经度 (optional)
     * @param  string $deviceToken 设备token (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AliosOpenAutoInfoQueryResponseModel|\Alipay\OpenAPISDK\Model\AliosOpenAutoInfoQueryDefaultResponse
     */
    public function query($authToken = null, $userId = null, $openId = null, $deviceToken = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($authToken, $userId, $openId, $deviceToken, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AliosOpenAutoInfoQueryResponseModel|\Alipay\OpenAPISDK\Model\AliosOpenAutoInfoQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($authToken = null, $userId = null, $openId = null, $deviceToken = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($authToken, $userId, $openId, $deviceToken, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AliosOpenAutoInfoQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AliosOpenAutoInfoQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AliosOpenAutoInfoQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AliosOpenAutoInfoQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AliosOpenAutoInfoQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AliosOpenAutoInfoQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AliosOpenAutoInfoQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AliosOpenAutoInfoQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($authToken = null, $userId = null, $openId = null, $deviceToken = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($authToken, $userId, $openId, $deviceToken, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($authToken = null, $userId = null, $openId = null, $deviceToken = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AliosOpenAutoInfoQueryResponseModel';
        $request = $this->queryRequest($authToken, $userId, $openId, $deviceToken, $customizedParams);
     ...
     */
    public function queryRequest($authToken = null, $userId = null, $openId = null, $deviceToken = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alios/open/auto/info/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
