...
/**
 * AlipayFundAccountApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayFundAccountApi
{
     ...
     * 支付宝资金账户资产查询接口
     *
     * @param  string $merchantUserId 商户会员的唯一标识。如果传入的user_id为虚拟账户userId，此字段必传并比对一致性。 (optional)
     * @param  string $alipayUserId 支付宝会员 id。 (optional)
     * @param  string $alipayOpenId 支付宝openId (optional)
     * @param  string $accountProductCode 开户产品码。如果查询托管子户余额，必传且必须传入与开户时传入的值一致。 (optional)
     * @param  string $accountType 查询的账号类型，查询余额账户值为ACCTRANS_ACCOUNT。必填。 (optional)
     * @param  string $accountSceneCode 开户场景码，与开户产品码不可同时传递。 (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayFundAccountQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundAccountQueryDefaultResponse
     */
    public function query($merchantUserId = null, $alipayUserId = null, $alipayOpenId = null, $accountProductCode = null, $accountType = null, $accountSceneCode = null, $extInfo = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($merchantUserId, $alipayUserId, $alipayOpenId, $accountProductCode, $accountType, $accountSceneCode, $extInfo, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayFundAccountQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundAccountQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($merchantUserId = null, $alipayUserId = null, $alipayOpenId = null, $accountProductCode = null, $accountType = null, $accountSceneCode = null, $extInfo = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($merchantUserId, $alipayUserId, $alipayOpenId, $accountProductCode, $accountType, $accountSceneCode, $extInfo, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundAccountQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundAccountQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundAccountQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundAccountQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundAccountQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundAccountQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundAccountQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayFundAccountQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($merchantUserId = null, $alipayUserId = null, $alipayOpenId = null, $accountProductCode = null, $accountType = null, $accountSceneCode = null, $extInfo = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($merchantUserId, $alipayUserId, $alipayOpenId, $accountProductCode, $accountType, $accountSceneCode, $extInfo, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($merchantUserId = null, $alipayUserId = null, $alipayOpenId = null, $accountProductCode = null, $accountType = null, $accountSceneCode = null, $extInfo = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundAccountQueryResponseModel';
        $request = $this->queryRequest($merchantUserId, $alipayUserId, $alipayOpenId, $accountProductCode, $accountType, $accountSceneCode, $extInfo, $customizedParams);
     ...
     */
    public function queryRequest($merchantUserId = null, $alipayUserId = null, $alipayOpenId = null, $accountProductCode = null, $accountType = null, $accountSceneCode = null, $extInfo = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/fund/account/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $accountProductCode,
            'account_product_code', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $accountSceneCode,
            'account_scene_code', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
