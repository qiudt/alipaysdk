...
/**
 * AlipayCommerceEcBalanceDownloadurlApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayCommerceEcBalanceDownloadurlApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $billType 账单类型 (optional)
     * @param  string $billDate 账单时间 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayCommerceEcBalanceDownloadurlQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceEcBalanceDownloadurlQueryDefaultResponse
     */
    public function query($enterpriseId = null, $accountId = null, $agreementNo = null, $billType = null, $billDate = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($enterpriseId, $accountId, $agreementNo, $billType, $billDate, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayCommerceEcBalanceDownloadurlQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceEcBalanceDownloadurlQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($enterpriseId = null, $accountId = null, $agreementNo = null, $billType = null, $billDate = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($enterpriseId, $accountId, $agreementNo, $billType, $billDate, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcBalanceDownloadurlQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcBalanceDownloadurlQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceEcBalanceDownloadurlQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcBalanceDownloadurlQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcBalanceDownloadurlQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceEcBalanceDownloadurlQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceEcBalanceDownloadurlQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayCommerceEcBalanceDownloadurlQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($enterpriseId = null, $accountId = null, $agreementNo = null, $billType = null, $billDate = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($enterpriseId, $accountId, $agreementNo, $billType, $billDate, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($enterpriseId = null, $accountId = null, $agreementNo = null, $billType = null, $billDate = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceEcBalanceDownloadurlQueryResponseModel';
        $request = $this->queryRequest($enterpriseId, $accountId, $agreementNo, $billType, $billDate, $customizedParams);
     ...
     */
    public function queryRequest($enterpriseId = null, $accountId = null, $agreementNo = null, $billType = null, $billDate = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/commerce/ec/balance/downloadurl/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
