...
/**
 * AlipayOpenMiniTemplatemsgTinypayswitchApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniTemplatemsgTinypayswitchApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgTinypayswitchConfirmDefaultResponse
     */
    public function confirm(?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->confirmWithHttpInfo($customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgTinypayswitchConfirmDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function confirmWithHttpInfo(?CustomizedParams $customizedParams = null)
    {
        $request = $this->confirmRequest($customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgTinypayswitchConfirmDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgTinypayswitchConfirmDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgTinypayswitchConfirmDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgTinypayswitchConfirmDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function confirmAsync(?CustomizedParams $customizedParams = null)
    {
        return $this->confirmAsyncWithHttpInfo($customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function confirmAsyncWithHttpInfo(?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->confirmRequest($customizedParams);
     ...
     */
    public function confirmRequest(?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/templatemsg/tinypayswitch/confirm';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
