...
/**
 * AlipayEbppPdeductApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayEbppPdeductApi
{
     ...
     * 公共事业缴费直连代扣扣款支付接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayModel $alipayEbppPdeductPayModel alipayEbppPdeductPayModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayDefaultResponse
     */
    public function pay($alipayEbppPdeductPayModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->payWithHttpInfo($alipayEbppPdeductPayModel, $customizedParams);
        return $response;
    }
     ...
     * 公共事业缴费直连代扣扣款支付接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayModel $alipayEbppPdeductPayModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function payWithHttpInfo($alipayEbppPdeductPayModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->payRequest($alipayEbppPdeductPayModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function payAsync($alipayEbppPdeductPayModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->payAsyncWithHttpInfo($alipayEbppPdeductPayModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function payAsyncWithHttpInfo($alipayEbppPdeductPayModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductPayResponseModel';
        $request = $this->payRequest($alipayEbppPdeductPayModel, $customizedParams);
     ...
     */
    public function payRequest($alipayEbppPdeductPayModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/pdeduct/pay';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayEbppPdeductPayModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayEbppPdeductPayModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayEbppPdeductPayModel;
            }
