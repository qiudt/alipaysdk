...
/**
 * AlipayDataBillSellApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayDataBillSellApi
{
     ...
     * 支付宝商家账户卖出交易查询
     *
     * @param  string $startTime 卖出交易流水创建时间的起始范围 (optional)
     * @param  string $endTime 卖出交易流水创建时间的结束范围。与起始时间间隔不超过31天。查询结果为起始时间至结束时间的左闭右开区间 (optional)
     * @param  string $alipayOrderNo 支付宝交易流水号。如果查询参数中指定流水号，则只查询流水号相关的记录 (optional)
     * @param  string $merchantOrderNo 商户交易号。如果查询参数中指定交易号，则只查询相关的记录 (optional)
     * @param  string $storeNo 门店编号，模糊搜索 (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayDataBillSellQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayDataBillSellQueryDefaultResponse
     */
    public function query($startTime = null, $endTime = null, $alipayOrderNo = null, $merchantOrderNo = null, $storeNo = null, $pageNo = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($startTime, $endTime, $alipayOrderNo, $merchantOrderNo, $storeNo, $pageNo, $pageSize, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayDataBillSellQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayDataBillSellQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($startTime = null, $endTime = null, $alipayOrderNo = null, $merchantOrderNo = null, $storeNo = null, $pageNo = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($startTime, $endTime, $alipayOrderNo, $merchantOrderNo, $storeNo, $pageNo, $pageSize, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayDataBillSellQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayDataBillSellQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayDataBillSellQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayDataBillSellQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayDataBillSellQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayDataBillSellQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayDataBillSellQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayDataBillSellQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($startTime = null, $endTime = null, $alipayOrderNo = null, $merchantOrderNo = null, $storeNo = null, $pageNo = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($startTime, $endTime, $alipayOrderNo, $merchantOrderNo, $storeNo, $pageNo, $pageSize, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($startTime = null, $endTime = null, $alipayOrderNo = null, $merchantOrderNo = null, $storeNo = null, $pageNo = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayDataBillSellQueryResponseModel';
        $request = $this->queryRequest($startTime, $endTime, $alipayOrderNo, $merchantOrderNo, $storeNo, $pageNo, $pageSize, $customizedParams);
     ...
     */
    public function queryRequest($startTime = null, $endTime = null, $alipayOrderNo = null, $merchantOrderNo = null, $storeNo = null, $pageNo = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/data/bill/sell/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
