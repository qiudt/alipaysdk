<?php
/**
 * AlipayCommerceEducateSchoolcardOrderApi
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AlipayCommerceEducateSchoolcardOrderApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayCommerceEducateSchoolcardOrderApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 校园卡支付订单数据同步
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncModel $alipayCommerceEducateSchoolcardOrderSyncModel alipayCommerceEducateSchoolcardOrderSyncModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncDefaultResponse
     */
    public function sync($alipayCommerceEducateSchoolcardOrderSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->syncWithHttpInfo($alipayCommerceEducateSchoolcardOrderSyncModel, $customizedParams);
        return $response;
    }
     ...
     * 校园卡支付订单数据同步
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncModel $alipayCommerceEducateSchoolcardOrderSyncModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function syncWithHttpInfo($alipayCommerceEducateSchoolcardOrderSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->syncRequest($alipayCommerceEducateSchoolcardOrderSyncModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function syncAsync($alipayCommerceEducateSchoolcardOrderSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->syncAsyncWithHttpInfo($alipayCommerceEducateSchoolcardOrderSyncModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function syncAsyncWithHttpInfo($alipayCommerceEducateSchoolcardOrderSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceEducateSchoolcardOrderSyncResponseModel';
        $request = $this->syncRequest($alipayCommerceEducateSchoolcardOrderSyncModel, $customizedParams);
     ...
     */
    public function syncRequest($alipayCommerceEducateSchoolcardOrderSyncModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/commerce/educate/schoolcard/order/sync';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayCommerceEducateSchoolcardOrderSyncModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayCommerceEducateSchoolcardOrderSyncModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayCommerceEducateSchoolcardOrderSyncModel;
            }
