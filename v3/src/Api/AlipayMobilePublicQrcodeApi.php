...
/**
 * AlipayMobilePublicQrcodeApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMobilePublicQrcodeApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 生成带参数的二维码
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateModel $alipayMobilePublicQrcodeCreateModel alipayMobilePublicQrcodeCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateResponseModel|\Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateDefaultResponse
     */
    public function create($alipayMobilePublicQrcodeCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->createWithHttpInfo($alipayMobilePublicQrcodeCreateModel, $customizedParams);
        return $response;
    }
     ...
     * 生成带参数的二维码
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateModel $alipayMobilePublicQrcodeCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateResponseModel|\Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($alipayMobilePublicQrcodeCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->createRequest($alipayMobilePublicQrcodeCreateModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function createAsync($alipayMobilePublicQrcodeCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->createAsyncWithHttpInfo($alipayMobilePublicQrcodeCreateModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function createAsyncWithHttpInfo($alipayMobilePublicQrcodeCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayMobilePublicQrcodeCreateResponseModel';
        $request = $this->createRequest($alipayMobilePublicQrcodeCreateModel, $customizedParams);
     ...
     */
    public function createRequest($alipayMobilePublicQrcodeCreateModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/mobile/public/qrcode/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayMobilePublicQrcodeCreateModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayMobilePublicQrcodeCreateModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayMobilePublicQrcodeCreateModel;
            }
