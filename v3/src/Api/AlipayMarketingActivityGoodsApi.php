...
/**
 * AlipayMarketingActivityGoodsApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMarketingActivityGoodsApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $goodsUseType 活动单品类型。 (optional)
     * @param  int $pageNum 分页查询页码。 限制: 必须为大于0的整数 (optional)
     * @param  int $pageSize 分页查询单页数据条数。 限制: 1.必须为大于0的整数 2.每页最大值为20 (optional)
     * @param  string $productVersion 版本号  枚举值: 2.0.0 (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayMarketingActivityGoodsBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingActivityGoodsBatchqueryDefaultResponse
     */
    public function batchquery($activityId, $merchantId = null, $goodsUseType = null, $pageNum = null, $pageSize = null, $productVersion = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->batchqueryWithHttpInfo($activityId, $merchantId, $goodsUseType, $pageNum, $pageSize, $productVersion, $merchantAccessMode, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayMarketingActivityGoodsBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingActivityGoodsBatchqueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function batchqueryWithHttpInfo($activityId, $merchantId = null, $goodsUseType = null, $pageNum = null, $pageSize = null, $productVersion = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->batchqueryRequest($activityId, $merchantId, $goodsUseType, $pageNum, $pageSize, $productVersion, $merchantAccessMode, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityGoodsBatchqueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityGoodsBatchqueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityGoodsBatchqueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityGoodsBatchqueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityGoodsBatchqueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityGoodsBatchqueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityGoodsBatchqueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityGoodsBatchqueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function batchqueryAsync($activityId, $merchantId = null, $goodsUseType = null, $pageNum = null, $pageSize = null, $productVersion = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->batchqueryAsyncWithHttpInfo($activityId, $merchantId, $goodsUseType, $pageNum, $pageSize, $productVersion, $merchantAccessMode, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function batchqueryAsyncWithHttpInfo($activityId, $merchantId = null, $goodsUseType = null, $pageNum = null, $pageSize = null, $productVersion = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityGoodsBatchqueryResponseModel';
        $request = $this->batchqueryRequest($activityId, $merchantId, $goodsUseType, $pageNum, $pageSize, $productVersion, $merchantAccessMode, $customizedParams);
     ...
     */
    public function batchqueryRequest($activityId, $merchantId = null, $goodsUseType = null, $pageNum = null, $pageSize = null, $productVersion = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        // verify the required path parameter 'activityId' is set
        if ($activityId === null || (is_array($activityId) && count($activityId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $activityId when calling batchquery'
            );
        }

        $resourcePath = '/v3/alipay/marketing/activity/{activity_id}/goods/batchquery';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $goodsUseType,
            'goods_use_type', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $productVersion,
            'product_version', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
