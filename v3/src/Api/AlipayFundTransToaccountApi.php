...
/**
 * AlipayFundTransToaccountApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayFundTransToaccountApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 单笔转账到支付宝账户接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferModel $alipayFundTransToaccountTransferModel alipayFundTransToaccountTransferModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferDefaultResponse
     */
    public function transfer($alipayFundTransToaccountTransferModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->transferWithHttpInfo($alipayFundTransToaccountTransferModel, $customizedParams);
        return $response;
    }
     ...
     * 单笔转账到支付宝账户接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferModel $alipayFundTransToaccountTransferModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function transferWithHttpInfo($alipayFundTransToaccountTransferModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->transferRequest($alipayFundTransToaccountTransferModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function transferAsync($alipayFundTransToaccountTransferModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->transferAsyncWithHttpInfo($alipayFundTransToaccountTransferModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function transferAsyncWithHttpInfo($alipayFundTransToaccountTransferModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundTransToaccountTransferResponseModel';
        $request = $this->transferRequest($alipayFundTransToaccountTransferModel, $customizedParams);
     ...
     */
    public function transferRequest($alipayFundTransToaccountTransferModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/fund/trans/toaccount/transfer';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayFundTransToaccountTransferModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayFundTransToaccountTransferModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayFundTransToaccountTransferModel;
            }
