...
/**
 * AlipayEcoMycarParkingPaymentinfoApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEcoMycarParkingPaymentinfoApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 车辆停车缴费接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingPaymentinfoSyncModel $alipayEcoMycarParkingPaymentinfoSyncModel alipayEcoMycarParkingPaymentinfoSyncModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingPaymentinfoSyncDefaultResponse
     */
    public function sync($alipayEcoMycarParkingPaymentinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->syncWithHttpInfo($alipayEcoMycarParkingPaymentinfoSyncModel, $customizedParams);
        return $response;
    }
     ...
     * 车辆停车缴费接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingPaymentinfoSyncModel $alipayEcoMycarParkingPaymentinfoSyncModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingPaymentinfoSyncDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function syncWithHttpInfo($alipayEcoMycarParkingPaymentinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->syncRequest($alipayEcoMycarParkingPaymentinfoSyncModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingPaymentinfoSyncDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingPaymentinfoSyncDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingPaymentinfoSyncDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingPaymentinfoSyncDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function syncAsync($alipayEcoMycarParkingPaymentinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->syncAsyncWithHttpInfo($alipayEcoMycarParkingPaymentinfoSyncModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function syncAsyncWithHttpInfo($alipayEcoMycarParkingPaymentinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->syncRequest($alipayEcoMycarParkingPaymentinfoSyncModel, $customizedParams);
     ...
     */
    public function syncRequest($alipayEcoMycarParkingPaymentinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/eco/mycar/parking/paymentinfo/sync';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayEcoMycarParkingPaymentinfoSyncModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayEcoMycarParkingPaymentinfoSyncModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayEcoMycarParkingPaymentinfoSyncModel;
            }
