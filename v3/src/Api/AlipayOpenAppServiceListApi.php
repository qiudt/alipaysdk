...
/**
 * AlipayOpenAppServiceListApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenAppServiceListApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 服务批量查询
     *
     * @param  string $serviceName 服务名称 (optional)
     * @param  string $categoryId 类目 (optional)
     * @param  int $pageSize 每页记录数 (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenAppServiceListQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenAppServiceListQueryDefaultResponse
     */
    public function query($serviceName = null, $categoryId = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($serviceName, $categoryId, $pageSize, $pageNum, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenAppServiceListQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenAppServiceListQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($serviceName = null, $categoryId = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($serviceName, $categoryId, $pageSize, $pageNum, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenAppServiceListQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenAppServiceListQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenAppServiceListQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenAppServiceListQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenAppServiceListQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenAppServiceListQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenAppServiceListQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenAppServiceListQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($serviceName = null, $categoryId = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($serviceName, $categoryId, $pageSize, $pageNum, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($serviceName = null, $categoryId = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenAppServiceListQueryResponseModel';
        $request = $this->queryRequest($serviceName, $categoryId, $pageSize, $pageNum, $customizedParams);
     ...
     */
    public function queryRequest($serviceName = null, $categoryId = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/app/service/list/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
