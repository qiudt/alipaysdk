...
/**
 * ZhimaCustomerJobworthCloudresumeApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ZhimaCustomerJobworthCloudresumeApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 智能简历基本数据查询
     *
     * @param  string $connKey 长效的认证令牌：zhima.credit.payafteruse.creditagreement.sign 的out_agreement_no (optional)
     * @param  string $onceToken 交换云简历的单次token：zhima.credit.payafteruse.creditagreement.sign 的  extra_param入参onceToken（授权后5分钟内，单次有效 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthCloudresumeQueryResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthCloudresumeQueryDefaultResponse
     */
    public function query($connKey = null, $onceToken = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($connKey, $onceToken, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthCloudresumeQueryResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthCloudresumeQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($connKey = null, $onceToken = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($connKey, $onceToken, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthCloudresumeQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthCloudresumeQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthCloudresumeQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthCloudresumeQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthCloudresumeQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthCloudresumeQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthCloudresumeQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthCloudresumeQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($connKey = null, $onceToken = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($connKey, $onceToken, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($connKey = null, $onceToken = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthCloudresumeQueryResponseModel';
        $request = $this->queryRequest($connKey, $onceToken, $customizedParams);
     ...
     */
    public function queryRequest($connKey = null, $onceToken = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/zhima/customer/jobworth/cloudresume/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
