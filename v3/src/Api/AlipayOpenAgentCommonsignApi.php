...
/**
 * AlipayOpenAgentCommonsignApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenAgentCommonsignApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 代商户签约，提交信息确认接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmModel $alipayOpenAgentCommonsignConfirmModel alipayOpenAgentCommonsignConfirmModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmDefaultResponse
     */
    public function confirm($alipayOpenAgentCommonsignConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->confirmWithHttpInfo($alipayOpenAgentCommonsignConfirmModel, $customizedParams);
        return $response;
    }
     ...
     * 代商户签约，提交信息确认接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmModel $alipayOpenAgentCommonsignConfirmModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function confirmWithHttpInfo($alipayOpenAgentCommonsignConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->confirmRequest($alipayOpenAgentCommonsignConfirmModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function confirmAsync($alipayOpenAgentCommonsignConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->confirmAsyncWithHttpInfo($alipayOpenAgentCommonsignConfirmModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function confirmAsyncWithHttpInfo($alipayOpenAgentCommonsignConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenAgentCommonsignConfirmResponseModel';
        $request = $this->confirmRequest($alipayOpenAgentCommonsignConfirmModel, $customizedParams);
     ...
     */
    public function confirmRequest($alipayOpenAgentCommonsignConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/agent/commonsign/confirm';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenAgentCommonsignConfirmModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenAgentCommonsignConfirmModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenAgentCommonsignConfirmModel;
            }
