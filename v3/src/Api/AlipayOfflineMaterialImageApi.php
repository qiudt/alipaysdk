...
/**
 * AlipayOfflineMaterialImageApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOfflineMaterialImageApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 上传门店照片和视频接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOfflineMaterialImageUploadModel $data data (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayOfflineMaterialImageUploadResponseModel|\Alipay\OpenAPISDK\Model\AlipayOfflineMaterialImageUploadDefaultResponse
     */
     ...
     * 上传门店照片和视频接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOfflineMaterialImageUploadModel $data (optional)
     * @param  \SplFileObject $imageContent (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOfflineMaterialImageUploadResponseModel|\Alipay\OpenAPISDK\Model\AlipayOfflineMaterialImageUploadDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadWithHttpInfo($data = null, $imageContent = null, ?CustomizedParams $customizedParams = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOfflineMaterialImageUploadResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOfflineMaterialImageUploadResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOfflineMaterialImageUploadResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOfflineMaterialImageUploadDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOfflineMaterialImageUploadDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOfflineMaterialImageUploadDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOfflineMaterialImageUploadResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOfflineMaterialImageUploadDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
    ...
    public function uploadRequest($data = null, $imageContent = null, ?CustomizedParams $customizedParams = null)
    {
        ...
        $resourcePath = '/v3/alipay/offline/material/image/upload';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
