...
/**
 * ZhimaCustomerJobworthPositionApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ZhimaCustomerJobworthPositionApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 职得工作证岗位收集
     *
     * @param  \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddModel $zhimaCustomerJobworthPositionAddModel zhimaCustomerJobworthPositionAddModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddDefaultResponse
     */
    public function add($zhimaCustomerJobworthPositionAddModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->addWithHttpInfo($zhimaCustomerJobworthPositionAddModel, $customizedParams);
        return $response;
    }
     ...
     * 职得工作证岗位收集
     *
     * @param  \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddModel $zhimaCustomerJobworthPositionAddModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function addWithHttpInfo($zhimaCustomerJobworthPositionAddModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->addRequest($zhimaCustomerJobworthPositionAddModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function addAsync($zhimaCustomerJobworthPositionAddModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->addAsyncWithHttpInfo($zhimaCustomerJobworthPositionAddModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function addAsyncWithHttpInfo($zhimaCustomerJobworthPositionAddModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthPositionAddResponseModel';
        $request = $this->addRequest($zhimaCustomerJobworthPositionAddModel, $customizedParams);
     ...
     */
    public function addRequest($zhimaCustomerJobworthPositionAddModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/zhima/customer/jobworth/position/add';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($zhimaCustomerJobworthPositionAddModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($zhimaCustomerJobworthPositionAddModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $zhimaCustomerJobworthPositionAddModel;
            }
