...
/**
 * AlipayOpenMiniBaseinfoNameApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniBaseinfoNameApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 小程序名称检测
     *
     * @param  string $appName 小程序名字，长度限制 3~30 个字符，仅支持包含简体中文、数字、英文、下划线、+、-。 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoNameCheckResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoNameCheckDefaultResponse
     */
    public function check($appName = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->checkWithHttpInfo($appName, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoNameCheckResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoNameCheckDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function checkWithHttpInfo($appName = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->checkRequest($appName, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoNameCheckResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoNameCheckResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoNameCheckResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoNameCheckDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoNameCheckDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoNameCheckDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoNameCheckResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoNameCheckDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function checkAsync($appName = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->checkAsyncWithHttpInfo($appName, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function checkAsyncWithHttpInfo($appName = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniBaseinfoNameCheckResponseModel';
        $request = $this->checkRequest($appName, $customizedParams);
     ...
     */
    public function checkRequest($appName = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/baseinfo/name/check';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
