...
/**
 * ZhimaCreditPeZmgoCumulationApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ZhimaCreditPeZmgoCumulationApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 芝麻go用户数据回传
     *
     * @param  \Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncModel $zhimaCreditPeZmgoCumulationSyncModel zhimaCreditPeZmgoCumulationSyncModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncDefaultResponse
     */
    public function sync($zhimaCreditPeZmgoCumulationSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->syncWithHttpInfo($zhimaCreditPeZmgoCumulationSyncModel, $customizedParams);
        return $response;
    }
     ...
     * 芝麻go用户数据回传
     *
     * @param  \Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncModel $zhimaCreditPeZmgoCumulationSyncModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function syncWithHttpInfo($zhimaCreditPeZmgoCumulationSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->syncRequest($zhimaCreditPeZmgoCumulationSyncModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function syncAsync($zhimaCreditPeZmgoCumulationSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->syncAsyncWithHttpInfo($zhimaCreditPeZmgoCumulationSyncModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function syncAsyncWithHttpInfo($zhimaCreditPeZmgoCumulationSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoCumulationSyncResponseModel';
        $request = $this->syncRequest($zhimaCreditPeZmgoCumulationSyncModel, $customizedParams);
     ...
     */
    public function syncRequest($zhimaCreditPeZmgoCumulationSyncModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/zhima/credit/pe/zmgo/cumulation/sync';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($zhimaCreditPeZmgoCumulationSyncModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($zhimaCreditPeZmgoCumulationSyncModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $zhimaCreditPeZmgoCumulationSyncModel;
            }
