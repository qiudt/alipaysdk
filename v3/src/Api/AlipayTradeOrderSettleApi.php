...
/**
 * AlipayTradeOrderSettleApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayTradeOrderSettleApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 交易分账查询接口
     *
     * @param  string $settleNo 支付宝分账请求单号，传入该字段，无需再传外部请求号和支付宝交易号 (optional)
     * @param  string $outRequestNo 调用分账接口时指定的外部请求号。分账查询时需要和支付宝交易号一起传入 (optional)
     * @param  string $tradeNo 支付宝交易号，传入该字段，需要和外部请求号一起传入 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayTradeOrderSettleQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayTradeOrderSettleQueryDefaultResponse
     */
    public function query($settleNo = null, $outRequestNo = null, $tradeNo = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($settleNo, $outRequestNo, $tradeNo, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayTradeOrderSettleQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayTradeOrderSettleQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($settleNo = null, $outRequestNo = null, $tradeNo = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($settleNo, $outRequestNo, $tradeNo, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayTradeOrderSettleQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayTradeOrderSettleQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayTradeOrderSettleQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayTradeOrderSettleQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayTradeOrderSettleQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayTradeOrderSettleQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayTradeOrderSettleQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayTradeOrderSettleQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($settleNo = null, $outRequestNo = null, $tradeNo = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($settleNo, $outRequestNo, $tradeNo, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($settleNo = null, $outRequestNo = null, $tradeNo = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayTradeOrderSettleQueryResponseModel';
        $request = $this->queryRequest($settleNo, $outRequestNo, $tradeNo, $customizedParams);
     ...
     */
    public function queryRequest($settleNo = null, $outRequestNo = null, $tradeNo = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/trade/order/settle/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
