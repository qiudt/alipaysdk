...
/**
 * ZhimaCustomerJobworthAuthenticationApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ZhimaCustomerJobworthAuthenticationApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 职得身份认证查询接口
     *
     * @param  string $connKey 调用第一步创建接口的out_agreement_no，由外部传入 (optional)
     * @param  string $onceToken 查询身份认证结果的凭证，在认证结果到达终态后只允许查询成功一次，若需要再次查询，则需要调用第一个接口再拉起受理台 (optional)
     * @param  string $queryType exact:精确查询,dim:模糊查询 (optional)
     * @param  string $identityType 04:教师，其它身份类型联系芝麻技术支持确认 (optional)
     * @param  string $serviceId 信用服务id，商家接入产品功能包时有运营同学分配 (optional)
     * @param  string $userId 蚂蚁统一会员ID 和身份证任选一个传入 (optional)
     * @param  string $openId 蚂蚁统一会员ID 和身份证任选一个传入 (optional)
     * @param  string $certNo 证件号 (optional)
     * @param  string $certType \&quot;身份证 : 0\&quot;，\&quot;护照: 1\&quot;，\&quot;台湾往来通行证：4\&quot;,\&quot;港澳往来通行证：3\&quot;, \&quot;回乡证: 2\&quot;；\&quot;港澳证件：5\&quot; (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthAuthenticationQueryResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthAuthenticationQueryDefaultResponse
     */
    public function query($connKey = null, $onceToken = null, $queryType = null, $identityType = null, $serviceId = null, $userId = null, $openId = null, $certNo = null, $certType = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($connKey, $onceToken, $queryType, $identityType, $serviceId, $userId, $openId, $certNo, $certType, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthAuthenticationQueryResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthAuthenticationQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($connKey = null, $onceToken = null, $queryType = null, $identityType = null, $serviceId = null, $userId = null, $openId = null, $certNo = null, $certType = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($connKey, $onceToken, $queryType, $identityType, $serviceId, $userId, $openId, $certNo, $certType, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthAuthenticationQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthAuthenticationQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthAuthenticationQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthAuthenticationQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthAuthenticationQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthAuthenticationQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthAuthenticationQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthAuthenticationQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($connKey = null, $onceToken = null, $queryType = null, $identityType = null, $serviceId = null, $userId = null, $openId = null, $certNo = null, $certType = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($connKey, $onceToken, $queryType, $identityType, $serviceId, $userId, $openId, $certNo, $certType, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($connKey = null, $onceToken = null, $queryType = null, $identityType = null, $serviceId = null, $userId = null, $openId = null, $certNo = null, $certType = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCustomerJobworthAuthenticationQueryResponseModel';
        $request = $this->queryRequest($connKey, $onceToken, $queryType, $identityType, $serviceId, $userId, $openId, $certNo, $certType, $customizedParams);
     ...
     */
    public function queryRequest($connKey = null, $onceToken = null, $queryType = null, $identityType = null, $serviceId = null, $userId = null, $openId = null, $certNo = null, $certType = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/zhima/customer/jobworth/authentication';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
