...
/**
 * AlipayOpenFeeAdjustApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayOpenFeeAdjustApi
{
     ...
     * @param  \SplFileObject $certPic certPic (optional)
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenFeeAdjustApplyModel $data data (optional)
     * @param  \SplFileObject $shopScenePic shopScenePic (optional)
     * @param  \SplFileObject $shopSignPic shopSignPic (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenFeeAdjustApplyDefaultResponse
     */
    public function apply($attachment = null, $certPic = null, $data = null, $shopScenePic = null, $shopSignPic = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->applyWithHttpInfo($attachment, $certPic, $data, $shopScenePic, $shopSignPic, $customizedParams);
        return $response;
    }
     ...
     * @param  \SplFileObject $certPic (optional)
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenFeeAdjustApplyModel $data (optional)
     * @param  \SplFileObject $shopScenePic (optional)
     * @param  \SplFileObject $shopSignPic (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenFeeAdjustApplyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function applyWithHttpInfo($attachment = null, $certPic = null, $data = null, $shopScenePic = null, $shopSignPic = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->applyRequest($attachment, $certPic, $data, $shopScenePic, $shopSignPic, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenFeeAdjustApplyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenFeeAdjustApplyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenFeeAdjustApplyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenFeeAdjustApplyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function applyAsync($attachment = null, $certPic = null, $data = null, $shopScenePic = null, $shopSignPic = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->applyAsyncWithHttpInfo($attachment, $certPic, $data, $shopScenePic, $shopSignPic, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function applyAsyncWithHttpInfo($attachment = null, $certPic = null, $data = null, $shopScenePic = null, $shopSignPic = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->applyRequest($attachment, $certPic, $data, $shopScenePic, $shopSignPic, $customizedParams);
     ...
     */
    public function applyRequest($attachment = null, $certPic = null, $data = null, $shopScenePic = null, $shopSignPic = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/fee/adjust/apply';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($certPic !== null) {
            $multipart = true;
            $formParams['cert_pic'] = [];
            $paramFiles = is_array($certPic) ? $certPic : [$certPic];
            foreach ($paramFiles as $paramFile) {
                $formParams['cert_pic'][] = \GuzzleHttp\Psr7\Utils::tryFopen(
                    ObjectSerializer::toFormValue($paramFile),
                    'rb'
                );
            }
        ...
        if ($shopSignPic !== null) {
            $multipart = true;
            $formParams['shop_sign_pic'] = [];
            $paramFiles = is_array($shopSignPic) ? $shopSignPic : [$shopSignPic];
            foreach ($paramFiles as $paramFile) {
                $formParams['shop_sign_pic'][] = \GuzzleHttp\Psr7\Utils::tryFopen(
                    ObjectSerializer::toFormValue($paramFile),
                    'rb'
                );
            }
