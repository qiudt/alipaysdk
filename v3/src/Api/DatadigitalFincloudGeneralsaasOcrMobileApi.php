...
/**
 * DatadigitalFincloudGeneralsaasOcrMobileApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DatadigitalFincloudGeneralsaasOcrMobileApi
{
    /**
     * @var ClientInterface
     */
     ...
     * App端OCR初始化
     *
     * @param  \Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeModel $datadigitalFincloudGeneralsaasOcrMobileInitializeModel datadigitalFincloudGeneralsaasOcrMobileInitializeModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeResponseModel|\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeDefaultResponse
     */
    public function initialize($datadigitalFincloudGeneralsaasOcrMobileInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->initializeWithHttpInfo($datadigitalFincloudGeneralsaasOcrMobileInitializeModel, $customizedParams);
        return $response;
    }
     ...
     * App端OCR初始化
     *
     * @param  \Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeModel $datadigitalFincloudGeneralsaasOcrMobileInitializeModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeResponseModel|\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function initializeWithHttpInfo($datadigitalFincloudGeneralsaasOcrMobileInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->initializeRequest($datadigitalFincloudGeneralsaasOcrMobileInitializeModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function initializeAsync($datadigitalFincloudGeneralsaasOcrMobileInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->initializeAsyncWithHttpInfo($datadigitalFincloudGeneralsaasOcrMobileInitializeModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function initializeAsyncWithHttpInfo($datadigitalFincloudGeneralsaasOcrMobileInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasOcrMobileInitializeResponseModel';
        $request = $this->initializeRequest($datadigitalFincloudGeneralsaasOcrMobileInitializeModel, $customizedParams);
     ...
     */
    public function initializeRequest($datadigitalFincloudGeneralsaasOcrMobileInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/datadigital/fincloud/generalsaas/ocr/mobile/initialize';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($datadigitalFincloudGeneralsaasOcrMobileInitializeModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($datadigitalFincloudGeneralsaasOcrMobileInitializeModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $datadigitalFincloudGeneralsaasOcrMobileInitializeModel;
            }
