...
/**
 * AlipayCommerceEcEmployeeInviteApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayCommerceEcEmployeeInviteApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $employeeId 企业码员工ID，签约适用对象为指定员工时填写 (optional)
     * @param  string $pageContentCode 用于展示不同的页面文案，使用标准页面文案是无需传值 (optional)
     * @param  string $withholdingSignStr 代扣签约串。需要签约代扣协议时，必传，返回的签约链接会拼接上代扣签约串。 (optional)
     * @param  string $createShareCode 是否生成签约吱口令，不传默认为N (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeInviteQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeInviteQueryDefaultResponse
     */
    public function query($enterpriseId = null, $employeeId = null, $pageContentCode = null, $withholdingSignStr = null, $createShareCode = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($enterpriseId, $employeeId, $pageContentCode, $withholdingSignStr, $createShareCode, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeInviteQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeInviteQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($enterpriseId = null, $employeeId = null, $pageContentCode = null, $withholdingSignStr = null, $createShareCode = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($enterpriseId, $employeeId, $pageContentCode, $withholdingSignStr, $createShareCode, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeInviteQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeInviteQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeInviteQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeInviteQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeInviteQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeInviteQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeInviteQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeInviteQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($enterpriseId = null, $employeeId = null, $pageContentCode = null, $withholdingSignStr = null, $createShareCode = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($enterpriseId, $employeeId, $pageContentCode, $withholdingSignStr, $createShareCode, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($enterpriseId = null, $employeeId = null, $pageContentCode = null, $withholdingSignStr = null, $createShareCode = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeInviteQueryResponseModel';
        $request = $this->queryRequest($enterpriseId, $employeeId, $pageContentCode, $withholdingSignStr, $createShareCode, $customizedParams);
     ...
     */
    public function queryRequest($enterpriseId = null, $employeeId = null, $pageContentCode = null, $withholdingSignStr = null, $createShareCode = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/commerce/ec/employee/invite';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $pageContentCode,
            'page_content_code', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $withholdingSignStr,
            'withholding_sign_str', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $createShareCode,
            'create_share_code', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
