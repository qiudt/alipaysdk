...
/**
 * AlipayEcoSignflowsUrlApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEcoSignflowsUrlApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $thirdPartyUserId 创建流程时指定个人唯一标识 (optional)
     * @param  string $orgThirdPartyUserId 创建流程时指定企业唯一标识 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEcoSignflowsUrlQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayEcoSignflowsUrlQueryDefaultResponse
     */
    public function query($targetAppId = null, $flowId = null, $thirdPartyUserId = null, $orgThirdPartyUserId = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($targetAppId, $flowId, $thirdPartyUserId, $orgThirdPartyUserId, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEcoSignflowsUrlQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayEcoSignflowsUrlQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($targetAppId = null, $flowId = null, $thirdPartyUserId = null, $orgThirdPartyUserId = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($targetAppId, $flowId, $thirdPartyUserId, $orgThirdPartyUserId, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEcoSignflowsUrlQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEcoSignflowsUrlQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEcoSignflowsUrlQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEcoSignflowsUrlQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEcoSignflowsUrlQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEcoSignflowsUrlQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEcoSignflowsUrlQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEcoSignflowsUrlQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($targetAppId = null, $flowId = null, $thirdPartyUserId = null, $orgThirdPartyUserId = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($targetAppId, $flowId, $thirdPartyUserId, $orgThirdPartyUserId, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($targetAppId = null, $flowId = null, $thirdPartyUserId = null, $orgThirdPartyUserId = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEcoSignflowsUrlQueryResponseModel';
        $request = $this->queryRequest($targetAppId, $flowId, $thirdPartyUserId, $orgThirdPartyUserId, $customizedParams);
     ...
     */
    public function queryRequest($targetAppId = null, $flowId = null, $thirdPartyUserId = null, $orgThirdPartyUserId = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/eco/signflows/url/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $thirdPartyUserId,
            'third_party_user_id', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $orgThirdPartyUserId,
            'org_third_party_user_id', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
