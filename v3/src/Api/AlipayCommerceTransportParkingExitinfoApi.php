...
/**
 * AlipayCommerceTransportParkingExitinfoApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayCommerceTransportParkingExitinfoApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 停车离场消息模板配置
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncModel $alipayCommerceTransportParkingExitinfoSyncModel alipayCommerceTransportParkingExitinfoSyncModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncDefaultResponse
     */
    public function sync($alipayCommerceTransportParkingExitinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->syncWithHttpInfo($alipayCommerceTransportParkingExitinfoSyncModel, $customizedParams);
        return $response;
    }
     ...
     * 停车离场消息模板配置
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncModel $alipayCommerceTransportParkingExitinfoSyncModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function syncWithHttpInfo($alipayCommerceTransportParkingExitinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->syncRequest($alipayCommerceTransportParkingExitinfoSyncModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function syncAsync($alipayCommerceTransportParkingExitinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->syncAsyncWithHttpInfo($alipayCommerceTransportParkingExitinfoSyncModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function syncAsyncWithHttpInfo($alipayCommerceTransportParkingExitinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceTransportParkingExitinfoSyncResponseModel';
        $request = $this->syncRequest($alipayCommerceTransportParkingExitinfoSyncModel, $customizedParams);
     ...
     */
    public function syncRequest($alipayCommerceTransportParkingExitinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/commerce/transport/parking/exitinfo/sync';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayCommerceTransportParkingExitinfoSyncModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayCommerceTransportParkingExitinfoSyncModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayCommerceTransportParkingExitinfoSyncModel;
            }
