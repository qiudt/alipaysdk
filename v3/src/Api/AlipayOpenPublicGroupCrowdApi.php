...
/**
 * AlipayOpenPublicGroupCrowdApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenPublicGroupCrowdApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 人群数量查询
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryModel $alipayOpenPublicGroupCrowdQueryModel alipayOpenPublicGroupCrowdQueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryDefaultResponse
     */
    public function query($alipayOpenPublicGroupCrowdQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($alipayOpenPublicGroupCrowdQueryModel, $customizedParams);
        return $response;
    }
     ...
     * 人群数量查询
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryModel $alipayOpenPublicGroupCrowdQueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($alipayOpenPublicGroupCrowdQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($alipayOpenPublicGroupCrowdQueryModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($alipayOpenPublicGroupCrowdQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($alipayOpenPublicGroupCrowdQueryModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($alipayOpenPublicGroupCrowdQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenPublicGroupCrowdQueryResponseModel';
        $request = $this->queryRequest($alipayOpenPublicGroupCrowdQueryModel, $customizedParams);
     ...
     */
    public function queryRequest($alipayOpenPublicGroupCrowdQueryModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/public/group/crowd/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenPublicGroupCrowdQueryModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenPublicGroupCrowdQueryModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenPublicGroupCrowdQueryModel;
            }
