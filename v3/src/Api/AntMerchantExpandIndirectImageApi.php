...
/**
 * AntMerchantExpandIndirectImageApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AntMerchantExpandIndirectImageApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 图片上传
     *
     * @param  \Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadModel $data data (optional)
     * @param  \SplFileObject $imageContent imageContent (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadResponseModel|\Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadDefaultResponse
     */
    public function upload($data = null, $imageContent = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->uploadWithHttpInfo($data, $imageContent, $customizedParams);
        return $response;
    }
     ...
     * 图片上传
     *
     * @param  \Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadModel $data (optional)
     * @param  \SplFileObject $imageContent (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadResponseModel|\Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadWithHttpInfo($data = null, $imageContent = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->uploadRequest($data, $imageContent, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function uploadAsync($data = null, $imageContent = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->uploadAsyncWithHttpInfo($data, $imageContent, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function uploadAsyncWithHttpInfo($data = null, $imageContent = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AntMerchantExpandIndirectImageUploadResponseModel';
        $request = $this->uploadRequest($data, $imageContent, $customizedParams);
     ...
     */
    public function uploadRequest($data = null, $imageContent = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/ant/merchant/indirect/image';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($imageContent !== null) {
            $multipart = true;
            $formParams['image_content'] = [];
            $paramFiles = is_array($imageContent) ? $imageContent : [$imageContent];
            foreach ($paramFiles as $paramFile) {
                $formParams['image_content'][] = \GuzzleHttp\Psr7\Utils::tryFopen(
