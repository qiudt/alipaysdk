...
/**
 * AlipayTradeApplepayAuthenticationApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayTradeApplepayAuthenticationApi
{
    /**
     * @var ClientInterface
     */
     ...
     * ApplePay支付鉴权提交
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitModel $alipayTradeApplepayAuthenticationSubmitModel alipayTradeApplepayAuthenticationSubmitModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitResponseModel|\Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitDefaultResponse
     */
    public function submit($alipayTradeApplepayAuthenticationSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->submitWithHttpInfo($alipayTradeApplepayAuthenticationSubmitModel, $customizedParams);
        return $response;
    }
     ...
     * ApplePay支付鉴权提交
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitModel $alipayTradeApplepayAuthenticationSubmitModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitResponseModel|\Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitWithHttpInfo($alipayTradeApplepayAuthenticationSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->submitRequest($alipayTradeApplepayAuthenticationSubmitModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function submitAsync($alipayTradeApplepayAuthenticationSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->submitAsyncWithHttpInfo($alipayTradeApplepayAuthenticationSubmitModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function submitAsyncWithHttpInfo($alipayTradeApplepayAuthenticationSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayTradeApplepayAuthenticationSubmitResponseModel';
        $request = $this->submitRequest($alipayTradeApplepayAuthenticationSubmitModel, $customizedParams);
     ...
     */
    public function submitRequest($alipayTradeApplepayAuthenticationSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/trade/applepay/authentication/submit';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayTradeApplepayAuthenticationSubmitModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayTradeApplepayAuthenticationSubmitModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayTradeApplepayAuthenticationSubmitModel;
            }
