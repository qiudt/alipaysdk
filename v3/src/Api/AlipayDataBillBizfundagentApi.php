...
/**
 * AlipayDataBillBizfundagentApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayDataBillBizfundagentApi
{
    /**
     * @var ClientInterface
     */
     ...
     * ISV代理商户资金业务账单查询
     *
     * @param  string $startTime 账单查询时间范围 -- 起始时间 (optional)
     * @param  string $endTime 账单查询时间范围 -- 结束范围。时间范围最大不超过31天。 (optional)
     * @param  string $pageNo 页码，从1开始 (optional)
     * @param  string $pageSize 分页大小1000-2000，默认2000 (optional)
     * @param  string $agreementType 根据不同业务协议类型，传入不同参数。传入协议产品码（personal_product_code，通过协议查询接口、协议签约通知响应参数获取），不填的话默认按照示例值传入。 安全发协议：FUND_SAFT_SIGN_WITHHOLDING_P 专用金协议：FLEXIBLE_EMPLOYMENT_SERVICE_P (optional)
     * @param  string $agreementNo ISV与商户授权协议号 (optional)
     * @param  string $accountBookId 记账本id，服务商在帮助商户开通时候获取的唯一身份号 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayDataBillBizfundagentQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayDataBillBizfundagentQueryDefaultResponse
     */
    public function query($startTime = null, $endTime = null, $pageNo = null, $pageSize = null, $agreementType = null, $agreementNo = null, $accountBookId = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($startTime, $endTime, $pageNo, $pageSize, $agreementType, $agreementNo, $accountBookId, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayDataBillBizfundagentQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayDataBillBizfundagentQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($startTime = null, $endTime = null, $pageNo = null, $pageSize = null, $agreementType = null, $agreementNo = null, $accountBookId = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($startTime, $endTime, $pageNo, $pageSize, $agreementType, $agreementNo, $accountBookId, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBizfundagentQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBizfundagentQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayDataBillBizfundagentQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBizfundagentQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBizfundagentQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayDataBillBizfundagentQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayDataBillBizfundagentQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayDataBillBizfundagentQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($startTime = null, $endTime = null, $pageNo = null, $pageSize = null, $agreementType = null, $agreementNo = null, $accountBookId = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($startTime, $endTime, $pageNo, $pageSize, $agreementType, $agreementNo, $accountBookId, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($startTime = null, $endTime = null, $pageNo = null, $pageSize = null, $agreementType = null, $agreementNo = null, $accountBookId = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayDataBillBizfundagentQueryResponseModel';
        $request = $this->queryRequest($startTime, $endTime, $pageNo, $pageSize, $agreementType, $agreementNo, $accountBookId, $customizedParams);
     ...
     */
    public function queryRequest($startTime = null, $endTime = null, $pageNo = null, $pageSize = null, $agreementType = null, $agreementNo = null, $accountBookId = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/data/bill/bizfundagent/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
