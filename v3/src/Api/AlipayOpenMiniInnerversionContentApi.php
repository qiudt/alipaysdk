...
/**
 * AlipayOpenMiniInnerversionContentApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerversionContentApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 内部链路回滚版本
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionContentRollbackModel $alipayOpenMiniInnerversionContentRollbackModel alipayOpenMiniInnerversionContentRollbackModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionContentRollbackDefaultResponse
     */
    public function rollback($alipayOpenMiniInnerversionContentRollbackModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->rollbackWithHttpInfo($alipayOpenMiniInnerversionContentRollbackModel, $customizedParams);
        return $response;
    }
     ...
     * 内部链路回滚版本
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionContentRollbackModel $alipayOpenMiniInnerversionContentRollbackModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionContentRollbackDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function rollbackWithHttpInfo($alipayOpenMiniInnerversionContentRollbackModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->rollbackRequest($alipayOpenMiniInnerversionContentRollbackModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionContentRollbackDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionContentRollbackDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionContentRollbackDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionContentRollbackDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function rollbackAsync($alipayOpenMiniInnerversionContentRollbackModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->rollbackAsyncWithHttpInfo($alipayOpenMiniInnerversionContentRollbackModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function rollbackAsyncWithHttpInfo($alipayOpenMiniInnerversionContentRollbackModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->rollbackRequest($alipayOpenMiniInnerversionContentRollbackModel, $customizedParams);
     ...
     */
    public function rollbackRequest($alipayOpenMiniInnerversionContentRollbackModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerversion/content/rollback';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniInnerversionContentRollbackModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniInnerversionContentRollbackModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniInnerversionContentRollbackModel;
            }
