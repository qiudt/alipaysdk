...
/**
 * MonitorHeartbeatApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class MonitorHeartbeatApi
{
     ...
     * 验签接口
     *
     * @param  \Alipay\OpenAPISDK\Model\MonitorHeartbeatSynModel $monitorHeartbeatSynModel monitorHeartbeatSynModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\MonitorHeartbeatSynResponseModel|\Alipay\OpenAPISDK\Model\MonitorHeartbeatSynDefaultResponse
     */
    public function syn($monitorHeartbeatSynModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->synWithHttpInfo($monitorHeartbeatSynModel, $customizedParams);
        return $response;
    }

    /**
     * Operation synWithHttpInfo
     *
     * 验签接口
     *
     * @param  \Alipay\OpenAPISDK\Model\MonitorHeartbeatSynModel $monitorHeartbeatSynModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\MonitorHeartbeatSynResponseModel|\Alipay\OpenAPISDK\Model\MonitorHeartbeatSynDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function synWithHttpInfo($monitorHeartbeatSynModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->synRequest($monitorHeartbeatSynModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\MonitorHeartbeatSynResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\MonitorHeartbeatSynResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\MonitorHeartbeatSynResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\MonitorHeartbeatSynDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\MonitorHeartbeatSynDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\MonitorHeartbeatSynDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\MonitorHeartbeatSynResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\MonitorHeartbeatSynDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function synAsync($monitorHeartbeatSynModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->synAsyncWithHttpInfo($monitorHeartbeatSynModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation synAsyncWithHttpInfo
     *
     * 验签接口
     *
     * @param  \Alipay\OpenAPISDK\Model\MonitorHeartbeatSynModel $monitorHeartbeatSynModel (optional)
     ...
     * @deprecated
     */
    public function synAsyncWithHttpInfo($monitorHeartbeatSynModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\MonitorHeartbeatSynResponseModel';
        $request = $this->synRequest($monitorHeartbeatSynModel, $customizedParams);
    ...
    /**
     * Create request for operation 'syn'
     *
     * @param  \Alipay\OpenAPISDK\Model\MonitorHeartbeatSynModel $monitorHeartbeatSynModel (optional)
     * @param CustomizedParams $customizedParams
     *
     ...
     */
    public function synRequest($monitorHeartbeatSynModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/monitor/heartbeat/syn';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($monitorHeartbeatSynModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($monitorHeartbeatSynModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $monitorHeartbeatSynModel;
            }
