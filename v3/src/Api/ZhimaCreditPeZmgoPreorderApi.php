...
/**
 * ZhimaCreditPeZmgoPreorderApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ZhimaCreditPeZmgoPreorderApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 芝麻GO签约预创单
     *
     * @param  \Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateModel $zhimaCreditPeZmgoPreorderCreateModel zhimaCreditPeZmgoPreorderCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateDefaultResponse
     */
    public function create($zhimaCreditPeZmgoPreorderCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->createWithHttpInfo($zhimaCreditPeZmgoPreorderCreateModel, $customizedParams);
        return $response;
    }
     ...
     * 芝麻GO签约预创单
     *
     * @param  \Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateModel $zhimaCreditPeZmgoPreorderCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateResponseModel|\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($zhimaCreditPeZmgoPreorderCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->createRequest($zhimaCreditPeZmgoPreorderCreateModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function createAsync($zhimaCreditPeZmgoPreorderCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->createAsyncWithHttpInfo($zhimaCreditPeZmgoPreorderCreateModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function createAsyncWithHttpInfo($zhimaCreditPeZmgoPreorderCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\ZhimaCreditPeZmgoPreorderCreateResponseModel';
        $request = $this->createRequest($zhimaCreditPeZmgoPreorderCreateModel, $customizedParams);
     ...
     */
    public function createRequest($zhimaCreditPeZmgoPreorderCreateModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/zhima/credit/pe/zmgo/preorder/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($zhimaCreditPeZmgoPreorderCreateModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($zhimaCreditPeZmgoPreorderCreateModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $zhimaCreditPeZmgoPreorderCreateModel;
            }
