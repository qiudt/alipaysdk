...
/**
 * ZolozAuthenticationCustomerFtokenApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ZolozAuthenticationCustomerFtokenApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 查询刷脸结果信息接口
     *
     * @param  \Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryModel $zolozAuthenticationCustomerFtokenQueryModel zolozAuthenticationCustomerFtokenQueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryResponseModel|\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryDefaultResponse
     */
    public function query($zolozAuthenticationCustomerFtokenQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($zolozAuthenticationCustomerFtokenQueryModel, $customizedParams);
        return $response;
    }
     ...
     * 查询刷脸结果信息接口
     *
     * @param  \Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryModel $zolozAuthenticationCustomerFtokenQueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryResponseModel|\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($zolozAuthenticationCustomerFtokenQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($zolozAuthenticationCustomerFtokenQueryModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($zolozAuthenticationCustomerFtokenQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($zolozAuthenticationCustomerFtokenQueryModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($zolozAuthenticationCustomerFtokenQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\ZolozAuthenticationCustomerFtokenQueryResponseModel';
        $request = $this->queryRequest($zolozAuthenticationCustomerFtokenQueryModel, $customizedParams);
     ...
     */
    public function queryRequest($zolozAuthenticationCustomerFtokenQueryModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/zoloz/authentication/customer/ftoken/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($zolozAuthenticationCustomerFtokenQueryModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($zolozAuthenticationCustomerFtokenQueryModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $zolozAuthenticationCustomerFtokenQueryModel;
            }
