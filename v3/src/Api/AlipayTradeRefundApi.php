...
/**
 * AlipayTradeRefundApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayTradeRefundApi
{
     ...
     * 异步退款受理接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyModel $alipayTradeRefundApplyModel alipayTradeRefundApplyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyResponseModel|\Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyDefaultResponse
     */
    public function apply($alipayTradeRefundApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->applyWithHttpInfo($alipayTradeRefundApplyModel, $customizedParams);
        return $response;
    }
     ...
     * 异步退款受理接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyModel $alipayTradeRefundApplyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyResponseModel|\Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function applyWithHttpInfo($alipayTradeRefundApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->applyRequest($alipayTradeRefundApplyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function applyAsync($alipayTradeRefundApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->applyAsyncWithHttpInfo($alipayTradeRefundApplyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function applyAsyncWithHttpInfo($alipayTradeRefundApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayTradeRefundApplyResponseModel';
        $request = $this->applyRequest($alipayTradeRefundApplyModel, $customizedParams);
     ...
     */
    public function applyRequest($alipayTradeRefundApplyModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/trade/refund/apply';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayTradeRefundApplyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayTradeRefundApplyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayTradeRefundApplyModel;
            }
