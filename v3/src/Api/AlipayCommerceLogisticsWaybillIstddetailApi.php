...
/**
 * AlipayCommerceLogisticsWaybillIstddetailApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayCommerceLogisticsWaybillIstddetailApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 查询即时配送运单详情
     *
     * @param  string $shopNo 商家门店编号 (optional)
     * @param  string $outOrderNo 商家订单号 (optional)
     * @param  string $orderNo 支付宝订单流水号 (optional)
     * @param  string $logisticsCode 即时配送公司编码 (optional)
     * @param  string $waybillNo 即时配送运单编号 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsWaybillIstddetailQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsWaybillIstddetailQueryDefaultResponse
     */
    public function query($shopNo = null, $outOrderNo = null, $orderNo = null, $logisticsCode = null, $waybillNo = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($shopNo, $outOrderNo, $orderNo, $logisticsCode, $waybillNo, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsWaybillIstddetailQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsWaybillIstddetailQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($shopNo = null, $outOrderNo = null, $orderNo = null, $logisticsCode = null, $waybillNo = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($shopNo, $outOrderNo, $orderNo, $logisticsCode, $waybillNo, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsWaybillIstddetailQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsWaybillIstddetailQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsWaybillIstddetailQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsWaybillIstddetailQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsWaybillIstddetailQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsWaybillIstddetailQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsWaybillIstddetailQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsWaybillIstddetailQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($shopNo = null, $outOrderNo = null, $orderNo = null, $logisticsCode = null, $waybillNo = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($shopNo, $outOrderNo, $orderNo, $logisticsCode, $waybillNo, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($shopNo = null, $outOrderNo = null, $orderNo = null, $logisticsCode = null, $waybillNo = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsWaybillIstddetailQueryResponseModel';
        $request = $this->queryRequest($shopNo, $outOrderNo, $orderNo, $logisticsCode, $waybillNo, $customizedParams);
     ...
     */
    public function queryRequest($shopNo = null, $outOrderNo = null, $orderNo = null, $logisticsCode = null, $waybillNo = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/commerce/logistics/waybill/istddetail/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
