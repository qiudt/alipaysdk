...
/**
 * AntMerchantExpandShopReceiptaccountApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AntMerchantExpandShopReceiptaccountApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 店铺增加收单账号
     *
     * @param  \Alipay\OpenAPISDK\Model\AntMerchantExpandShopReceiptaccountSaveModel $antMerchantExpandShopReceiptaccountSaveModel antMerchantExpandShopReceiptaccountSaveModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AntMerchantExpandShopReceiptaccountSaveDefaultResponse
     */
    public function save($antMerchantExpandShopReceiptaccountSaveModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->saveWithHttpInfo($antMerchantExpandShopReceiptaccountSaveModel, $customizedParams);
        return $response;
    }
     ...
     * 店铺增加收单账号
     *
     * @param  \Alipay\OpenAPISDK\Model\AntMerchantExpandShopReceiptaccountSaveModel $antMerchantExpandShopReceiptaccountSaveModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AntMerchantExpandShopReceiptaccountSaveDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function saveWithHttpInfo($antMerchantExpandShopReceiptaccountSaveModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->saveRequest($antMerchantExpandShopReceiptaccountSaveModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AntMerchantExpandShopReceiptaccountSaveDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AntMerchantExpandShopReceiptaccountSaveDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AntMerchantExpandShopReceiptaccountSaveDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AntMerchantExpandShopReceiptaccountSaveDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function saveAsync($antMerchantExpandShopReceiptaccountSaveModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->saveAsyncWithHttpInfo($antMerchantExpandShopReceiptaccountSaveModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function saveAsyncWithHttpInfo($antMerchantExpandShopReceiptaccountSaveModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->saveRequest($antMerchantExpandShopReceiptaccountSaveModel, $customizedParams);
     ...
     */
    public function saveRequest($antMerchantExpandShopReceiptaccountSaveModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/ant/merchant/expand/shop/receiptaccount/save';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($antMerchantExpandShopReceiptaccountSaveModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($antMerchantExpandShopReceiptaccountSaveModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $antMerchantExpandShopReceiptaccountSaveModel;
            }
