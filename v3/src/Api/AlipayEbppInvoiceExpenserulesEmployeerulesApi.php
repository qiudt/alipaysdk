...
/**
 * AlipayEbppInvoiceExpenserulesEmployeerulesApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEbppInvoiceExpenserulesEmployeerulesApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $employeeId 未切换open_id时使用此字段：员工ID (optional)
     * @param  string $employeeOpenId 切换open_id后使用此字段：员工的open_id (optional)
     * @param  int $pageNum 页码，默认值为1 (optional)
     * @param  int $pageSize 每页行数，默认值为20 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesEmployeerulesQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesEmployeerulesQueryDefaultResponse
     */
    public function query($accountId = null, $agreementNo = null, $employeeId = null, $employeeOpenId = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($accountId, $agreementNo, $employeeId, $employeeOpenId, $pageNum, $pageSize, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesEmployeerulesQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesEmployeerulesQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($accountId = null, $agreementNo = null, $employeeId = null, $employeeOpenId = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($accountId, $agreementNo, $employeeId, $employeeOpenId, $pageNum, $pageSize, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesEmployeerulesQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesEmployeerulesQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesEmployeerulesQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesEmployeerulesQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesEmployeerulesQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesEmployeerulesQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesEmployeerulesQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesEmployeerulesQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($accountId = null, $agreementNo = null, $employeeId = null, $employeeOpenId = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($accountId, $agreementNo, $employeeId, $employeeOpenId, $pageNum, $pageSize, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($accountId = null, $agreementNo = null, $employeeId = null, $employeeOpenId = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesEmployeerulesQueryResponseModel';
        $request = $this->queryRequest($accountId, $agreementNo, $employeeId, $employeeOpenId, $pageNum, $pageSize, $customizedParams);
     ...
     */
    public function queryRequest($accountId = null, $agreementNo = null, $employeeId = null, $employeeOpenId = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/invoice/expenserules/employeerules/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
