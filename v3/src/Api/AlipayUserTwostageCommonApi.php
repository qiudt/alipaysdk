...
/**
 * AlipayUserTwostageCommonApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayUserTwostageCommonApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 通用当面付二阶段接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseModel $alipayUserTwostageCommonUseModel alipayUserTwostageCommonUseModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseResponseModel|\Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseDefaultResponse
     */
    public function callUse($alipayUserTwostageCommonUseModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->callUseWithHttpInfo($alipayUserTwostageCommonUseModel, $customizedParams);
        return $response;
    }
     ...
     * 通用当面付二阶段接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseModel $alipayUserTwostageCommonUseModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseResponseModel|\Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function callUseWithHttpInfo($alipayUserTwostageCommonUseModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->callUseRequest($alipayUserTwostageCommonUseModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function callUseAsync($alipayUserTwostageCommonUseModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->callUseAsyncWithHttpInfo($alipayUserTwostageCommonUseModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function callUseAsyncWithHttpInfo($alipayUserTwostageCommonUseModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayUserTwostageCommonUseResponseModel';
        $request = $this->callUseRequest($alipayUserTwostageCommonUseModel, $customizedParams);
     ...
     */
    public function callUseRequest($alipayUserTwostageCommonUseModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/user/twostage/common/use';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayUserTwostageCommonUseModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayUserTwostageCommonUseModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayUserTwostageCommonUseModel;
            }
