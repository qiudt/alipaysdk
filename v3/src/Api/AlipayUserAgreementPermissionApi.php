...
/**
 * AlipayUserAgreementPermissionApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayUserAgreementPermissionApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 支付宝协议支付许可创建、服务变更接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateModel $alipayUserAgreementPermissionCreateModel alipayUserAgreementPermissionCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateResponseModel|\Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateDefaultResponse
     */
    public function create($alipayUserAgreementPermissionCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->createWithHttpInfo($alipayUserAgreementPermissionCreateModel, $customizedParams);
        return $response;
    }
     ...
     * 支付宝协议支付许可创建、服务变更接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateModel $alipayUserAgreementPermissionCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateResponseModel|\Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($alipayUserAgreementPermissionCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->createRequest($alipayUserAgreementPermissionCreateModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function createAsync($alipayUserAgreementPermissionCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->createAsyncWithHttpInfo($alipayUserAgreementPermissionCreateModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function createAsyncWithHttpInfo($alipayUserAgreementPermissionCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayUserAgreementPermissionCreateResponseModel';
        $request = $this->createRequest($alipayUserAgreementPermissionCreateModel, $customizedParams);
     ...
     */
    public function createRequest($alipayUserAgreementPermissionCreateModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/user/agreement/permission/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayUserAgreementPermissionCreateModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayUserAgreementPermissionCreateModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayUserAgreementPermissionCreateModel;
            }
