...
/**
 * AlipayOpenMiniVersionAuditedApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniVersionAuditedApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 小程序退回开发
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniVersionAuditedCancelModel $alipayOpenMiniVersionAuditedCancelModel alipayOpenMiniVersionAuditedCancelModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniVersionAuditedCancelDefaultResponse
     */
    public function cancel($alipayOpenMiniVersionAuditedCancelModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->cancelWithHttpInfo($alipayOpenMiniVersionAuditedCancelModel, $customizedParams);
        return $response;
    }
     ...
     * 小程序退回开发
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniVersionAuditedCancelModel $alipayOpenMiniVersionAuditedCancelModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniVersionAuditedCancelDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelWithHttpInfo($alipayOpenMiniVersionAuditedCancelModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->cancelRequest($alipayOpenMiniVersionAuditedCancelModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniVersionAuditedCancelDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniVersionAuditedCancelDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniVersionAuditedCancelDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniVersionAuditedCancelDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function cancelAsync($alipayOpenMiniVersionAuditedCancelModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->cancelAsyncWithHttpInfo($alipayOpenMiniVersionAuditedCancelModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function cancelAsyncWithHttpInfo($alipayOpenMiniVersionAuditedCancelModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->cancelRequest($alipayOpenMiniVersionAuditedCancelModel, $customizedParams);
     ...
     */
    public function cancelRequest($alipayOpenMiniVersionAuditedCancelModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/version/audited/cancel';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniVersionAuditedCancelModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniVersionAuditedCancelModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniVersionAuditedCancelModel;
            }
