...
/**
 * AlipayOpenSearchAbilityApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenSearchAbilityApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 搜索运营列表分页查询
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryModel $alipayOpenSearchAbilityBatchqueryModel alipayOpenSearchAbilityBatchqueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryDefaultResponse
     */
    public function batchquery($alipayOpenSearchAbilityBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->batchqueryWithHttpInfo($alipayOpenSearchAbilityBatchqueryModel, $customizedParams);
        return $response;
    }
     ...
     * 搜索运营列表分页查询
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryModel $alipayOpenSearchAbilityBatchqueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function batchqueryWithHttpInfo($alipayOpenSearchAbilityBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->batchqueryRequest($alipayOpenSearchAbilityBatchqueryModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function batchqueryAsync($alipayOpenSearchAbilityBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->batchqueryAsyncWithHttpInfo($alipayOpenSearchAbilityBatchqueryModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function batchqueryAsyncWithHttpInfo($alipayOpenSearchAbilityBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenSearchAbilityBatchqueryResponseModel';
        $request = $this->batchqueryRequest($alipayOpenSearchAbilityBatchqueryModel, $customizedParams);
     ...
     */
    public function batchqueryRequest($alipayOpenSearchAbilityBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/search/ability/batchquery';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenSearchAbilityBatchqueryModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenSearchAbilityBatchqueryModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenSearchAbilityBatchqueryModel;
            }
