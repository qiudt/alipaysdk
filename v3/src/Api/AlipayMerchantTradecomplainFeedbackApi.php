...
/**
 * AlipayMerchantTradecomplainFeedbackApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMerchantTradecomplainFeedbackApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 商家处理交易投诉
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainFeedbackSubmitModel $alipayMerchantTradecomplainFeedbackSubmitModel alipayMerchantTradecomplainFeedbackSubmitModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainFeedbackSubmitDefaultResponse
     */
    public function submit($alipayMerchantTradecomplainFeedbackSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->submitWithHttpInfo($alipayMerchantTradecomplainFeedbackSubmitModel, $customizedParams);
        return $response;
    }
     ...
     * 商家处理交易投诉
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainFeedbackSubmitModel $alipayMerchantTradecomplainFeedbackSubmitModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainFeedbackSubmitDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitWithHttpInfo($alipayMerchantTradecomplainFeedbackSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->submitRequest($alipayMerchantTradecomplainFeedbackSubmitModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainFeedbackSubmitDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainFeedbackSubmitDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainFeedbackSubmitDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainFeedbackSubmitDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function submitAsync($alipayMerchantTradecomplainFeedbackSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->submitAsyncWithHttpInfo($alipayMerchantTradecomplainFeedbackSubmitModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function submitAsyncWithHttpInfo($alipayMerchantTradecomplainFeedbackSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->submitRequest($alipayMerchantTradecomplainFeedbackSubmitModel, $customizedParams);
     ...
     */
    public function submitRequest($alipayMerchantTradecomplainFeedbackSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/merchant/tradecomplain/feedback';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayMerchantTradecomplainFeedbackSubmitModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayMerchantTradecomplainFeedbackSubmitModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayMerchantTradecomplainFeedbackSubmitModel;
            }
