...
/**
 * AlipayOpenAuthTokenAppApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenAuthTokenAppApi
{
    /**
     * @var ClientInterface
     */
     ...
     *
     * @param string $appAuthToken 应用授权令牌 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppQueryDefaultResponse
     * @throws \InvalidArgumentException
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     */
    public function query($appAuthToken = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($appAuthToken, $customizedParams);
        return $response;
    }
     ...
     * @param CustomizedParams $customizedParams
     *
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \InvalidArgumentException
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     */
    public function queryWithHttpInfo($appAuthToken = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($appAuthToken, $customizedParams);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];

                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string)$response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($appAuthToken = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($appAuthToken, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($appAuthToken = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenAuthTokenAppQueryResponseModel';
        $request = $this->queryRequest($appAuthToken, $customizedParams);
     ...
     * @throws \InvalidArgumentException
     */
    public function queryRequest($appAuthToken = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/auth/token/app/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $appAuthToken,
            'app_auth_token', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
