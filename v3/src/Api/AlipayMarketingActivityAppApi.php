...
/**
 * AlipayMarketingActivityAppApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMarketingActivityAppApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $merchantId 商户PID,默认为当前接口调用商户  限制:  接口调用者必须有商户代运营权限。  &lt;a href&#x3D;\&quot;https://opendocs.alipay.com/mini/01hm6i#%E4%BB%A3%E8%BF%90%E8%90%A5%E6%8E%88%E6%9D%83\&quot;&gt;代运营授权流程&lt;/a&gt; (optional)
     * @param  int $pageNum 分页查询页码。  限制: 必须为大于0的整数 (optional)
     * @param  string $pageSize 分页查询单页数据条数。  限制:  1.必须为大于0的整数  2.每页最大值为20 (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayMarketingActivityAppBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingActivityAppBatchqueryDefaultResponse
     */
    public function batchquery($activityId, $merchantId = null, $pageNum = null, $pageSize = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->batchqueryWithHttpInfo($activityId, $merchantId, $pageNum, $pageSize, $merchantAccessMode, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayMarketingActivityAppBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingActivityAppBatchqueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function batchqueryWithHttpInfo($activityId, $merchantId = null, $pageNum = null, $pageSize = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->batchqueryRequest($activityId, $merchantId, $pageNum, $pageSize, $merchantAccessMode, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityAppBatchqueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityAppBatchqueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityAppBatchqueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityAppBatchqueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityAppBatchqueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityAppBatchqueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityAppBatchqueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityAppBatchqueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function batchqueryAsync($activityId, $merchantId = null, $pageNum = null, $pageSize = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->batchqueryAsyncWithHttpInfo($activityId, $merchantId, $pageNum, $pageSize, $merchantAccessMode, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function batchqueryAsyncWithHttpInfo($activityId, $merchantId = null, $pageNum = null, $pageSize = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityAppBatchqueryResponseModel';
        $request = $this->batchqueryRequest($activityId, $merchantId, $pageNum, $pageSize, $merchantAccessMode, $customizedParams);
     ...
     */
    public function batchqueryRequest($activityId, $merchantId = null, $pageNum = null, $pageSize = null, $merchantAccessMode = null, ?CustomizedParams $customizedParams = null)
    {
        ...
        $resourcePath = '/v3/alipay/marketing/activity/{activity_id}/app/batchquery';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
