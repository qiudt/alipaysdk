...
/**
 * AlipayOpenMiniInnerversionLastApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerversionLastApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 内部链路查询最新版本号
     *
     * @param  string $miniAppId 小程序ID，仅特殊场景使用，普通业务方无需关注该参数。 (optional)
     * @param  string $bundleId 端信息 (optional)
     * @param  string $appOrigin 业务来源场景 (optional)
     * @param  string $pid 小程序主体 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionLastQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionLastQueryDefaultResponse
     */
    public function query($miniAppId = null, $bundleId = null, $appOrigin = null, $pid = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($miniAppId, $bundleId, $appOrigin, $pid, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionLastQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionLastQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($miniAppId = null, $bundleId = null, $appOrigin = null, $pid = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($miniAppId, $bundleId, $appOrigin, $pid, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionLastQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionLastQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionLastQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionLastQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionLastQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionLastQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionLastQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionLastQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($miniAppId = null, $bundleId = null, $appOrigin = null, $pid = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($miniAppId, $bundleId, $appOrigin, $pid, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($miniAppId = null, $bundleId = null, $appOrigin = null, $pid = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionLastQueryResponseModel';
        $request = $this->queryRequest($miniAppId, $bundleId, $appOrigin, $pid, $customizedParams);
     ...
     */
    public function queryRequest($miniAppId = null, $bundleId = null, $appOrigin = null, $pid = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerversion/last/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
