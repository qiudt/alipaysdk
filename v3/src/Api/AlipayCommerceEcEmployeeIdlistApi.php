...
/**
 * AlipayCommerceEcEmployeeIdlistApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayCommerceEcEmployeeIdlistApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  int $pageNum 查询页数 (optional)
     * @param  int $pageSize 每页查询大小，限制最大为1000 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeIdlistQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeIdlistQueryDefaultResponse
     */
    public function query($enterpriseId = null, $departmentId = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($enterpriseId, $departmentId, $pageNum, $pageSize, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeIdlistQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeIdlistQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($enterpriseId = null, $departmentId = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($enterpriseId, $departmentId, $pageNum, $pageSize, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeIdlistQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeIdlistQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeIdlistQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeIdlistQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeIdlistQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeIdlistQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeIdlistQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeIdlistQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($enterpriseId = null, $departmentId = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($enterpriseId, $departmentId, $pageNum, $pageSize, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($enterpriseId = null, $departmentId = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceEcEmployeeIdlistQueryResponseModel';
        $request = $this->queryRequest($enterpriseId, $departmentId, $pageNum, $pageSize, $customizedParams);
     ...
     */
    public function queryRequest($enterpriseId = null, $departmentId = null, $pageNum = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/commerce/ec/employee/idlist/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
