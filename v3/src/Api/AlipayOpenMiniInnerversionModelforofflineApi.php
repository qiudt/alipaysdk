...
/**
 * AlipayOpenMiniInnerversionModelforofflineApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerversionModelforofflineApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $appVersion 版本号 (optional)
     * @param  string $bundleId com.alipay.alipaywallet:支付包 (optional)
     * @param  string $instCode alipay:支付宝 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionModelforofflineQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionModelforofflineQueryDefaultResponse
     */
    public function query($miniAppId = null, $appVersion = null, $bundleId = null, $instCode = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($miniAppId, $appVersion, $bundleId, $instCode, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionModelforofflineQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionModelforofflineQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($miniAppId = null, $appVersion = null, $bundleId = null, $instCode = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($miniAppId, $appVersion, $bundleId, $instCode, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionModelforofflineQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionModelforofflineQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionModelforofflineQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionModelforofflineQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionModelforofflineQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionModelforofflineQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionModelforofflineQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionModelforofflineQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($miniAppId = null, $appVersion = null, $bundleId = null, $instCode = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($miniAppId, $appVersion, $bundleId, $instCode, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($miniAppId = null, $appVersion = null, $bundleId = null, $instCode = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionModelforofflineQueryResponseModel';
        $request = $this->queryRequest($miniAppId, $appVersion, $bundleId, $instCode, $customizedParams);
     ...
     */
    public function queryRequest($miniAppId = null, $appVersion = null, $bundleId = null, $instCode = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerversion/modelforoffline/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
