...
/**
 * AlipayUserAlipaypointApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayUserAlipaypointApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 集分宝发放接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendModel $alipayUserAlipaypointSendModel alipayUserAlipaypointSendModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendResponseModel|\Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendDefaultResponse
     */
    public function send($alipayUserAlipaypointSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->sendWithHttpInfo($alipayUserAlipaypointSendModel, $customizedParams);
        return $response;
    }
     ...
     * 集分宝发放接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendModel $alipayUserAlipaypointSendModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendResponseModel|\Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendWithHttpInfo($alipayUserAlipaypointSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->sendRequest($alipayUserAlipaypointSendModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function sendAsync($alipayUserAlipaypointSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->sendAsyncWithHttpInfo($alipayUserAlipaypointSendModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function sendAsyncWithHttpInfo($alipayUserAlipaypointSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayUserAlipaypointSendResponseModel';
        $request = $this->sendRequest($alipayUserAlipaypointSendModel, $customizedParams);
     ...
     */
    public function sendRequest($alipayUserAlipaypointSendModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/user/alipaypoint/send';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayUserAlipaypointSendModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayUserAlipaypointSendModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayUserAlipaypointSendModel;
            }
