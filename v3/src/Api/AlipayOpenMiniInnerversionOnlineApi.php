<?php
/**
 * AlipayOpenMiniInnerversionOnlineApi
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AlipayOpenMiniInnerversionOnlineApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerversionOnlineApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 内部链路小程序上架
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOnlinePublishModel $alipayOpenMiniInnerversionOnlinePublishModel alipayOpenMiniInnerversionOnlinePublishModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOnlinePublishDefaultResponse
     */
    public function publish($alipayOpenMiniInnerversionOnlinePublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->publishWithHttpInfo($alipayOpenMiniInnerversionOnlinePublishModel, $customizedParams);
        return $response;
    }
     ...
     * 内部链路小程序上架
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOnlinePublishModel $alipayOpenMiniInnerversionOnlinePublishModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOnlinePublishDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function publishWithHttpInfo($alipayOpenMiniInnerversionOnlinePublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->publishRequest($alipayOpenMiniInnerversionOnlinePublishModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOnlinePublishDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOnlinePublishDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOnlinePublishDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOnlinePublishDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function publishAsync($alipayOpenMiniInnerversionOnlinePublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->publishAsyncWithHttpInfo($alipayOpenMiniInnerversionOnlinePublishModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function publishAsyncWithHttpInfo($alipayOpenMiniInnerversionOnlinePublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->publishRequest($alipayOpenMiniInnerversionOnlinePublishModel, $customizedParams);
     ...
     */
    public function publishRequest($alipayOpenMiniInnerversionOnlinePublishModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerversion/online/publish';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniInnerversionOnlinePublishModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniInnerversionOnlinePublishModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniInnerversionOnlinePublishModel;
            }
