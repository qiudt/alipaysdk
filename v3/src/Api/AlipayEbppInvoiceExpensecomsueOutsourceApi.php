...
/**
 * AlipayEbppInvoiceExpensecomsueOutsourceApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEbppInvoiceExpensecomsueOutsourceApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 同步外部额度变更（交易形式）
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyModel $alipayEbppInvoiceExpensecomsueOutsourceNotifyModel alipayEbppInvoiceExpensecomsueOutsourceNotifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyDefaultResponse
     */
    public function notify($alipayEbppInvoiceExpensecomsueOutsourceNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->notifyWithHttpInfo($alipayEbppInvoiceExpensecomsueOutsourceNotifyModel, $customizedParams);
        return $response;
    }
     ...
     * 同步外部额度变更（交易形式）
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyModel $alipayEbppInvoiceExpensecomsueOutsourceNotifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function notifyWithHttpInfo($alipayEbppInvoiceExpensecomsueOutsourceNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->notifyRequest($alipayEbppInvoiceExpensecomsueOutsourceNotifyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function notifyAsync($alipayEbppInvoiceExpensecomsueOutsourceNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->notifyAsyncWithHttpInfo($alipayEbppInvoiceExpensecomsueOutsourceNotifyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function notifyAsyncWithHttpInfo($alipayEbppInvoiceExpensecomsueOutsourceNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpensecomsueOutsourceNotifyResponseModel';
        $request = $this->notifyRequest($alipayEbppInvoiceExpensecomsueOutsourceNotifyModel, $customizedParams);
     ...
     */
    public function notifyRequest($alipayEbppInvoiceExpensecomsueOutsourceNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/invoice/expensecomsue/outsource/notify';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayEbppInvoiceExpensecomsueOutsourceNotifyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayEbppInvoiceExpensecomsueOutsourceNotifyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayEbppInvoiceExpensecomsueOutsourceNotifyModel;
            }
