...
/**
 * AlipayOpenMiniInnerversionBetaApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerversionBetaApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 确认邀测结果
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetaConfirmModel $alipayOpenMiniInnerversionBetaConfirmModel alipayOpenMiniInnerversionBetaConfirmModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetaConfirmDefaultResponse
     */
    public function confirm($alipayOpenMiniInnerversionBetaConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->confirmWithHttpInfo($alipayOpenMiniInnerversionBetaConfirmModel, $customizedParams);
        return $response;
    }
     ...
     * 确认邀测结果
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetaConfirmModel $alipayOpenMiniInnerversionBetaConfirmModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetaConfirmDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function confirmWithHttpInfo($alipayOpenMiniInnerversionBetaConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->confirmRequest($alipayOpenMiniInnerversionBetaConfirmModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetaConfirmDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetaConfirmDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetaConfirmDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetaConfirmDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function confirmAsync($alipayOpenMiniInnerversionBetaConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->confirmAsyncWithHttpInfo($alipayOpenMiniInnerversionBetaConfirmModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function confirmAsyncWithHttpInfo($alipayOpenMiniInnerversionBetaConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->confirmRequest($alipayOpenMiniInnerversionBetaConfirmModel, $customizedParams);
     ...
     */
    public function confirmRequest($alipayOpenMiniInnerversionBetaConfirmModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerversion/beta/confirm';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniInnerversionBetaConfirmModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniInnerversionBetaConfirmModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniInnerversionBetaConfirmModel;
            }
