...
/**
 * AlipayEbppInvoiceTitleDynamicApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEbppInvoiceTitleDynamicApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 根据动态码查询发票抬头
     *
     * @param  string $barCode 抬头动态码 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleDynamicGetResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleDynamicGetDefaultResponse
     */
    public function get($barCode = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->getWithHttpInfo($barCode, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleDynamicGetResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleDynamicGetDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($barCode = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->getRequest($barCode, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleDynamicGetResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleDynamicGetResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleDynamicGetResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleDynamicGetDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleDynamicGetDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleDynamicGetDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleDynamicGetResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleDynamicGetDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function getAsync($barCode = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->getAsyncWithHttpInfo($barCode, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getAsyncWithHttpInfo($barCode = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleDynamicGetResponseModel';
        $request = $this->getRequest($barCode, $customizedParams);
     ...
     */
    public function getRequest($barCode = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/invoice/title/dynamic/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
