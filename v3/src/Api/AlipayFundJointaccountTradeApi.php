...
/**
 * AlipayFundJointaccountTradeApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayFundJointaccountTradeApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $memberId 成员ID，消费发起人 (optional)
     * @param  string $memberOpenId 消费发起人的openId (optional)
     * @param  string $accountId 企业账户ID (optional)
     * @param  string $agreementNo 三方授权协议号 (optional)
     * @param  string $tradeNo 支付宝交易订单号 (optional)
     * @param  string $platformOrderId 外部平台订单号。使用该参数查询时，返回结果见trade_info_list (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayFundJointaccountTradeQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundJointaccountTradeQueryDefaultResponse
     */
    public function query($productCode = null, $bizScene = null, $memberId = null, $memberOpenId = null, $accountId = null, $agreementNo = null, $tradeNo = null, $platformOrderId = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($productCode, $bizScene, $memberId, $memberOpenId, $accountId, $agreementNo, $tradeNo, $platformOrderId, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayFundJointaccountTradeQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundJointaccountTradeQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($productCode = null, $bizScene = null, $memberId = null, $memberOpenId = null, $accountId = null, $agreementNo = null, $tradeNo = null, $platformOrderId = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($productCode, $bizScene, $memberId, $memberOpenId, $accountId, $agreementNo, $tradeNo, $platformOrderId, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountTradeQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountTradeQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountTradeQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountTradeQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountTradeQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountTradeQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountTradeQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountTradeQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($productCode = null, $bizScene = null, $memberId = null, $memberOpenId = null, $accountId = null, $agreementNo = null, $tradeNo = null, $platformOrderId = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($productCode, $bizScene, $memberId, $memberOpenId, $accountId, $agreementNo, $tradeNo, $platformOrderId, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($productCode = null, $bizScene = null, $memberId = null, $memberOpenId = null, $accountId = null, $agreementNo = null, $tradeNo = null, $platformOrderId = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountTradeQueryResponseModel';
        $request = $this->queryRequest($productCode, $bizScene, $memberId, $memberOpenId, $accountId, $agreementNo, $tradeNo, $platformOrderId, $customizedParams);
     ...
     */
    public function queryRequest($productCode = null, $bizScene = null, $memberId = null, $memberOpenId = null, $accountId = null, $agreementNo = null, $tradeNo = null, $platformOrderId = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/fund/jointaccount/trade/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $memberOpenId,
            'member_open_id', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $platformOrderId,
            'platform_order_id', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
