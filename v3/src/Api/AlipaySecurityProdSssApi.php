...
/**
 * AlipaySecurityProdSssApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipaySecurityProdSssApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 金柚测试3.0接口
     *
     * @param  string $bbb activity_id 词条描述 (required)
     * @param  string $aaa 1 (optional)
     * @param  string $aaaOpenId 1 (optional)
     * @param  \Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryModel $alipaySecurityProdSssQueryModel alipaySecurityProdSssQueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryDefaultResponse
     */
    public function query($bbb, $aaa = null, $aaaOpenId = null, $alipaySecurityProdSssQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($bbb, $aaa, $aaaOpenId, $alipaySecurityProdSssQueryModel, $customizedParams);
        return $response;
    }
     ...
     * @param  string $aaa 1 (optional)
     * @param  string $aaaOpenId 1 (optional)
     * @param  \Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryModel $alipaySecurityProdSssQueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($bbb, $aaa = null, $aaaOpenId = null, $alipaySecurityProdSssQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($bbb, $aaa, $aaaOpenId, $alipaySecurityProdSssQueryModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($bbb, $aaa = null, $aaaOpenId = null, $alipaySecurityProdSssQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($bbb, $aaa, $aaaOpenId, $alipaySecurityProdSssQueryModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($bbb, $aaa = null, $aaaOpenId = null, $alipaySecurityProdSssQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipaySecurityProdSssQueryResponseModel';
        $request = $this->queryRequest($bbb, $aaa, $aaaOpenId, $alipaySecurityProdSssQueryModel, $customizedParams);
     ...
     */
    public function queryRequest($bbb, $aaa = null, $aaaOpenId = null, $alipaySecurityProdSssQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        // verify the required path parameter 'bbb' is set
        if ($bbb === null || (is_array($bbb) && count($bbb) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $bbb when calling query'
            );
        }

        $resourcePath = '/v3/alipay/security/prod/sss/query/{bbb}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($bbb !== null) {
            $resourcePath = str_replace(
                '{' . 'bbb' . '}',
                ObjectSerializer::toPathValue($bbb),
                $resourcePath
            );
        }
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipaySecurityProdSssQueryModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipaySecurityProdSssQueryModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipaySecurityProdSssQueryModel;
            }
