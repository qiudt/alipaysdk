...
/**
 * AlipayOpenPublicMessageLabelApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenPublicMessageLabelApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 根据标签组发消息接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenPublicMessageLabelSendModel $alipayOpenPublicMessageLabelSendModel alipayOpenPublicMessageLabelSendModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenPublicMessageLabelSendDefaultResponse
     */
    public function send($alipayOpenPublicMessageLabelSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->sendWithHttpInfo($alipayOpenPublicMessageLabelSendModel, $customizedParams);
        return $response;
    }
     ...
     * 根据标签组发消息接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenPublicMessageLabelSendModel $alipayOpenPublicMessageLabelSendModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenPublicMessageLabelSendDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendWithHttpInfo($alipayOpenPublicMessageLabelSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->sendRequest($alipayOpenPublicMessageLabelSendModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenPublicMessageLabelSendDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenPublicMessageLabelSendDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenPublicMessageLabelSendDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenPublicMessageLabelSendDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function sendAsync($alipayOpenPublicMessageLabelSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->sendAsyncWithHttpInfo($alipayOpenPublicMessageLabelSendModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function sendAsyncWithHttpInfo($alipayOpenPublicMessageLabelSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->sendRequest($alipayOpenPublicMessageLabelSendModel, $customizedParams);
     ...
     */
    public function sendRequest($alipayOpenPublicMessageLabelSendModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/public/message/label/send';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenPublicMessageLabelSendModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenPublicMessageLabelSendModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenPublicMessageLabelSendModel;
            }
