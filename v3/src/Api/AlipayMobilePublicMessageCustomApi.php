...
/**
 * AlipayMobilePublicMessageCustomApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMobilePublicMessageCustomApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 异步单发消息
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendModel $alipayMobilePublicMessageCustomSendModel alipayMobilePublicMessageCustomSendModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendResponseModel|\Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendDefaultResponse
     */
    public function send($alipayMobilePublicMessageCustomSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->sendWithHttpInfo($alipayMobilePublicMessageCustomSendModel, $customizedParams);
        return $response;
    }
     ...
     * 异步单发消息
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendModel $alipayMobilePublicMessageCustomSendModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendResponseModel|\Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendWithHttpInfo($alipayMobilePublicMessageCustomSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->sendRequest($alipayMobilePublicMessageCustomSendModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function sendAsync($alipayMobilePublicMessageCustomSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->sendAsyncWithHttpInfo($alipayMobilePublicMessageCustomSendModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function sendAsyncWithHttpInfo($alipayMobilePublicMessageCustomSendModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayMobilePublicMessageCustomSendResponseModel';
        $request = $this->sendRequest($alipayMobilePublicMessageCustomSendModel, $customizedParams);
     ...
     */
    public function sendRequest($alipayMobilePublicMessageCustomSendModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/mobile/public/message/custom/send';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayMobilePublicMessageCustomSendModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayMobilePublicMessageCustomSendModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayMobilePublicMessageCustomSendModel;
            }
