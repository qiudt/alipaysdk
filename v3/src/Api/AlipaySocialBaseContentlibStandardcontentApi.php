...
/**
 * AlipaySocialBaseContentlibStandardcontentApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipaySocialBaseContentlibStandardcontentApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 内容批量查询接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryModel $alipaySocialBaseContentlibStandardcontentBatchqueryModel alipaySocialBaseContentlibStandardcontentBatchqueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryDefaultResponse
     */
    public function batchquery($alipaySocialBaseContentlibStandardcontentBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->batchqueryWithHttpInfo($alipaySocialBaseContentlibStandardcontentBatchqueryModel, $customizedParams);
        return $response;
    }
     ...
     * 内容批量查询接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryModel $alipaySocialBaseContentlibStandardcontentBatchqueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function batchqueryWithHttpInfo($alipaySocialBaseContentlibStandardcontentBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->batchqueryRequest($alipaySocialBaseContentlibStandardcontentBatchqueryModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function batchqueryAsync($alipaySocialBaseContentlibStandardcontentBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->batchqueryAsyncWithHttpInfo($alipaySocialBaseContentlibStandardcontentBatchqueryModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function batchqueryAsyncWithHttpInfo($alipaySocialBaseContentlibStandardcontentBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipaySocialBaseContentlibStandardcontentBatchqueryResponseModel';
        $request = $this->batchqueryRequest($alipaySocialBaseContentlibStandardcontentBatchqueryModel, $customizedParams);
     ...
     */
    public function batchqueryRequest($alipaySocialBaseContentlibStandardcontentBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/social/base/contentlib/standardcontent/batchquery';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipaySocialBaseContentlibStandardcontentBatchqueryModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipaySocialBaseContentlibStandardcontentBatchqueryModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipaySocialBaseContentlibStandardcontentBatchqueryModel;
            }
