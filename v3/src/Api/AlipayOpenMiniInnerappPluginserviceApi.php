...
/**
 * AlipayOpenMiniInnerappPluginserviceApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerappPluginserviceApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 插件发布能力中心
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishModel $alipayOpenMiniInnerappPluginservicePublishModel alipayOpenMiniInnerappPluginservicePublishModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishDefaultResponse
     */
    public function publish($alipayOpenMiniInnerappPluginservicePublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->publishWithHttpInfo($alipayOpenMiniInnerappPluginservicePublishModel, $customizedParams);
        return $response;
    }
     ...
     * 插件发布能力中心
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishModel $alipayOpenMiniInnerappPluginservicePublishModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function publishWithHttpInfo($alipayOpenMiniInnerappPluginservicePublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->publishRequest($alipayOpenMiniInnerappPluginservicePublishModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function publishAsync($alipayOpenMiniInnerappPluginservicePublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->publishAsyncWithHttpInfo($alipayOpenMiniInnerappPluginservicePublishModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function publishAsyncWithHttpInfo($alipayOpenMiniInnerappPluginservicePublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerappPluginservicePublishResponseModel';
        $request = $this->publishRequest($alipayOpenMiniInnerappPluginservicePublishModel, $customizedParams);
     ...
     */
    public function publishRequest($alipayOpenMiniInnerappPluginservicePublishModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerapp/pluginservice/publish';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniInnerappPluginservicePublishModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniInnerappPluginservicePublishModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniInnerappPluginservicePublishModel;
            }
