...
/**
 * AlipayOpenPublicMenuDataApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenPublicMenuDataApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 菜单分析数据查询接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryModel $alipayOpenPublicMenuDataBatchqueryModel alipayOpenPublicMenuDataBatchqueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryDefaultResponse
     */
    public function batchquery($alipayOpenPublicMenuDataBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->batchqueryWithHttpInfo($alipayOpenPublicMenuDataBatchqueryModel, $customizedParams);
        return $response;
    }
     ...
     * 菜单分析数据查询接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryModel $alipayOpenPublicMenuDataBatchqueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function batchqueryWithHttpInfo($alipayOpenPublicMenuDataBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->batchqueryRequest($alipayOpenPublicMenuDataBatchqueryModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function batchqueryAsync($alipayOpenPublicMenuDataBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->batchqueryAsyncWithHttpInfo($alipayOpenPublicMenuDataBatchqueryModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function batchqueryAsyncWithHttpInfo($alipayOpenPublicMenuDataBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenPublicMenuDataBatchqueryResponseModel';
        $request = $this->batchqueryRequest($alipayOpenPublicMenuDataBatchqueryModel, $customizedParams);
     ...
     */
    public function batchqueryRequest($alipayOpenPublicMenuDataBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/public/menu/data/batchquery';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenPublicMenuDataBatchqueryModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenPublicMenuDataBatchqueryModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenPublicMenuDataBatchqueryModel;
            }
