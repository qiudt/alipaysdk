...
/**
 * AlipayOpenMiniResourceRecordApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniResourceRecordApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 提供给淘联盟备案信息接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniResourceRecordNotifyModel $alipayOpenMiniResourceRecordNotifyModel alipayOpenMiniResourceRecordNotifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniResourceRecordNotifyDefaultResponse
     */
    public function notify($alipayOpenMiniResourceRecordNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->notifyWithHttpInfo($alipayOpenMiniResourceRecordNotifyModel, $customizedParams);
        return $response;
    }
     ...
     * 提供给淘联盟备案信息接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniResourceRecordNotifyModel $alipayOpenMiniResourceRecordNotifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniResourceRecordNotifyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function notifyWithHttpInfo($alipayOpenMiniResourceRecordNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->notifyRequest($alipayOpenMiniResourceRecordNotifyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniResourceRecordNotifyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniResourceRecordNotifyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniResourceRecordNotifyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniResourceRecordNotifyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function notifyAsync($alipayOpenMiniResourceRecordNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->notifyAsyncWithHttpInfo($alipayOpenMiniResourceRecordNotifyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function notifyAsyncWithHttpInfo($alipayOpenMiniResourceRecordNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->notifyRequest($alipayOpenMiniResourceRecordNotifyModel, $customizedParams);
     ...
     */
    public function notifyRequest($alipayOpenMiniResourceRecordNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/resource/record/notify';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniResourceRecordNotifyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniResourceRecordNotifyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniResourceRecordNotifyModel;
            }
