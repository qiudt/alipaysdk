...
/**
 * AlipayMarketingCampaignOrderVoucherApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMarketingCampaignOrderVoucherApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  \Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultModel $alipayMarketingCampaignOrderVoucherConsultModel alipayMarketingCampaignOrderVoucherConsultModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultDefaultResponse
     */
    public function consult($authToken = null, $alipayMarketingCampaignOrderVoucherConsultModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->consultWithHttpInfo($authToken, $alipayMarketingCampaignOrderVoucherConsultModel, $customizedParams);
        return $response;
    }
     ...
     *
     * @param  string $authToken 用户授权令牌 (optional)
     * @param  \Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultModel $alipayMarketingCampaignOrderVoucherConsultModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultWithHttpInfo($authToken = null, $alipayMarketingCampaignOrderVoucherConsultModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->consultRequest($authToken, $alipayMarketingCampaignOrderVoucherConsultModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function consultAsync($authToken = null, $alipayMarketingCampaignOrderVoucherConsultModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->consultAsyncWithHttpInfo($authToken, $alipayMarketingCampaignOrderVoucherConsultModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function consultAsyncWithHttpInfo($authToken = null, $alipayMarketingCampaignOrderVoucherConsultModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignOrderVoucherConsultResponseModel';
        $request = $this->consultRequest($authToken, $alipayMarketingCampaignOrderVoucherConsultModel, $customizedParams);
     ...
     */
    public function consultRequest($authToken = null, $alipayMarketingCampaignOrderVoucherConsultModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/marketing/campaign/order/voucher/consult';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayMarketingCampaignOrderVoucherConsultModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayMarketingCampaignOrderVoucherConsultModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayMarketingCampaignOrderVoucherConsultModel;
            }
