...
/**
 * AlipayOpenMiniAppdeployByappversionApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniAppdeployByappversionApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $appVersion 小程序版本 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappversionQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappversionQueryDefaultResponse
     */
    public function query($miniAppId = null, $bundleId = null, $instCode = null, $appVersion = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($miniAppId, $bundleId, $instCode, $appVersion, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappversionQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappversionQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($miniAppId = null, $bundleId = null, $instCode = null, $appVersion = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($miniAppId, $bundleId, $instCode, $appVersion, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappversionQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappversionQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappversionQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappversionQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappversionQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappversionQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappversionQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappversionQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($miniAppId = null, $bundleId = null, $instCode = null, $appVersion = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($miniAppId, $bundleId, $instCode, $appVersion, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($miniAppId = null, $bundleId = null, $instCode = null, $appVersion = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployByappversionQueryResponseModel';
        $request = $this->queryRequest($miniAppId, $bundleId, $instCode, $appVersion, $customizedParams);
     ...
     */
    public function queryRequest($miniAppId = null, $bundleId = null, $instCode = null, $appVersion = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/appdeploy/byappversion/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
