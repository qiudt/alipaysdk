...
/**
 * AlipayOpenMiniAppdeployBydeployversionApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniAppdeployBydeployversionApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 根据发布版本查询小程序发布信息
     *
     * @param  string $bundleId 客户端标识 (optional)
     * @param  string $miniAppId 小程序ID (optional)
     * @param  string $instCode 租户 (optional)
     * @param  string $deployVersion 发布标识 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployBydeployversionQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployBydeployversionQueryDefaultResponse
     */
    public function query($bundleId = null, $miniAppId = null, $instCode = null, $deployVersion = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($bundleId, $miniAppId, $instCode, $deployVersion, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployBydeployversionQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployBydeployversionQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($bundleId = null, $miniAppId = null, $instCode = null, $deployVersion = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($bundleId, $miniAppId, $instCode, $deployVersion, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployBydeployversionQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployBydeployversionQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployBydeployversionQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployBydeployversionQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployBydeployversionQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployBydeployversionQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployBydeployversionQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployBydeployversionQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($bundleId = null, $miniAppId = null, $instCode = null, $deployVersion = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($bundleId, $miniAppId, $instCode, $deployVersion, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($bundleId = null, $miniAppId = null, $instCode = null, $deployVersion = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniAppdeployBydeployversionQueryResponseModel';
        $request = $this->queryRequest($bundleId, $miniAppId, $instCode, $deployVersion, $customizedParams);
     ...
     */
    public function queryRequest($bundleId = null, $miniAppId = null, $instCode = null, $deployVersion = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/appdeploy/bydeployversion/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $deployVersion,
            'deploy_version', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
