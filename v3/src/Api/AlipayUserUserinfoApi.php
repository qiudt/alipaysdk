...
/**
 * AlipayUserUserinfoApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayUserUserinfoApi
{
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayUserUserinfoShareResponseModel|\Alipay\OpenAPISDK\Model\AlipayUserUserinfoShareDefaultResponse
     */
    public function share(?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->shareWithHttpInfo($customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayUserUserinfoShareResponseModel|\Alipay\OpenAPISDK\Model\AlipayUserUserinfoShareDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function shareWithHttpInfo(?CustomizedParams $customizedParams = null)
    {
        $request = $this->shareRequest($customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayUserUserinfoShareResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayUserUserinfoShareResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayUserUserinfoShareResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayUserUserinfoShareDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayUserUserinfoShareDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayUserUserinfoShareDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayUserUserinfoShareResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayUserUserinfoShareDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function shareAsync(?CustomizedParams $customizedParams = null)
    {
        return $this->shareAsyncWithHttpInfo($customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function shareAsyncWithHttpInfo(?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayUserUserinfoShareResponseModel';
        $request = $this->shareRequest($customizedParams);
     ...
     */
    public function shareRequest(?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/user/userinfo/share';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
