...
/**
 * AlipayOpenMiniInnerversionBuildauditApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerversionBuildauditApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 内部链路小程序构建并提审
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBuildauditSubmitModel $alipayOpenMiniInnerversionBuildauditSubmitModel alipayOpenMiniInnerversionBuildauditSubmitModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBuildauditSubmitDefaultResponse
     */
    public function submit($alipayOpenMiniInnerversionBuildauditSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->submitWithHttpInfo($alipayOpenMiniInnerversionBuildauditSubmitModel, $customizedParams);
        return $response;
    }
     ...
     * 内部链路小程序构建并提审
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBuildauditSubmitModel $alipayOpenMiniInnerversionBuildauditSubmitModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBuildauditSubmitDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitWithHttpInfo($alipayOpenMiniInnerversionBuildauditSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->submitRequest($alipayOpenMiniInnerversionBuildauditSubmitModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBuildauditSubmitDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBuildauditSubmitDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBuildauditSubmitDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBuildauditSubmitDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function submitAsync($alipayOpenMiniInnerversionBuildauditSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->submitAsyncWithHttpInfo($alipayOpenMiniInnerversionBuildauditSubmitModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function submitAsyncWithHttpInfo($alipayOpenMiniInnerversionBuildauditSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->submitRequest($alipayOpenMiniInnerversionBuildauditSubmitModel, $customizedParams);
     ...
     */
    public function submitRequest($alipayOpenMiniInnerversionBuildauditSubmitModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerversion/buildaudit/submit';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniInnerversionBuildauditSubmitModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniInnerversionBuildauditSubmitModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniInnerversionBuildauditSubmitModel;
            }
