...
/**
 * AlipayMerchantTradecomplainReplyApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMerchantTradecomplainReplyApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 商家留言回复
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainReplySubmitModel $alipayMerchantTradecomplainReplySubmitModel alipayMerchantTradecomplainReplySubmitModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainReplySubmitDefaultResponse
     */
    public function submit($alipayMerchantTradecomplainReplySubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->submitWithHttpInfo($alipayMerchantTradecomplainReplySubmitModel, $customizedParams);
        return $response;
    }
     ...
     * 商家留言回复
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainReplySubmitModel $alipayMerchantTradecomplainReplySubmitModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainReplySubmitDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitWithHttpInfo($alipayMerchantTradecomplainReplySubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->submitRequest($alipayMerchantTradecomplainReplySubmitModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainReplySubmitDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainReplySubmitDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainReplySubmitDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMerchantTradecomplainReplySubmitDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function submitAsync($alipayMerchantTradecomplainReplySubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->submitAsyncWithHttpInfo($alipayMerchantTradecomplainReplySubmitModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function submitAsyncWithHttpInfo($alipayMerchantTradecomplainReplySubmitModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->submitRequest($alipayMerchantTradecomplainReplySubmitModel, $customizedParams);
     ...
     */
    public function submitRequest($alipayMerchantTradecomplainReplySubmitModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/merchant/tradecomplain/reply';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayMerchantTradecomplainReplySubmitModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayMerchantTradecomplainReplySubmitModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayMerchantTradecomplainReplySubmitModel;
            }
