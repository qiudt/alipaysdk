...
/**
 * AlipayOpenMiniTemplatemsgMaketingApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniTemplatemsgMaketingApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 小程序模板消息营销投放详情分页批量查询
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryModel $alipayOpenMiniTemplatemsgMaketingBatchqueryModel alipayOpenMiniTemplatemsgMaketingBatchqueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryDefaultResponse
     */
    public function batchquery($alipayOpenMiniTemplatemsgMaketingBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->batchqueryWithHttpInfo($alipayOpenMiniTemplatemsgMaketingBatchqueryModel, $customizedParams);
        return $response;
    }
     ...
     * 小程序模板消息营销投放详情分页批量查询
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryModel $alipayOpenMiniTemplatemsgMaketingBatchqueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function batchqueryWithHttpInfo($alipayOpenMiniTemplatemsgMaketingBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->batchqueryRequest($alipayOpenMiniTemplatemsgMaketingBatchqueryModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function batchqueryAsync($alipayOpenMiniTemplatemsgMaketingBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->batchqueryAsyncWithHttpInfo($alipayOpenMiniTemplatemsgMaketingBatchqueryModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function batchqueryAsyncWithHttpInfo($alipayOpenMiniTemplatemsgMaketingBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemsgMaketingBatchqueryResponseModel';
        $request = $this->batchqueryRequest($alipayOpenMiniTemplatemsgMaketingBatchqueryModel, $customizedParams);
     ...
     */
    public function batchqueryRequest($alipayOpenMiniTemplatemsgMaketingBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/templatemsg/maketing/batchquery';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniTemplatemsgMaketingBatchqueryModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniTemplatemsgMaketingBatchqueryModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniTemplatemsgMaketingBatchqueryModel;
            }
