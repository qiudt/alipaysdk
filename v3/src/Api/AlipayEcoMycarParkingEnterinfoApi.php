...
/**
 * AlipayEcoMycarParkingEnterinfoApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEcoMycarParkingEnterinfoApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 车辆驶入接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncModel $alipayEcoMycarParkingEnterinfoSyncModel alipayEcoMycarParkingEnterinfoSyncModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncResponseModel|\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncDefaultResponse
     */
    public function sync($alipayEcoMycarParkingEnterinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->syncWithHttpInfo($alipayEcoMycarParkingEnterinfoSyncModel, $customizedParams);
        return $response;
    }
     ...
     * 车辆驶入接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncModel $alipayEcoMycarParkingEnterinfoSyncModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncResponseModel|\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function syncWithHttpInfo($alipayEcoMycarParkingEnterinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->syncRequest($alipayEcoMycarParkingEnterinfoSyncModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function syncAsync($alipayEcoMycarParkingEnterinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->syncAsyncWithHttpInfo($alipayEcoMycarParkingEnterinfoSyncModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function syncAsyncWithHttpInfo($alipayEcoMycarParkingEnterinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingEnterinfoSyncResponseModel';
        $request = $this->syncRequest($alipayEcoMycarParkingEnterinfoSyncModel, $customizedParams);
     ...
     */
    public function syncRequest($alipayEcoMycarParkingEnterinfoSyncModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/eco/mycar/parking/enterinfo/sync';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayEcoMycarParkingEnterinfoSyncModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayEcoMycarParkingEnterinfoSyncModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayEcoMycarParkingEnterinfoSyncModel;
            }
