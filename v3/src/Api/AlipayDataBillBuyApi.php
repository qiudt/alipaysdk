...
/**
 * AlipayDataBillBuyApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayDataBillBuyApi
{
     ...
     * 支付宝商家账户买入交易查询
     *
     * @param  string $startTime 交易流水创建时间的起始范围 (optional)
     * @param  string $endTime 交易流水创建时间的结束范围。与起始时间间隔不超过31天。查询结果为起始时间至结束时间的左闭右开区间 (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayDataBillBuyQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayDataBillBuyQueryDefaultResponse
     */
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayDataBillBuyQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayDataBillBuyQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($startTime = null, $endTime = null, $alipayOrderNo = null, $merchantOrderNo = null, $storeNo = null, $pageNo = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBuyQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBuyQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayDataBillBuyQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBuyQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBuyQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayDataBillBuyQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayDataBillBuyQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayDataBillBuyQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
    ...
    public function queryRequest($startTime = null, $endTime = null, $alipayOrderNo = null, $merchantOrderNo = null, $storeNo = null, $pageNo = null, $pageSize = null, ?CustomizedParams $customizedParams = null)
    {
        ...
        $resourcePath = '/v3/alipay/data/bill/buy/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
