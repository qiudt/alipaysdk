...
/**
 * AlipayOpenSpOpporPageApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenSpOpporPageApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 商机作业列表查询
     *
     * @param  string $isvPid 服务商pid (optional)
     * @param  string $statusList 作业记录状态列表,以,拼接传入 (optional)
     * @param  string $pageSize 页大小 (optional)
     * @param  string $pageNum 页数 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenSpOpporPageQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporPageQueryDefaultResponse
     */
    public function query($isvPid = null, $statusList = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($isvPid, $statusList, $pageSize, $pageNum, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenSpOpporPageQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporPageQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($isvPid = null, $statusList = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($isvPid, $statusList, $pageSize, $pageNum, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporPageQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporPageQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporPageQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporPageQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporPageQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporPageQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporPageQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporPageQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($isvPid = null, $statusList = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($isvPid, $statusList, $pageSize, $pageNum, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($isvPid = null, $statusList = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporPageQueryResponseModel';
        $request = $this->queryRequest($isvPid, $statusList, $pageSize, $pageNum, $customizedParams);
     ...
     */
    public function queryRequest($isvPid = null, $statusList = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/sp/oppor/page/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
