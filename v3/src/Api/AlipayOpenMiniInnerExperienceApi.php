...
/**
 * AlipayOpenMiniInnerExperienceApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerExperienceApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 内部链路取消体验版
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerExperienceCancelModel $alipayOpenMiniInnerExperienceCancelModel alipayOpenMiniInnerExperienceCancelModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerExperienceCancelDefaultResponse
     */
    public function cancel($alipayOpenMiniInnerExperienceCancelModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->cancelWithHttpInfo($alipayOpenMiniInnerExperienceCancelModel, $customizedParams);
        return $response;
    }
     ...
     * 内部链路取消体验版
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerExperienceCancelModel $alipayOpenMiniInnerExperienceCancelModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerExperienceCancelDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelWithHttpInfo($alipayOpenMiniInnerExperienceCancelModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->cancelRequest($alipayOpenMiniInnerExperienceCancelModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerExperienceCancelDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerExperienceCancelDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerExperienceCancelDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerExperienceCancelDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function cancelAsync($alipayOpenMiniInnerExperienceCancelModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->cancelAsyncWithHttpInfo($alipayOpenMiniInnerExperienceCancelModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function cancelAsyncWithHttpInfo($alipayOpenMiniInnerExperienceCancelModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->cancelRequest($alipayOpenMiniInnerExperienceCancelModel, $customizedParams);
     ...
     */
    public function cancelRequest($alipayOpenMiniInnerExperienceCancelModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/inner/experience/cancel';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniInnerExperienceCancelModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniInnerExperienceCancelModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniInnerExperienceCancelModel;
            }
