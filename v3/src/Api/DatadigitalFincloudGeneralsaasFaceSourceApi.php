...
/**
 * DatadigitalFincloudGeneralsaasFaceSourceApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DatadigitalFincloudGeneralsaasFaceSourceApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 纯服务端人脸核身
     *
     * @param  \Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyModel $data data (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyResponseModel|\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyDefaultResponse
     */
    public function certify($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->certifyWithHttpInfo($data, $fileContent, $customizedParams);
        return $response;
    }
     ...
     * 纯服务端人脸核身
     *
     * @param  \Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyModel $data (optional)
     * @param  \SplFileObject $fileContent (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyResponseModel|\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function certifyWithHttpInfo($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->certifyRequest($data, $fileContent, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function certifyAsync($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->certifyAsyncWithHttpInfo($data, $fileContent, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function certifyAsyncWithHttpInfo($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\DatadigitalFincloudGeneralsaasFaceSourceCertifyResponseModel';
        $request = $this->certifyRequest($data, $fileContent, $customizedParams);
     ...
     */
    public function certifyRequest($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/datadigital/fincloud/generalsaas/face/source/certify';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
