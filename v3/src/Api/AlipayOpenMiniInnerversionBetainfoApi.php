...
/**
 * AlipayOpenMiniInnerversionBetainfoApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerversionBetainfoApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 查看可邀测状态接口
     *
     * @param  string $pluginId 插件ID (optional)
     * @param  string $bundleId 端信息 (optional)
     * @param  string $pluginVersion 查询版本号 (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetainfoQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetainfoQueryDefaultResponse
     */
    public function query($pluginId = null, $bundleId = null, $pluginVersion = null, $appOrigin = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($pluginId, $bundleId, $pluginVersion, $appOrigin, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetainfoQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetainfoQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($pluginId = null, $bundleId = null, $pluginVersion = null, $appOrigin = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($pluginId, $bundleId, $pluginVersion, $appOrigin, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetainfoQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetainfoQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetainfoQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetainfoQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetainfoQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetainfoQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetainfoQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetainfoQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($pluginId = null, $bundleId = null, $pluginVersion = null, $appOrigin = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($pluginId, $bundleId, $pluginVersion, $appOrigin, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($pluginId = null, $bundleId = null, $pluginVersion = null, $appOrigin = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionBetainfoQueryResponseModel';
        $request = $this->queryRequest($pluginId, $bundleId, $pluginVersion, $appOrigin, $customizedParams);
     ...
     */
    public function queryRequest($pluginId = null, $bundleId = null, $pluginVersion = null, $appOrigin = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerversion/betainfo/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $pluginVersion,
            'plugin_version', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
