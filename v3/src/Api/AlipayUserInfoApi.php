...
/**
 * AlipayUserInfoApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayUserInfoApi
{
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayUserInfoShareResponseModel|\Alipay\OpenAPISDK\Model\AlipayUserInfoShareDefaultResponse
     */
    public function share($authToken = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->shareWithHttpInfo($authToken, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayUserInfoShareResponseModel|\Alipay\OpenAPISDK\Model\AlipayUserInfoShareDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function shareWithHttpInfo($authToken = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->shareRequest($authToken, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayUserInfoShareResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayUserInfoShareResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayUserInfoShareResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayUserInfoShareDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayUserInfoShareDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayUserInfoShareDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayUserInfoShareResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayUserInfoShareDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function shareAsync($authToken = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->shareAsyncWithHttpInfo($authToken, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function shareAsyncWithHttpInfo($authToken = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayUserInfoShareResponseModel';
        $request = $this->shareRequest($authToken, $customizedParams);
     ...
     */
    public function shareRequest($authToken = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/user/info/share';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
