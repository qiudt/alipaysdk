...
/**
 * AlipayFundJointaccountMemberruleApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayFundJointaccountMemberruleApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 企业设置员工规则
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayFundJointaccountMemberruleModifyModel $alipayFundJointaccountMemberruleModifyModel alipayFundJointaccountMemberruleModifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayFundJointaccountMemberruleModifyDefaultResponse
     */
    public function modify($alipayFundJointaccountMemberruleModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->modifyWithHttpInfo($alipayFundJointaccountMemberruleModifyModel, $customizedParams);
        return $response;
    }
     ...
     * 企业设置员工规则
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayFundJointaccountMemberruleModifyModel $alipayFundJointaccountMemberruleModifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayFundJointaccountMemberruleModifyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function modifyWithHttpInfo($alipayFundJointaccountMemberruleModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->modifyRequest($alipayFundJointaccountMemberruleModifyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountMemberruleModifyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountMemberruleModifyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountMemberruleModifyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountMemberruleModifyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function modifyAsync($alipayFundJointaccountMemberruleModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->modifyAsyncWithHttpInfo($alipayFundJointaccountMemberruleModifyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function modifyAsyncWithHttpInfo($alipayFundJointaccountMemberruleModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->modifyRequest($alipayFundJointaccountMemberruleModifyModel, $customizedParams);
     ...
     */
    public function modifyRequest($alipayFundJointaccountMemberruleModifyModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/fund/jointaccount/memberrule/modify';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayFundJointaccountMemberruleModifyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayFundJointaccountMemberruleModifyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayFundJointaccountMemberruleModifyModel;
            }
