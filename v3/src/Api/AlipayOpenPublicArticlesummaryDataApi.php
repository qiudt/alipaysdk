...
/**
 * AlipayOpenPublicArticlesummaryDataApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenPublicArticlesummaryDataApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 图文分析-按时间查询数据接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryModel $alipayOpenPublicArticlesummaryDataBatchqueryModel alipayOpenPublicArticlesummaryDataBatchqueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryDefaultResponse
     */
    public function batchquery($alipayOpenPublicArticlesummaryDataBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->batchqueryWithHttpInfo($alipayOpenPublicArticlesummaryDataBatchqueryModel, $customizedParams);
        return $response;
    }
     ...
     * 图文分析-按时间查询数据接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryModel $alipayOpenPublicArticlesummaryDataBatchqueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function batchqueryWithHttpInfo($alipayOpenPublicArticlesummaryDataBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->batchqueryRequest($alipayOpenPublicArticlesummaryDataBatchqueryModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function batchqueryAsync($alipayOpenPublicArticlesummaryDataBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->batchqueryAsyncWithHttpInfo($alipayOpenPublicArticlesummaryDataBatchqueryModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function batchqueryAsyncWithHttpInfo($alipayOpenPublicArticlesummaryDataBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenPublicArticlesummaryDataBatchqueryResponseModel';
        $request = $this->batchqueryRequest($alipayOpenPublicArticlesummaryDataBatchqueryModel, $customizedParams);
     ...
     */
    public function batchqueryRequest($alipayOpenPublicArticlesummaryDataBatchqueryModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/public/articlesummary/data/batchquery';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenPublicArticlesummaryDataBatchqueryModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenPublicArticlesummaryDataBatchqueryModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenPublicArticlesummaryDataBatchqueryModel;
            }
