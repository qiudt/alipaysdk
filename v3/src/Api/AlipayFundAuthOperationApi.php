...
/**
 * AlipayFundAuthOperationApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayFundAuthOperationApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 资金授权撤销接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelModel $alipayFundAuthOperationCancelModel alipayFundAuthOperationCancelModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelDefaultResponse
     */
    public function cancel($alipayFundAuthOperationCancelModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->cancelWithHttpInfo($alipayFundAuthOperationCancelModel, $customizedParams);
        return $response;
    }
     ...
     * 资金授权撤销接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelModel $alipayFundAuthOperationCancelModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelWithHttpInfo($alipayFundAuthOperationCancelModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->cancelRequest($alipayFundAuthOperationCancelModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function cancelAsync($alipayFundAuthOperationCancelModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->cancelAsyncWithHttpInfo($alipayFundAuthOperationCancelModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function cancelAsyncWithHttpInfo($alipayFundAuthOperationCancelModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundAuthOperationCancelResponseModel';
        $request = $this->cancelRequest($alipayFundAuthOperationCancelModel, $customizedParams);
     ...
     */
    public function cancelRequest($alipayFundAuthOperationCancelModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/fund/auth/operation/cancel';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayFundAuthOperationCancelModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayFundAuthOperationCancelModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayFundAuthOperationCancelModel;
            }
