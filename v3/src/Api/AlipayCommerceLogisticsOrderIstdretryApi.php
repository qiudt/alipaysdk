...
/**
 * AlipayCommerceLogisticsOrderIstdretryApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayCommerceLogisticsOrderIstdretryApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 重下即时配送订单
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateModel $alipayCommerceLogisticsOrderIstdretryCreateModel alipayCommerceLogisticsOrderIstdretryCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateDefaultResponse
     */
    public function create($alipayCommerceLogisticsOrderIstdretryCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->createWithHttpInfo($alipayCommerceLogisticsOrderIstdretryCreateModel, $customizedParams);
        return $response;
    }
     ...
     * 重下即时配送订单
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateModel $alipayCommerceLogisticsOrderIstdretryCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateResponseModel|\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($alipayCommerceLogisticsOrderIstdretryCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->createRequest($alipayCommerceLogisticsOrderIstdretryCreateModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function createAsync($alipayCommerceLogisticsOrderIstdretryCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->createAsyncWithHttpInfo($alipayCommerceLogisticsOrderIstdretryCreateModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function createAsyncWithHttpInfo($alipayCommerceLogisticsOrderIstdretryCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayCommerceLogisticsOrderIstdretryCreateResponseModel';
        $request = $this->createRequest($alipayCommerceLogisticsOrderIstdretryCreateModel, $customizedParams);
     ...
     */
    public function createRequest($alipayCommerceLogisticsOrderIstdretryCreateModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/commerce/logistics/order/istdretry/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayCommerceLogisticsOrderIstdretryCreateModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayCommerceLogisticsOrderIstdretryCreateModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayCommerceLogisticsOrderIstdretryCreateModel;
            }
