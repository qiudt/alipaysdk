...
/**
 * AlipayEbppPdeductBillPayApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEbppPdeductBillPayApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 缴费直连代扣订单支付状态查询
     *
     * @param  string $agreementId 支付宝用户ID (optional)
     * @param  string $openId 用户UserId在应用AppId下的唯一用户标识 (optional)
     * @param  string $outOrderNo 商户代扣业务流水 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppPdeductBillPayStatusResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppPdeductBillPayStatusDefaultResponse
     */
    public function status($agreementId = null, $openId = null, $outOrderNo = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->statusWithHttpInfo($agreementId, $openId, $outOrderNo, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppPdeductBillPayStatusResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppPdeductBillPayStatusDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function statusWithHttpInfo($agreementId = null, $openId = null, $outOrderNo = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->statusRequest($agreementId, $openId, $outOrderNo, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppPdeductBillPayStatusResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppPdeductBillPayStatusResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductBillPayStatusResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppPdeductBillPayStatusDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppPdeductBillPayStatusDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductBillPayStatusDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductBillPayStatusResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductBillPayStatusDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function statusAsync($agreementId = null, $openId = null, $outOrderNo = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->statusAsyncWithHttpInfo($agreementId, $openId, $outOrderNo, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function statusAsyncWithHttpInfo($agreementId = null, $openId = null, $outOrderNo = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppPdeductBillPayStatusResponseModel';
        $request = $this->statusRequest($agreementId, $openId, $outOrderNo, $customizedParams);
     ...
     */
    public function statusRequest($agreementId = null, $openId = null, $outOrderNo = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/pdeduct/bill/pay/status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
