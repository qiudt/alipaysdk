...
/**
 * AlipayIserviceCcmRolePageApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayIserviceCcmRolePageApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $ccsInstanceId 部门id（即租户实例ID、数据权限ID） (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayIserviceCcmRolePageQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayIserviceCcmRolePageQueryDefaultResponse
     */
    public function query($name = null, $pageNum = null, $pageSize = null, $ccsInstanceId = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($name, $pageNum, $pageSize, $ccsInstanceId, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayIserviceCcmRolePageQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayIserviceCcmRolePageQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($name = null, $pageNum = null, $pageSize = null, $ccsInstanceId = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($name, $pageNum, $pageSize, $ccsInstanceId, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayIserviceCcmRolePageQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayIserviceCcmRolePageQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmRolePageQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayIserviceCcmRolePageQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayIserviceCcmRolePageQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmRolePageQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmRolePageQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmRolePageQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($name = null, $pageNum = null, $pageSize = null, $ccsInstanceId = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($name, $pageNum, $pageSize, $ccsInstanceId, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($name = null, $pageNum = null, $pageSize = null, $ccsInstanceId = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayIserviceCcmRolePageQueryResponseModel';
        $request = $this->queryRequest($name, $pageNum, $pageSize, $ccsInstanceId, $customizedParams);
     ...
     */
    public function queryRequest($name = null, $pageNum = null, $pageSize = null, $ccsInstanceId = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/iservice/ccm/role/page/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
