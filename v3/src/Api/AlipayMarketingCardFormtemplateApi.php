...
/**
 * AlipayMarketingCardFormtemplateApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMarketingCardFormtemplateApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 会员卡开卡表单模板配置
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMarketingCardFormtemplateSetModel $alipayMarketingCardFormtemplateSetModel alipayMarketingCardFormtemplateSetModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayMarketingCardFormtemplateSetDefaultResponse
     */
    public function set($alipayMarketingCardFormtemplateSetModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->setWithHttpInfo($alipayMarketingCardFormtemplateSetModel, $customizedParams);
        return $response;
    }
     ...
     * 会员卡开卡表单模板配置
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMarketingCardFormtemplateSetModel $alipayMarketingCardFormtemplateSetModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayMarketingCardFormtemplateSetDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function setWithHttpInfo($alipayMarketingCardFormtemplateSetModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->setRequest($alipayMarketingCardFormtemplateSetModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCardFormtemplateSetDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCardFormtemplateSetDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingCardFormtemplateSetDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMarketingCardFormtemplateSetDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function setAsync($alipayMarketingCardFormtemplateSetModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->setAsyncWithHttpInfo($alipayMarketingCardFormtemplateSetModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function setAsyncWithHttpInfo($alipayMarketingCardFormtemplateSetModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->setRequest($alipayMarketingCardFormtemplateSetModel, $customizedParams);
     ...
     */
    public function setRequest($alipayMarketingCardFormtemplateSetModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/marketing/card/formtemplate/set';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayMarketingCardFormtemplateSetModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayMarketingCardFormtemplateSetModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayMarketingCardFormtemplateSetModel;
            }
