...
/**
 * AlipayMerchantItemFileApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMerchantItemFileApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 商品文件上传接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMerchantItemFileUploadModel $data data (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayMerchantItemFileUploadResponseModel|\Alipay\OpenAPISDK\Model\AlipayMerchantItemFileUploadDefaultResponse
     */
     ...
     * 商品文件上传接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMerchantItemFileUploadModel $data (optional)
     * @param  \SplFileObject $fileContent (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayMerchantItemFileUploadResponseModel|\Alipay\OpenAPISDK\Model\AlipayMerchantItemFileUploadDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadWithHttpInfo($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMerchantItemFileUploadResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayMerchantItemFileUploadResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMerchantItemFileUploadResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMerchantItemFileUploadDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMerchantItemFileUploadDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMerchantItemFileUploadDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayMerchantItemFileUploadResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMerchantItemFileUploadDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
    ...
    public function uploadRequest($data = null, $fileContent = null, ?CustomizedParams $customizedParams = null)
    {
        ...
        $resourcePath = '/v3/alipay/merchant/item/file/upload';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
