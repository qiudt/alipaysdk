...
/**
 * AlipayEcoEduKtParentApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayEcoEduKtParentApi
{
     ...
     * 查询学生家长状态接口
     *
     * @param  string $schoolPid 学校支付宝pid (optional)
     * @param  string $schoolNo 学校编码，录入学校接口返回的school_no参数 (optional)
     * @param  string $partnerId Isv的支付宝pid (optional)
     * @param  string $childName 孩子或学生姓名 (optional)
     * @param  string $userMobile 用户手机号，发账单时填写users数组中的一个手机号。结果返回用户是否通过此手机号添加此学生的缴费账户。user_mobile、student_code 、student_identify 必须并且只能填一项。 (optional)
     * @param  string $studentCode 学生的学号，一个学校的学号必须是唯一。结果返回用户是否通过此学号添加此学生的缴费账户。user_mobile、student_code 、student_identify 必须并且只能填一项。 (optional)
     * @param  string $studentIdentify 学生的身份证号，使用身份证规则验证。结果返回用户是否通过此身份证号添加此学生的缴费账户。user_mobile、student_code 、student_identify 必须并且只能填一项。 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEcoEduKtParentQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayEcoEduKtParentQueryDefaultResponse
     */
    public function query($schoolPid = null, $schoolNo = null, $partnerId = null, $childName = null, $userMobile = null, $studentCode = null, $studentIdentify = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($schoolPid, $schoolNo, $partnerId, $childName, $userMobile, $studentCode, $studentIdentify, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEcoEduKtParentQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayEcoEduKtParentQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($schoolPid = null, $schoolNo = null, $partnerId = null, $childName = null, $userMobile = null, $studentCode = null, $studentIdentify = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($schoolPid, $schoolNo, $partnerId, $childName, $userMobile, $studentCode, $studentIdentify, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEcoEduKtParentQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEcoEduKtParentQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEcoEduKtParentQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEcoEduKtParentQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEcoEduKtParentQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEcoEduKtParentQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEcoEduKtParentQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEcoEduKtParentQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($schoolPid = null, $schoolNo = null, $partnerId = null, $childName = null, $userMobile = null, $studentCode = null, $studentIdentify = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($schoolPid, $schoolNo, $partnerId, $childName, $userMobile, $studentCode, $studentIdentify, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($schoolPid = null, $schoolNo = null, $partnerId = null, $childName = null, $userMobile = null, $studentCode = null, $studentIdentify = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEcoEduKtParentQueryResponseModel';
        $request = $this->queryRequest($schoolPid, $schoolNo, $partnerId, $childName, $userMobile, $studentCode, $studentIdentify, $customizedParams);
     ...
     */
    public function queryRequest($schoolPid = null, $schoolNo = null, $partnerId = null, $childName = null, $userMobile = null, $studentCode = null, $studentIdentify = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/eco/edu/kt/parent/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $studentIdentify,
            'student_identify', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
