...
/**
 * AlipayOpenSpOpporFeedbackApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenSpOpporFeedbackApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 商机拓展完成
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyModel $alipayOpenSpOpporFeedbackModifyModel alipayOpenSpOpporFeedbackModifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyDefaultResponse
     */
    public function modify($alipayOpenSpOpporFeedbackModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->modifyWithHttpInfo($alipayOpenSpOpporFeedbackModifyModel, $customizedParams);
        return $response;
    }
     ...
     * 商机拓展完成
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyModel $alipayOpenSpOpporFeedbackModifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function modifyWithHttpInfo($alipayOpenSpOpporFeedbackModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->modifyRequest($alipayOpenSpOpporFeedbackModifyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function modifyAsync($alipayOpenSpOpporFeedbackModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->modifyAsyncWithHttpInfo($alipayOpenSpOpporFeedbackModifyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function modifyAsyncWithHttpInfo($alipayOpenSpOpporFeedbackModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenSpOpporFeedbackModifyResponseModel';
        $request = $this->modifyRequest($alipayOpenSpOpporFeedbackModifyModel, $customizedParams);
     ...
     */
    public function modifyRequest($alipayOpenSpOpporFeedbackModifyModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/sp/oppor/feedback/modify';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenSpOpporFeedbackModifyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenSpOpporFeedbackModifyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenSpOpporFeedbackModifyModel;
            }
