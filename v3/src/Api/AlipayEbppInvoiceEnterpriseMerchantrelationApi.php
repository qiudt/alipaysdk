...
/**
 * AlipayEbppInvoiceEnterpriseMerchantrelationApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEbppInvoiceEnterpriseMerchantrelationApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateModel $alipayEbppInvoiceEnterpriseMerchantrelationCreateModel alipayEbppInvoiceEnterpriseMerchantrelationCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateDefaultResponse
     */
    public function create($enterpriseId = null, $alipayEbppInvoiceEnterpriseMerchantrelationCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->createWithHttpInfo($enterpriseId, $alipayEbppInvoiceEnterpriseMerchantrelationCreateModel, $customizedParams);
        return $response;
    }
     ...
     *
     * @param  string $enterpriseId 企业ID (optional)
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateModel $alipayEbppInvoiceEnterpriseMerchantrelationCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($enterpriseId = null, $alipayEbppInvoiceEnterpriseMerchantrelationCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->createRequest($enterpriseId, $alipayEbppInvoiceEnterpriseMerchantrelationCreateModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function createAsync($enterpriseId = null, $alipayEbppInvoiceEnterpriseMerchantrelationCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->createAsyncWithHttpInfo($enterpriseId, $alipayEbppInvoiceEnterpriseMerchantrelationCreateModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function createAsyncWithHttpInfo($enterpriseId = null, $alipayEbppInvoiceEnterpriseMerchantrelationCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceEnterpriseMerchantrelationCreateResponseModel';
        $request = $this->createRequest($enterpriseId, $alipayEbppInvoiceEnterpriseMerchantrelationCreateModel, $customizedParams);
     ...
     */
    public function createRequest($enterpriseId = null, $alipayEbppInvoiceEnterpriseMerchantrelationCreateModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/invoice/enterprise/merchantrelation/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayEbppInvoiceEnterpriseMerchantrelationCreateModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayEbppInvoiceEnterpriseMerchantrelationCreateModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayEbppInvoiceEnterpriseMerchantrelationCreateModel;
            }
