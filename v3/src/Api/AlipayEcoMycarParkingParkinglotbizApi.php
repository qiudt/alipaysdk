...
/**
 * AlipayEcoMycarParkingParkinglotbizApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEcoMycarParkingParkinglotbizApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 车场业务归属配置
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingParkinglotbizTransferModel $alipayEcoMycarParkingParkinglotbizTransferModel alipayEcoMycarParkingParkinglotbizTransferModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingParkinglotbizTransferDefaultResponse
     */
    public function transfer($alipayEcoMycarParkingParkinglotbizTransferModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->transferWithHttpInfo($alipayEcoMycarParkingParkinglotbizTransferModel, $customizedParams);
        return $response;
    }
     ...
     * 车场业务归属配置
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingParkinglotbizTransferModel $alipayEcoMycarParkingParkinglotbizTransferModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingParkinglotbizTransferDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function transferWithHttpInfo($alipayEcoMycarParkingParkinglotbizTransferModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->transferRequest($alipayEcoMycarParkingParkinglotbizTransferModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingParkinglotbizTransferDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingParkinglotbizTransferDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingParkinglotbizTransferDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEcoMycarParkingParkinglotbizTransferDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function transferAsync($alipayEcoMycarParkingParkinglotbizTransferModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->transferAsyncWithHttpInfo($alipayEcoMycarParkingParkinglotbizTransferModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function transferAsyncWithHttpInfo($alipayEcoMycarParkingParkinglotbizTransferModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->transferRequest($alipayEcoMycarParkingParkinglotbizTransferModel, $customizedParams);
     ...
     */
    public function transferRequest($alipayEcoMycarParkingParkinglotbizTransferModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/eco/mycar/parking/parkinglotbiz/transfer';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayEcoMycarParkingParkinglotbizTransferModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayEcoMycarParkingParkinglotbizTransferModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayEcoMycarParkingParkinglotbizTransferModel;
            }
