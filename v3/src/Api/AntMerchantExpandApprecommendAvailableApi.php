...
/**
 * AntMerchantExpandApprecommendAvailableApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AntMerchantExpandApprecommendAvailableApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 查询可关联APP的账号列表
     *
     * @param  int $pageSize 单页行数，不能超过100行 (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AntMerchantExpandApprecommendAvailableQueryResponseModel|\Alipay\OpenAPISDK\Model\AntMerchantExpandApprecommendAvailableQueryDefaultResponse
     */
    public function query($pageSize = null, $pageNumber = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($pageSize, $pageNumber, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AntMerchantExpandApprecommendAvailableQueryResponseModel|\Alipay\OpenAPISDK\Model\AntMerchantExpandApprecommendAvailableQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($pageSize = null, $pageNumber = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($pageSize, $pageNumber, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AntMerchantExpandApprecommendAvailableQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AntMerchantExpandApprecommendAvailableQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AntMerchantExpandApprecommendAvailableQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AntMerchantExpandApprecommendAvailableQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AntMerchantExpandApprecommendAvailableQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AntMerchantExpandApprecommendAvailableQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AntMerchantExpandApprecommendAvailableQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AntMerchantExpandApprecommendAvailableQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($pageSize = null, $pageNumber = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($pageSize, $pageNumber, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($pageSize = null, $pageNumber = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AntMerchantExpandApprecommendAvailableQueryResponseModel';
        $request = $this->queryRequest($pageSize, $pageNumber, $customizedParams);
     ...
     */
    public function queryRequest($pageSize = null, $pageNumber = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/ant/merchant/expand/apprecommend/available/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
