...
/**
 * AlipayFundJointaccountQuotaApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayFundJointaccountQuotaApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $memberId 员工ID (optional)
     * @param  string $memberOpenId 员工的openid (optional)
     * @param  string $operateRole 角色：创建方(CREATOR)、参与方(PARTICIPANT) (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayFundJointaccountQuotaQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundJointaccountQuotaQueryDefaultResponse
     */
    public function query($productCode = null, $bizScene = null, $accountId = null, $memberId = null, $memberOpenId = null, $operateRole = null, $agreementNo = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($productCode, $bizScene, $accountId, $memberId, $memberOpenId, $operateRole, $agreementNo, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayFundJointaccountQuotaQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundJointaccountQuotaQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($productCode = null, $bizScene = null, $accountId = null, $memberId = null, $memberOpenId = null, $operateRole = null, $agreementNo = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($productCode, $bizScene, $accountId, $memberId, $memberOpenId, $operateRole, $agreementNo, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountQuotaQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountQuotaQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountQuotaQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountQuotaQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountQuotaQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountQuotaQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountQuotaQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountQuotaQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($productCode = null, $bizScene = null, $accountId = null, $memberId = null, $memberOpenId = null, $operateRole = null, $agreementNo = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($productCode, $bizScene, $accountId, $memberId, $memberOpenId, $operateRole, $agreementNo, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($productCode = null, $bizScene = null, $accountId = null, $memberId = null, $memberOpenId = null, $operateRole = null, $agreementNo = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountQuotaQueryResponseModel';
        $request = $this->queryRequest($productCode, $bizScene, $accountId, $memberId, $memberOpenId, $operateRole, $agreementNo, $customizedParams);
     ...
     */
    public function queryRequest($productCode = null, $bizScene = null, $accountId = null, $memberId = null, $memberOpenId = null, $operateRole = null, $agreementNo = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/fund/jointaccount/quota/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
