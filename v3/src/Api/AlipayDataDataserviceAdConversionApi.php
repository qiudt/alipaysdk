...
/**
 * AlipayDataDataserviceAdConversionApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayDataDataserviceAdConversionApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 转化数据回传
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayDataDataserviceAdConversionUploadModel $alipayDataDataserviceAdConversionUploadModel alipayDataDataserviceAdConversionUploadModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayDataDataserviceAdConversionUploadDefaultResponse
     */
    public function upload($alipayDataDataserviceAdConversionUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->uploadWithHttpInfo($alipayDataDataserviceAdConversionUploadModel, $customizedParams);
        return $response;
    }
     ...
     * 转化数据回传
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayDataDataserviceAdConversionUploadModel $alipayDataDataserviceAdConversionUploadModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayDataDataserviceAdConversionUploadDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadWithHttpInfo($alipayDataDataserviceAdConversionUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->uploadRequest($alipayDataDataserviceAdConversionUploadModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayDataDataserviceAdConversionUploadDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayDataDataserviceAdConversionUploadDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayDataDataserviceAdConversionUploadDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayDataDataserviceAdConversionUploadDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function uploadAsync($alipayDataDataserviceAdConversionUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->uploadAsyncWithHttpInfo($alipayDataDataserviceAdConversionUploadModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function uploadAsyncWithHttpInfo($alipayDataDataserviceAdConversionUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->uploadRequest($alipayDataDataserviceAdConversionUploadModel, $customizedParams);
     ...
     */
    public function uploadRequest($alipayDataDataserviceAdConversionUploadModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/data/dataservice/ad/conversion/upload';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayDataDataserviceAdConversionUploadModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayDataDataserviceAdConversionUploadModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayDataDataserviceAdConversionUploadModel;
            }
