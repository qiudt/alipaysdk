...
/**
 * AlipayTradeOverseasApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayTradeOverseasApi
{
     ...
     * 统一境内收单跨境结算接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleModel $alipayTradeOverseasSettleModel alipayTradeOverseasSettleModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleResponseModel|\Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleDefaultResponse
     */
    public function settle($alipayTradeOverseasSettleModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->settleWithHttpInfo($alipayTradeOverseasSettleModel, $customizedParams);
        return $response;
    }
     ...
     * 统一境内收单跨境结算接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleModel $alipayTradeOverseasSettleModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleResponseModel|\Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function settleWithHttpInfo($alipayTradeOverseasSettleModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->settleRequest($alipayTradeOverseasSettleModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function settleAsync($alipayTradeOverseasSettleModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->settleAsyncWithHttpInfo($alipayTradeOverseasSettleModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function settleAsyncWithHttpInfo($alipayTradeOverseasSettleModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayTradeOverseasSettleResponseModel';
        $request = $this->settleRequest($alipayTradeOverseasSettleModel, $customizedParams);
     ...
     */
    public function settleRequest($alipayTradeOverseasSettleModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/trade/overseas/settle';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayTradeOverseasSettleModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayTradeOverseasSettleModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayTradeOverseasSettleModel;
            }
