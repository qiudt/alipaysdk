...
/**
 * AlipayOpenMiniTemplateUsageApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniTemplateUsageApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 查询使用模板的小程序列表
     *
     * @param  string $templateId 小程序模板APPID (optional)
     * @param  int $pageNum 查询的页数，起始为 1（第一页） 。默认第一页。 (optional)
     * @param  int $pageSize 每页的数量，最多查询50个，默认查询10个 (optional)
     * @param  string $templateVersion 模板小程序的版本号 (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplateUsageQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplateUsageQueryDefaultResponse
     */
    public function query($templateId = null, $pageNum = null, $pageSize = null, $templateVersion = null, $bundleId = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($templateId, $pageNum, $pageSize, $templateVersion, $bundleId, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplateUsageQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplateUsageQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($templateId = null, $pageNum = null, $pageSize = null, $templateVersion = null, $bundleId = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($templateId, $pageNum, $pageSize, $templateVersion, $bundleId, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplateUsageQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplateUsageQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplateUsageQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplateUsageQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplateUsageQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplateUsageQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplateUsageQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplateUsageQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($templateId = null, $pageNum = null, $pageSize = null, $templateVersion = null, $bundleId = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($templateId, $pageNum, $pageSize, $templateVersion, $bundleId, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($templateId = null, $pageNum = null, $pageSize = null, $templateVersion = null, $bundleId = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplateUsageQueryResponseModel';
        $request = $this->queryRequest($templateId, $pageNum, $pageSize, $templateVersion, $bundleId, $customizedParams);
     ...
     */
    public function queryRequest($templateId = null, $pageNum = null, $pageSize = null, $templateVersion = null, $bundleId = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/template/usage/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $templateVersion,
            'template_version', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
