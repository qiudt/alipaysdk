...
/**
 * AlipayPcreditHuabeiAuthAccumulationApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayPcreditHuabeiAuthAccumulationApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 花芝轻会员周期累计数据查询
     *
     * @param  string $agreementNo 支付宝系统中用以唯一标识用户签约记录的编号。 (optional)
     * @param  string $period 协议结算周期，使用支付宝端回传的周期信息。 (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthAccumulationQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthAccumulationQueryDefaultResponse
     */
    public function query($agreementNo = null, $period = null, $alipayUserId = null, $openId = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($agreementNo, $period, $alipayUserId, $openId, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthAccumulationQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthAccumulationQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($agreementNo = null, $period = null, $alipayUserId = null, $openId = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($agreementNo, $period, $alipayUserId, $openId, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthAccumulationQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthAccumulationQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthAccumulationQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthAccumulationQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthAccumulationQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthAccumulationQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthAccumulationQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthAccumulationQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($agreementNo = null, $period = null, $alipayUserId = null, $openId = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($agreementNo, $period, $alipayUserId, $openId, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($agreementNo = null, $period = null, $alipayUserId = null, $openId = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayPcreditHuabeiAuthAccumulationQueryResponseModel';
        $request = $this->queryRequest($agreementNo, $period, $alipayUserId, $openId, $customizedParams);
     ...
     */
    public function queryRequest($agreementNo = null, $period = null, $alipayUserId = null, $openId = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/pcredit/huabei/auth/accumulation/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
