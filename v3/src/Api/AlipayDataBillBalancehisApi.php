...
/**
 * AlipayDataBillBalancehisApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayDataBillBalancehisApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 支付宝商家账户历史余额查询
     *
     * @param  string $bizDate 查询指定自然日的起初余额和期末余额，biz_date与biz_month传入参数互斥 (optional)
     * @param  string $bizMonth 查询指定自然月的起初余额和期末余额，biz_date与biz_month传入参数互斥 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayDataBillBalancehisQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayDataBillBalancehisQueryDefaultResponse
     */
    public function query($bizDate = null, $bizMonth = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($bizDate, $bizMonth, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayDataBillBalancehisQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayDataBillBalancehisQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($bizDate = null, $bizMonth = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($bizDate, $bizMonth, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBalancehisQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBalancehisQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayDataBillBalancehisQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBalancehisQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayDataBillBalancehisQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayDataBillBalancehisQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayDataBillBalancehisQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayDataBillBalancehisQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($bizDate = null, $bizMonth = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($bizDate, $bizMonth, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($bizDate = null, $bizMonth = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayDataBillBalancehisQueryResponseModel';
        $request = $this->queryRequest($bizDate, $bizMonth, $customizedParams);
     ...
     */
    public function queryRequest($bizDate = null, $bizMonth = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/data/bill/balancehis/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
