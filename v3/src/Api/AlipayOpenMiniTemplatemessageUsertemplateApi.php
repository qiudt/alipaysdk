...
/**
 * AlipayOpenMiniTemplatemessageUsertemplateApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniTemplatemessageUsertemplateApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 小程序模板消息申请
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyModel $alipayOpenMiniTemplatemessageUsertemplateApplyModel alipayOpenMiniTemplatemessageUsertemplateApplyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyDefaultResponse
     */
    public function apply($alipayOpenMiniTemplatemessageUsertemplateApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->applyWithHttpInfo($alipayOpenMiniTemplatemessageUsertemplateApplyModel, $customizedParams);
        return $response;
    }
     ...
     * 小程序模板消息申请
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyModel $alipayOpenMiniTemplatemessageUsertemplateApplyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function applyWithHttpInfo($alipayOpenMiniTemplatemessageUsertemplateApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->applyRequest($alipayOpenMiniTemplatemessageUsertemplateApplyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function applyAsync($alipayOpenMiniTemplatemessageUsertemplateApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->applyAsyncWithHttpInfo($alipayOpenMiniTemplatemessageUsertemplateApplyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function applyAsyncWithHttpInfo($alipayOpenMiniTemplatemessageUsertemplateApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenMiniTemplatemessageUsertemplateApplyResponseModel';
        $request = $this->applyRequest($alipayOpenMiniTemplatemessageUsertemplateApplyModel, $customizedParams);
     ...
     */
    public function applyRequest($alipayOpenMiniTemplatemessageUsertemplateApplyModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/templatemessage/usertemplate/apply';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniTemplatemessageUsertemplateApplyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniTemplatemessageUsertemplateApplyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniTemplatemessageUsertemplateApplyModel;
            }
