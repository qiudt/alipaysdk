...
/**
 * AlipayOpenServicemarketPromotiontaskRelationApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenServicemarketPromotiontaskRelationApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 服务商推广关系查询
     *
     * @param  string $commodityId 服务商品ID，并不是uid，取值来源于前端的获取 (optional)
     * @param  int $pageSize 每页数量，范围(1-100)。默认：10 (optional)
     * @param  int $pageNum 当前页码，从1开始。默认：1 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenServicemarketPromotiontaskRelationQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenServicemarketPromotiontaskRelationQueryDefaultResponse
     */
    public function query($commodityId = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($commodityId, $pageSize, $pageNum, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenServicemarketPromotiontaskRelationQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenServicemarketPromotiontaskRelationQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($commodityId = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($commodityId, $pageSize, $pageNum, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenServicemarketPromotiontaskRelationQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenServicemarketPromotiontaskRelationQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenServicemarketPromotiontaskRelationQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenServicemarketPromotiontaskRelationQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenServicemarketPromotiontaskRelationQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenServicemarketPromotiontaskRelationQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenServicemarketPromotiontaskRelationQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenServicemarketPromotiontaskRelationQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($commodityId = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($commodityId, $pageSize, $pageNum, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($commodityId = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenServicemarketPromotiontaskRelationQueryResponseModel';
        $request = $this->queryRequest($commodityId, $pageSize, $pageNum, $customizedParams);
     ...
     */
    public function queryRequest($commodityId = null, $pageSize = null, $pageNum = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/servicemarket/promotiontask/relation/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
