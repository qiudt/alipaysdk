...
/**
 * AlipayOpenMiniInnerversionNobuildApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerversionNobuildApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 手淘小程序产物包免构建版本上传
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionNobuildUploadModel $alipayOpenMiniInnerversionNobuildUploadModel alipayOpenMiniInnerversionNobuildUploadModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionNobuildUploadDefaultResponse
     */
    public function upload($alipayOpenMiniInnerversionNobuildUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->uploadWithHttpInfo($alipayOpenMiniInnerversionNobuildUploadModel, $customizedParams);
        return $response;
    }
     ...
     * 手淘小程序产物包免构建版本上传
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionNobuildUploadModel $alipayOpenMiniInnerversionNobuildUploadModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionNobuildUploadDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadWithHttpInfo($alipayOpenMiniInnerversionNobuildUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->uploadRequest($alipayOpenMiniInnerversionNobuildUploadModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionNobuildUploadDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionNobuildUploadDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionNobuildUploadDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionNobuildUploadDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function uploadAsync($alipayOpenMiniInnerversionNobuildUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->uploadAsyncWithHttpInfo($alipayOpenMiniInnerversionNobuildUploadModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function uploadAsyncWithHttpInfo($alipayOpenMiniInnerversionNobuildUploadModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->uploadRequest($alipayOpenMiniInnerversionNobuildUploadModel, $customizedParams);
     ...
     */
    public function uploadRequest($alipayOpenMiniInnerversionNobuildUploadModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerversion/nobuild/upload';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniInnerversionNobuildUploadModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniInnerversionNobuildUploadModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniInnerversionNobuildUploadModel;
            }
