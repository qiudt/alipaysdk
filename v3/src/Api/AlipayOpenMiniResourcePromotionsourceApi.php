<?php
/**
 * AlipayOpenMiniResourcePromotionsourceApi
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AlipayOpenMiniResourcePromotionsourceApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniResourcePromotionsourceApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 提供给淘联盟推广位信息接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniResourcePromotionsourceNotifyModel $alipayOpenMiniResourcePromotionsourceNotifyModel alipayOpenMiniResourcePromotionsourceNotifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniResourcePromotionsourceNotifyDefaultResponse
     */
    public function notify($alipayOpenMiniResourcePromotionsourceNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->notifyWithHttpInfo($alipayOpenMiniResourcePromotionsourceNotifyModel, $customizedParams);
        return $response;
    }
     ...
     * 提供给淘联盟推广位信息接口
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniResourcePromotionsourceNotifyModel $alipayOpenMiniResourcePromotionsourceNotifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniResourcePromotionsourceNotifyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function notifyWithHttpInfo($alipayOpenMiniResourcePromotionsourceNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->notifyRequest($alipayOpenMiniResourcePromotionsourceNotifyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniResourcePromotionsourceNotifyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniResourcePromotionsourceNotifyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniResourcePromotionsourceNotifyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniResourcePromotionsourceNotifyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function notifyAsync($alipayOpenMiniResourcePromotionsourceNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->notifyAsyncWithHttpInfo($alipayOpenMiniResourcePromotionsourceNotifyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function notifyAsyncWithHttpInfo($alipayOpenMiniResourcePromotionsourceNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->notifyRequest($alipayOpenMiniResourcePromotionsourceNotifyModel, $customizedParams);
     ...
     */
    public function notifyRequest($alipayOpenMiniResourcePromotionsourceNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/resource/promotionsource/notify';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniResourcePromotionsourceNotifyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniResourcePromotionsourceNotifyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniResourcePromotionsourceNotifyModel;
            }
