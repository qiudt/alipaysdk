...
/**
 * AlipayEbppInvoiceExpenserulesProjectemployeeApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEbppInvoiceExpenserulesProjectemployeeApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 修改项目的员工列表
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyModel $alipayEbppInvoiceExpenserulesProjectemployeeModifyModel alipayEbppInvoiceExpenserulesProjectemployeeModifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyDefaultResponse
     */
    public function modify($alipayEbppInvoiceExpenserulesProjectemployeeModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->modifyWithHttpInfo($alipayEbppInvoiceExpenserulesProjectemployeeModifyModel, $customizedParams);
        return $response;
    }
     ...
     * 修改项目的员工列表
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyModel $alipayEbppInvoiceExpenserulesProjectemployeeModifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function modifyWithHttpInfo($alipayEbppInvoiceExpenserulesProjectemployeeModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->modifyRequest($alipayEbppInvoiceExpenserulesProjectemployeeModifyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function modifyAsync($alipayEbppInvoiceExpenserulesProjectemployeeModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->modifyAsyncWithHttpInfo($alipayEbppInvoiceExpenserulesProjectemployeeModifyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function modifyAsyncWithHttpInfo($alipayEbppInvoiceExpenserulesProjectemployeeModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceExpenserulesProjectemployeeModifyResponseModel';
        $request = $this->modifyRequest($alipayEbppInvoiceExpenserulesProjectemployeeModifyModel, $customizedParams);
     ...
     */
    public function modifyRequest($alipayEbppInvoiceExpenserulesProjectemployeeModifyModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/invoice/expenserules/projectemployee/modify';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayEbppInvoiceExpenserulesProjectemployeeModifyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayEbppInvoiceExpenserulesProjectemployeeModifyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayEbppInvoiceExpenserulesProjectemployeeModifyModel;
            }
