...
/**
 * AlipayMarketingCampaignCashStatusApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMarketingCampaignCashStatusApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 更改现金活动状态
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMarketingCampaignCashStatusModifyModel $alipayMarketingCampaignCashStatusModifyModel alipayMarketingCampaignCashStatusModifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignCashStatusModifyDefaultResponse
     */
    public function modify($alipayMarketingCampaignCashStatusModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->modifyWithHttpInfo($alipayMarketingCampaignCashStatusModifyModel, $customizedParams);
        return $response;
    }
     ...
     * 更改现金活动状态
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMarketingCampaignCashStatusModifyModel $alipayMarketingCampaignCashStatusModifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignCashStatusModifyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function modifyWithHttpInfo($alipayMarketingCampaignCashStatusModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->modifyRequest($alipayMarketingCampaignCashStatusModifyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignCashStatusModifyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignCashStatusModifyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignCashStatusModifyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMarketingCampaignCashStatusModifyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function modifyAsync($alipayMarketingCampaignCashStatusModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->modifyAsyncWithHttpInfo($alipayMarketingCampaignCashStatusModifyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function modifyAsyncWithHttpInfo($alipayMarketingCampaignCashStatusModifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->modifyRequest($alipayMarketingCampaignCashStatusModifyModel, $customizedParams);
     ...
     */
    public function modifyRequest($alipayMarketingCampaignCashStatusModifyModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/marketing/campaign/cash/status/modify';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayMarketingCampaignCashStatusModifyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayMarketingCampaignCashStatusModifyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayMarketingCampaignCashStatusModifyModel;
            }
