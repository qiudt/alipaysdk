...
/**
 * AlipayEcoFilePathApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
...
class AlipayEcoFilePathApi
{
     ...
     * @param  string $contentMd5 先计算文件md5值，在对该md5值进行base64编码 (optional)
     * @param  string $contentType 目标文件的MIME类型 (optional)
     * @param  string $fileName 文件名称。 注意：必须带上文件扩展名，不然会导致后续发起流程校验不通过。示例：合同.pdf。 (optional)
     * @param  int $fileSize 文件大小，单位byte。最大允许上传30Mb (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEcoFilePathQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayEcoFilePathQueryDefaultResponse
     */
    public function query($targetAppId = null, $contentMd5 = null, $contentType = null, $fileName = null, $fileSize = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($targetAppId, $contentMd5, $contentType, $fileName, $fileSize, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEcoFilePathQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayEcoFilePathQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($targetAppId = null, $contentMd5 = null, $contentType = null, $fileName = null, $fileSize = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($targetAppId, $contentMd5, $contentType, $fileName, $fileSize, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEcoFilePathQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEcoFilePathQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEcoFilePathQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEcoFilePathQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEcoFilePathQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEcoFilePathQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEcoFilePathQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEcoFilePathQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($targetAppId = null, $contentMd5 = null, $contentType = null, $fileName = null, $fileSize = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($targetAppId, $contentMd5, $contentType, $fileName, $fileSize, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($targetAppId = null, $contentMd5 = null, $contentType = null, $fileName = null, $fileSize = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEcoFilePathQueryResponseModel';
        $request = $this->queryRequest($targetAppId, $contentMd5, $contentType, $fileName, $fileSize, $customizedParams);
     ...
     */
    public function queryRequest($targetAppId = null, $contentMd5 = null, $contentType = null, $fileName = null, $fileSize = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/eco/file/path/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
