...
/**
 * ZolozAuthenticationSmilepayApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ZolozAuthenticationSmilepayApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 刷脸支付初始化
     *
     * @param  \Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeModel $zolozAuthenticationSmilepayInitializeModel zolozAuthenticationSmilepayInitializeModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeResponseModel|\Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeDefaultResponse
     */
    public function initialize($zolozAuthenticationSmilepayInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->initializeWithHttpInfo($zolozAuthenticationSmilepayInitializeModel, $customizedParams);
        return $response;
    }
     ...
     * 刷脸支付初始化
     *
     * @param  \Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeModel $zolozAuthenticationSmilepayInitializeModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeResponseModel|\Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function initializeWithHttpInfo($zolozAuthenticationSmilepayInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->initializeRequest($zolozAuthenticationSmilepayInitializeModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function initializeAsync($zolozAuthenticationSmilepayInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->initializeAsyncWithHttpInfo($zolozAuthenticationSmilepayInitializeModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function initializeAsyncWithHttpInfo($zolozAuthenticationSmilepayInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\ZolozAuthenticationSmilepayInitializeResponseModel';
        $request = $this->initializeRequest($zolozAuthenticationSmilepayInitializeModel, $customizedParams);
     ...
     */
    public function initializeRequest($zolozAuthenticationSmilepayInitializeModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/zoloz/authentication/smilepay/initialize';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($zolozAuthenticationSmilepayInitializeModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($zolozAuthenticationSmilepayInitializeModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $zolozAuthenticationSmilepayInitializeModel;
            }
