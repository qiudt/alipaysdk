...
/**
 * AlipayEbppInvoiceTitleListApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEbppInvoiceTitleListApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  string $userId 支付宝用户id (optional)
     * @param  string $openId 支付宝用户id (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleListGetResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleListGetDefaultResponse
     */
    public function get($authToken = null, $userId = null, $openId = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->getWithHttpInfo($authToken, $userId, $openId, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleListGetResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleListGetDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($authToken = null, $userId = null, $openId = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->getRequest($authToken, $userId, $openId, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleListGetResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleListGetResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleListGetResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleListGetDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleListGetDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleListGetDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleListGetResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleListGetDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function getAsync($authToken = null, $userId = null, $openId = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->getAsyncWithHttpInfo($authToken, $userId, $openId, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getAsyncWithHttpInfo($authToken = null, $userId = null, $openId = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceTitleListGetResponseModel';
        $request = $this->getRequest($authToken, $userId, $openId, $customizedParams);
     ...
     */
    public function getRequest($authToken = null, $userId = null, $openId = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/invoice/title/list/get';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
