...
/**
 * AlipayOpenSpMerchantInconsistentApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenSpMerchantInconsistentApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 非同人商家进件资料审批
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveModel $alipayOpenSpMerchantInconsistentApproveModel alipayOpenSpMerchantInconsistentApproveModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveDefaultResponse
     */
    public function approve($alipayOpenSpMerchantInconsistentApproveModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->approveWithHttpInfo($alipayOpenSpMerchantInconsistentApproveModel, $customizedParams);
        return $response;
    }
     ...
     * 非同人商家进件资料审批
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveModel $alipayOpenSpMerchantInconsistentApproveModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function approveWithHttpInfo($alipayOpenSpMerchantInconsistentApproveModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->approveRequest($alipayOpenSpMerchantInconsistentApproveModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function approveAsync($alipayOpenSpMerchantInconsistentApproveModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->approveAsyncWithHttpInfo($alipayOpenSpMerchantInconsistentApproveModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function approveAsyncWithHttpInfo($alipayOpenSpMerchantInconsistentApproveModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenSpMerchantInconsistentApproveResponseModel';
        $request = $this->approveRequest($alipayOpenSpMerchantInconsistentApproveModel, $customizedParams);
     ...
     */
    public function approveRequest($alipayOpenSpMerchantInconsistentApproveModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/sp/merchant/inconsistent/approve';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenSpMerchantInconsistentApproveModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenSpMerchantInconsistentApproveModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenSpMerchantInconsistentApproveModel;
            }
