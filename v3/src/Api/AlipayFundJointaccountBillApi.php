...
/**
 * AlipayFundJointaccountBillApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayFundJointaccountBillApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 因公付账单查询
     *
     * @param  string $productCode 因公付产品码 (optional)
     ...
     * @return \Alipay\OpenAPISDK\Model\AlipayFundJointaccountBillQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundJointaccountBillQueryDefaultResponse
     */
    public function query($productCode = null, $bizScene = null, $accountId = null, $pageNum = null, $pageSize = null, $userId = null, $openId = null, $startDate = null, $endDate = null, $agreementNo = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($productCode, $bizScene, $accountId, $pageNum, $pageSize, $userId, $openId, $startDate, $endDate, $agreementNo, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayFundJointaccountBillQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayFundJointaccountBillQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($productCode = null, $bizScene = null, $accountId = null, $pageNum = null, $pageSize = null, $userId = null, $openId = null, $startDate = null, $endDate = null, $agreementNo = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($productCode, $bizScene, $accountId, $pageNum, $pageSize, $userId, $openId, $startDate, $endDate, $agreementNo, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountBillQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountBillQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountBillQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountBillQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayFundJointaccountBillQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountBillQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountBillQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountBillQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($productCode = null, $bizScene = null, $accountId = null, $pageNum = null, $pageSize = null, $userId = null, $openId = null, $startDate = null, $endDate = null, $agreementNo = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($productCode, $bizScene, $accountId, $pageNum, $pageSize, $userId, $openId, $startDate, $endDate, $agreementNo, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($productCode = null, $bizScene = null, $accountId = null, $pageNum = null, $pageSize = null, $userId = null, $openId = null, $startDate = null, $endDate = null, $agreementNo = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayFundJointaccountBillQueryResponseModel';
        $request = $this->queryRequest($productCode, $bizScene, $accountId, $pageNum, $pageSize, $userId, $openId, $startDate, $endDate, $agreementNo, $customizedParams);
     ...
     */
    public function queryRequest($productCode = null, $bizScene = null, $accountId = null, $pageNum = null, $pageSize = null, $userId = null, $openId = null, $startDate = null, $endDate = null, $agreementNo = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/fund/jointaccount/bill/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
