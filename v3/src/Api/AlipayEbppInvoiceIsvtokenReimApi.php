<?php
/**
 * AlipayEbppInvoiceIsvtokenReimApi
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AlipayEbppInvoiceIsvtokenReimApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayEbppInvoiceIsvtokenReimApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 获取报销授权令牌
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyModel $alipayEbppInvoiceIsvtokenReimApplyModel alipayEbppInvoiceIsvtokenReimApplyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyDefaultResponse
     */
    public function apply($alipayEbppInvoiceIsvtokenReimApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->applyWithHttpInfo($alipayEbppInvoiceIsvtokenReimApplyModel, $customizedParams);
        return $response;
    }
     ...
     * 获取报销授权令牌
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyModel $alipayEbppInvoiceIsvtokenReimApplyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyResponseModel|\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function applyWithHttpInfo($alipayEbppInvoiceIsvtokenReimApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->applyRequest($alipayEbppInvoiceIsvtokenReimApplyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function applyAsync($alipayEbppInvoiceIsvtokenReimApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->applyAsyncWithHttpInfo($alipayEbppInvoiceIsvtokenReimApplyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function applyAsyncWithHttpInfo($alipayEbppInvoiceIsvtokenReimApplyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayEbppInvoiceIsvtokenReimApplyResponseModel';
        $request = $this->applyRequest($alipayEbppInvoiceIsvtokenReimApplyModel, $customizedParams);
     ...
     */
    public function applyRequest($alipayEbppInvoiceIsvtokenReimApplyModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/ebpp/invoice/isvtoken/reim/apply';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayEbppInvoiceIsvtokenReimApplyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayEbppInvoiceIsvtokenReimApplyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayEbppInvoiceIsvtokenReimApplyModel;
            }
