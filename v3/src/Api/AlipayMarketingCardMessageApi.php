...
/**
 * AlipayMarketingCardMessageApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMarketingCardMessageApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 会员卡消息通知
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyModel $alipayMarketingCardMessageNotifyModel alipayMarketingCardMessageNotifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyDefaultResponse
     */
    public function notify($alipayMarketingCardMessageNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->notifyWithHttpInfo($alipayMarketingCardMessageNotifyModel, $customizedParams);
        return $response;
    }
     ...
     * 会员卡消息通知
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyModel $alipayMarketingCardMessageNotifyModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function notifyWithHttpInfo($alipayMarketingCardMessageNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->notifyRequest($alipayMarketingCardMessageNotifyModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function notifyAsync($alipayMarketingCardMessageNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->notifyAsyncWithHttpInfo($alipayMarketingCardMessageNotifyModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function notifyAsyncWithHttpInfo($alipayMarketingCardMessageNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingCardMessageNotifyResponseModel';
        $request = $this->notifyRequest($alipayMarketingCardMessageNotifyModel, $customizedParams);
     ...
     */
    public function notifyRequest($alipayMarketingCardMessageNotifyModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/marketing/card/message/notify';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayMarketingCardMessageNotifyModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayMarketingCardMessageNotifyModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayMarketingCardMessageNotifyModel;
            }
