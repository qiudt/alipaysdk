<?php
/**
 * AlipayOpenMiniInnerversionOfflineApi
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AlipayOpenMiniInnerversionOfflineApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenMiniInnerversionOfflineApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 内部链路小程序下架
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOfflinePublishModel $alipayOpenMiniInnerversionOfflinePublishModel alipayOpenMiniInnerversionOfflinePublishModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOfflinePublishDefaultResponse
     */
    public function publish($alipayOpenMiniInnerversionOfflinePublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->publishWithHttpInfo($alipayOpenMiniInnerversionOfflinePublishModel, $customizedParams);
        return $response;
    }
     ...
     * 内部链路小程序下架
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOfflinePublishModel $alipayOpenMiniInnerversionOfflinePublishModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOfflinePublishDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function publishWithHttpInfo($alipayOpenMiniInnerversionOfflinePublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->publishRequest($alipayOpenMiniInnerversionOfflinePublishModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOfflinePublishDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOfflinePublishDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOfflinePublishDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenMiniInnerversionOfflinePublishDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function publishAsync($alipayOpenMiniInnerversionOfflinePublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->publishAsyncWithHttpInfo($alipayOpenMiniInnerversionOfflinePublishModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function publishAsyncWithHttpInfo($alipayOpenMiniInnerversionOfflinePublishModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = 'object';
        $request = $this->publishRequest($alipayOpenMiniInnerversionOfflinePublishModel, $customizedParams);
     ...
     */
    public function publishRequest($alipayOpenMiniInnerversionOfflinePublishModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/mini/innerversion/offline/publish';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayOpenMiniInnerversionOfflinePublishModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayOpenMiniInnerversionOfflinePublishModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayOpenMiniInnerversionOfflinePublishModel;
            }
