...
/**
 * AlipayMarketingActivityDeliverychannelApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayMarketingActivityDeliverychannelApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 查询可推广渠道
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryModel $alipayMarketingActivityDeliverychannelQueryModel alipayMarketingActivityDeliverychannelQueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryDefaultResponse
     */
    public function query($alipayMarketingActivityDeliverychannelQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($alipayMarketingActivityDeliverychannelQueryModel, $customizedParams);
        return $response;
    }
     ...
     * 查询可推广渠道
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryModel $alipayMarketingActivityDeliverychannelQueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($alipayMarketingActivityDeliverychannelQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($alipayMarketingActivityDeliverychannelQueryModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($alipayMarketingActivityDeliverychannelQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($alipayMarketingActivityDeliverychannelQueryModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($alipayMarketingActivityDeliverychannelQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayMarketingActivityDeliverychannelQueryResponseModel';
        $request = $this->queryRequest($alipayMarketingActivityDeliverychannelQueryModel, $customizedParams);
     ...
     */
    public function queryRequest($alipayMarketingActivityDeliverychannelQueryModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/marketing/activity/deliverychannel/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayMarketingActivityDeliverychannelQueryModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayMarketingActivityDeliverychannelQueryModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayMarketingActivityDeliverychannelQueryModel;
            }
