...
/**
 * AlipayTradeFastpayRefundApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayTradeFastpayRefundApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 统一收单交易退款查询
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryModel $alipayTradeFastpayRefundQueryModel alipayTradeFastpayRefundQueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryDefaultResponse
     */
    public function query($alipayTradeFastpayRefundQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($alipayTradeFastpayRefundQueryModel, $customizedParams);
        return $response;
    }
     ...
     * 统一收单交易退款查询
     *
     * @param  \Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryModel $alipayTradeFastpayRefundQueryModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($alipayTradeFastpayRefundQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($alipayTradeFastpayRefundQueryModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($alipayTradeFastpayRefundQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($alipayTradeFastpayRefundQueryModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($alipayTradeFastpayRefundQueryModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayTradeFastpayRefundQueryResponseModel';
        $request = $this->queryRequest($alipayTradeFastpayRefundQueryModel, $customizedParams);
     ...
     */
    public function queryRequest($alipayTradeFastpayRefundQueryModel = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/trade/fastpay/refund/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipayTradeFastpayRefundQueryModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipayTradeFastpayRefundQueryModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipayTradeFastpayRefundQueryModel;
            }
