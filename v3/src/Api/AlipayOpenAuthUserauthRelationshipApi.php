...
/**
 * AlipayOpenAuthUserauthRelationshipApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipayOpenAuthUserauthRelationshipApi
{
    /**
     * @var ClientInterface
     */
     ...
     * 用户授权关系查询
     *
     * @param  string $userId 蚂蚁统一会员ID，如果未开启openid改造，则此值必传 (optional)
     * @param  string $openId 蚂蚁统一会员ID，蚂蚁统一会员ID，如果已完成openid改造，则此值必传 (optional)
     * @param  string $scopes 查询授权关系所关联的scope，半角逗号分隔的列表，且不允许有重复值 (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipayOpenAuthUserauthRelationshipQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenAuthUserauthRelationshipQueryDefaultResponse
     */
    public function query($userId = null, $openId = null, $scopes = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->queryWithHttpInfo($userId, $openId, $scopes, $customizedParams);
        return $response;
    }
     ...
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipayOpenAuthUserauthRelationshipQueryResponseModel|\Alipay\OpenAPISDK\Model\AlipayOpenAuthUserauthRelationshipQueryDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function queryWithHttpInfo($userId = null, $openId = null, $scopes = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->queryRequest($userId, $openId, $scopes, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenAuthUserauthRelationshipQueryResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenAuthUserauthRelationshipQueryResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenAuthUserauthRelationshipQueryResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipayOpenAuthUserauthRelationshipQueryDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipayOpenAuthUserauthRelationshipQueryDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipayOpenAuthUserauthRelationshipQueryDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenAuthUserauthRelationshipQueryResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipayOpenAuthUserauthRelationshipQueryDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function queryAsync($userId = null, $openId = null, $scopes = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->queryAsyncWithHttpInfo($userId, $openId, $scopes, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function queryAsyncWithHttpInfo($userId = null, $openId = null, $scopes = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipayOpenAuthUserauthRelationshipQueryResponseModel';
        $request = $this->queryRequest($userId, $openId, $scopes, $customizedParams);
     ...
     */
    public function queryRequest($userId = null, $openId = null, $scopes = null, ?CustomizedParams $customizedParams = null)
    {

        $resourcePath = '/v3/alipay/open/auth/userauth/relationship/query';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
