...
/**
 * AlipaySecurityDataSssApi Class Doc Comment
 *
 * @category Class
 * @package  Alipay\OpenAPISDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AlipaySecurityDataSssApi
{
    /**
     * @var ClientInterface
     */
     ...
     *
     * @param  int $a path.数字，无枚举，有注意事项 (required)
     * @param  string $b 有枚举，必须，有openid，有注意事项 (optional)
     * @param  string $bOpenId 有枚举，必须，有openid，有注意事项 (optional)
     * @param  \Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateModel $alipaySecurityDataSssCreateModel alipaySecurityDataSssCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateResponseModel|\Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateDefaultResponse
     */
    public function create($a, $b = null, $bOpenId = null, $alipaySecurityDataSssCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        list($response) = $this->createWithHttpInfo($a, $b, $bOpenId, $alipaySecurityDataSssCreateModel, $customizedParams);
        return $response;
    }
     ...
     * @param  string $b 有枚举，必须，有openid，有注意事项 (optional)
     * @param  string $bOpenId 有枚举，必须，有openid，有注意事项 (optional)
     * @param  \Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateModel $alipaySecurityDataSssCreateModel (optional)
     * @param CustomizedParams $customizedParams
     *
     * @throws \Alipay\OpenAPISDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateResponseModel|\Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($a, $b = null, $bOpenId = null, $alipaySecurityDataSssCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        $request = $this->createRequest($a, $b, $bOpenId, $alipaySecurityDataSssCreateModel, $customizedParams);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateResponseModel' === '\SplFileObject') {
                        ...
                        if ('\Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateResponseModel' !== 'string') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateResponseModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                                
                default:
                    if ('\Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateDefaultResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        //验签
                        $this->alipayConfigUtil->verifyResponse($content, $response->getHeaders(), true);
                        if ('\Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateDefaultResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
                    AlipayLogger::logBizResponseInfo($response->getStatusCode(), $content, $response->getHeaders());
                    ...
                    return [
                        //ObjectSerializer::deserialize($content, '\Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateDefaultResponse', []),
                        $content,
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            ...
            $returnType = '\Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateResponseModel';
            ...
            switch ($e->getCode()) {
                ...
                default:
                    //$data = ObjectSerializer::deserialize(
                    //    $e->getResponseBody(),
                    //    '\Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateDefaultResponse',
                    //    $e->getResponseHeaders()
                    //);
                    //$e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function createAsync($a, $b = null, $bOpenId = null, $alipaySecurityDataSssCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        return $this->createAsyncWithHttpInfo($a, $b, $bOpenId, $alipaySecurityDataSssCreateModel, $customizedParams)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function createAsyncWithHttpInfo($a, $b = null, $bOpenId = null, $alipaySecurityDataSssCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        $returnType = '\Alipay\OpenAPISDK\Model\AlipaySecurityDataSssCreateResponseModel';
        $request = $this->createRequest($a, $b, $bOpenId, $alipaySecurityDataSssCreateModel, $customizedParams);
     ...
     */
    public function createRequest($a, $b = null, $bOpenId = null, $alipaySecurityDataSssCreateModel = null, ?CustomizedParams $customizedParams = null)
    {
        // verify the required path parameter 'a' is set
        if ($a === null || (is_array($a) && count($a) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $a when calling create'
            );
        }

        $resourcePath = '/v3/alipay/security/data/sss/create/{a}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (($customizedParams != null && !$this->getAlipayConfigUtil()->checkEmpty($customizedParams->getBodyContent()))
        ...
        } elseif (isset($alipaySecurityDataSssCreateModel)) {
            $signContent = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($alipaySecurityDataSssCreateModel), JSON_UNESCAPED_UNICODE);
            if ($headers['Content-Type'] === 'application/json' || $isEncrypt) {
                ...
                $httpBody = $alipaySecurityDataSssCreateModel;
            }
